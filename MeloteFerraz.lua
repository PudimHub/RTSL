...
Instance.new("UICorner",dataHeader).CornerRadius=UDim.new(0,8)
...
makeDiceBtn(diceBtnsRow,"📋CopyID",Color3.fromRGB(60,160,80),function()
...
local ESP_CATS = {
    ...
    {key="Kids", label="👶 Lost Children", color=Color3.fromRGB(100,220,255), type="entity", range=math.huge, desc="Dino, Kraken, Squid, Koala Kid",
     nomes={"Dino Kid","Kraken Kid","Squid Kid","Koala Kid","DinoKid","KrakenKid","SquidKid","KoalaKid","Kid","Child","MissingChild"}},
    {key="PassiveAnima", label="🐰 Passive Animals", color=Color3.fromRGB(130,255,170), type="entity", range=500, description="Bunny, Horse, Kiwi, Turkey",
     names={"Bunny","Horse","Kiwi","Turkey"}},
    {key="AggressiveAnimal",label="🐺 Aggressive Animals", color=Color3.fromRGB(255,175,30), type="entity", range=600, desc="Wolf, Bear, Polar Bear, Frog, Scorpion…",
    ...
    {key="Aliens",       label="👽 Aliens",              cor=Color3.fromRGB(60,255,200),  tipo="entity", alcance=700, desc="Alien, Elite Alien",
     names={"Alien","Elite Alien","EliteAlien","NormalAlien"}},
    ...
    {key="EspCarcacas", label="🦴 Carcasses", color=Color3.fromRGB(180,100,50), type="item", range=350, description="Wolf/Bear/PolarBear/Mammoth/Hellephant Corpse…",
    ...
    {key="EspFerr", label="🪓 Tools & Bags", color=Color3.fromRGB(255,200,55), type="item", range=500, desc="Axes, Sacks, Rods, Flutes, Armor…",
    ...
    {key="EspAmmo", label="🔫 Ammunition", color=Color3.fromRGB(255,155,60), type="item", range=400, desc="Revolver Ammo, Rifle Ammo, Shotgun Ammo",
     names={"Revolver Ammo","RevolverAmmo","Rifle AmmoRifleAmmoShotgun AmmoShotgunAmmo"}},
    ...
    {key="EspBigorna", label="⚙️ Anvil Parts", color=Color3.fromRGB(200,160,255), type="item", range=math.huge, desc="Anvil Front/Back/Base + Meteor Anvil",
...
local function makeEspRow(cat)
    ...
    labelName.Font=Enum.Font.GothamBold; labelName.Text=cat.label; labelName.TextColor3=Color3.fromRGB(220,225,240)
    ...
    btn.MouseButton1Click:Connect(function()
        state=not state; space[cat.key]=state; lastCache=0
...
local espGroupOrder={
    {"ESP — Entities", Color3.fromRGB(88,101,242), {"Players","Kids","PassiveAnim","AggressiveAnim","Monsters","Cultists","Aliens"}},
    {"ESP — Resources & Fuel", Color3.fromRGB(255,130,40), {"EspLog","EspCombustivel","EspCarcacas","EspSucata","EspMateriais"}},
    {"ESP — Food & Nature", Color3.fromRGB(255,120,170), {"EspFood","EspFish","EspSeeds","EspPotions"}},
    {"ESP — Equipment", Color3.fromRGB(255,200,55), {"EspFerr","EspArmas","EspAmmo","EspCura","EspChaves","EspAnvil","EspBlueprint"}},
}
for _,grp in ipairs(espGroupOrder) do
    local title,cor,keys=group[1],group[2],group[3]
...
local BRING_CATS = {
    ...
    {key="BArmas",    label="⚔️ Bring Armas",       cor=Color3.fromRGB(255,70,70),   desc="Spear, Ice Sword, Crossbow, Revolver, Rifle…",
     nomes={"Spear","Morningstar","Katana","Laser Sword","LaserSword","Ice Sword","IceSword","Trident","Poison Spear","PoisonSpear","Infernal Sword","InfernalSword","Obsidiron Hammer","ObsidironHammer","Scythe","Crossbow","Infernal Crossbow","InfernalCrossbow","Bouncing Blade","BouncingBlade","Vampire Scythe","VampireScythe","Revolver","Rifle","Tactical Shotgun","TacticalShotgun","Ray Gun","RayGun","Laser Cannon","LaserCannon","Flamethrower","Snowball","Frozen Shuriken","FrozenShuriken","Kunai","Witch Potion","WitchPotion","Wildfire","Blowpipe","Air Rifle","AirRifle"}},
    {key="BAmmo", label="🔫 Bring Ammunition", color=Color3.fromRGB(255,155,60), desc="Revolver Ammo, Rifle Ammo, Shotgun Ammo",
     names={"Revolver Ammo","RevolverAmmo","Rifle AmmoRifleAmmoShotgun AmmoShotgunAmmo"}},
...
local function makeBringRow(bcat)
    ...
    labelName.Font=Enum.Font.GothamBold; labelName.Text=bcat.label; labelName.TextColor3=Color3.fromRGB(225,230,245)
