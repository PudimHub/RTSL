...
-- ═══════════════════════════════════════════════════════════════════
-- HELPER: Cards agrupados navy para aba Farm
-- ═══════════════════════════════════════════════════════════════════
local function _nfc(loFn)
    local c2=Instance.new("Frame",Pages["Farm"])
    c2.BackgroundColor3=_NB; c2.BackgroundTransparency=0.28
    ...
    s2.Color=_NS; s2.Thickness=1; s2.Transparency=0.50
    s2.ApplyStrokeMode=Enum.ApplyStrokeMode.Border
    return c2
end

local function _nfd(c2,y)
    local d2=Instance.new("Frame",c2); d2.BackgroundColor3=_ND
...
local function _nfb(c2,y,lbl,cor,onClick)
    ...
    btn.BackgroundColor3=cor or _ON; btn.BackgroundTransparency=0.15; btn.BorderSizePixel=0
...
local function _nfSec(title, cor)
    ...
    local pill=Instance.new("Frame",sec); pill.BackgroundColor3=cor or _ON; pill.BorderSizePixel=0
...
do
    ...
    kaCk.Text="✕"; kaCk.TextColor3=_OF; kaCk.TextSize=11; kaCk.ZIndex=10
    ...
    kaBtnClick.MouseButton1Click:Connect(function()
        ...
        TweenService:Create(kaPill,TweenInfo.new(0.18),{BackgroundColor3=kaEnabled and _ON or _OF}):Play()
        ...
        kaCk.Text=kaEnabled and "✓" or "✕"; kaCk.TextColor3=kaEnabled and _ON or _OF
        if kaEnabled then
            startKillAura()
...
do
    ...
    tl.TextColor3=_NT; tl.TextSize=10; tl.TextXAlignment=Enum.TextXAlignment.Left
    ...
    kaValLbl.TextColor3=_NT; kaValLbl.TextSize=11; kaValLbl.ZIndex=7
...
aeTitleLbl.TextColor3=_NT; aeTitleLbl.TextSize=11; aeTitleLbl.TextXAlignment=Enum.TextXAlignment.Left
...
aeCk2.Text="✕"; aeCk2.TextColor3=_OF; aeCk2.TextSize=11; aeCk2.ZIndex=11

-- Div 1
local _aeD1=Instance.new("Frame",aeCard); _aeD1.BackgroundColor3=_ND
...
aeBtn.MouseButton1Click:Connect(function()
    ...
    TweenService:Create(aePill,TweenInfo.new(0.18),{BackgroundColor3=aeEnabled and _ON or _OF}):Play()
    ...
    aeCk2.Text=aeEnabled and '✓' or '✕'; aeCk2.TextColor3=aeEnabled and _ON or _OF
...
afcTit.TextColor3=_NT; afcTit.TextSize=11; afcTit.TextXAlignment=Enum.TextXAlignment.Left
...
-- Div
local _afD=Instance.new("Frame",afcCard); _afD.BackgroundColor3=_ND
...
do
    ...
    tit.TextColor3=_NT; tit.TextSize=11; tit.TextXAlignment=Enum.TextXAlignment.Left
    ...
    card._updateState=_updateState
    -- Div
    local _d1=Instance.new("Frame",card); _d1.BackgroundColor3=_ND; _d1.BackgroundTransparency=0.58; _d1.BorderSizePixel=0
...
amgTit.TextColor3=_NT; amgTit.TextSize=11; amgTit.TextXAlignment=Enum.TextXAlignment.Left
...
-- div
local _amgD=Instance.new("Frame",amgCard); _amgD.BackgroundColor3=_ND; _amgD.BackgroundTransparency=0.58; _amgD.BorderSizePixel=0
...
fbcTitLbl.TextColor3=_NT; fbcTitLbl.TextSize=11; fbcTitLbl.TextXAlignment=Enum.TextXAlignment.Left
...
-- div
local _fbcD=Instance.new("Frame",fbcCard); _fbcD.BackgroundColor3=_ND; _fbcD.BackgroundTransparency=0.58; _fbcD.BorderSizePixel=0
