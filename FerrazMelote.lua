...
MainStroke.Color = Color3.fromRGB(52, 211, 153); MainStroke.Thickness = 1.8; MainStroke.Transparency = 0.55
...
TopBar.Name = "TopBar"
TopBar.BackgroundColor3 = Color3.fromRGB(10, 15, 12)
TopBar.Size = UDim2.new(1, 0, 0, 40)
TopBar.BorderSizePixel = 0
TopBar.ZIndex = 3
Instance.new("UICorner", TopBar).CornerRadius = UDim.new(0, 12)
local topFix = Instance.new("Frame", TopBar)
topFix.BackgroundColor3 = Color3.fromRGB(10,15,12)
...
TitleLabel.TextColor3 = Color3.fromRGB(52, 211, 153)
...
for _, d in ipairs(btnData) do
    ...
    btn.ImageColor3 = Color3.fromRGB(70, 110, 85); btn.ZIndex = 5
    ...
    btn.MouseLeave:Connect(function() TweenService:Create(btn, TweenInfo.new(0.15), {ImageColor3 = Color3.fromRGB(70,110,85)}):Play() end)
...
SideBar.Name = "SideBar"; SideBar.BackgroundColor3 = Color3.fromRGB(10, 15, 12)
...
Divider.BackgroundColor3 = Color3.fromRGB(7,11,9); Divider.BorderSizePixel = 0
...
ContentArea.Name = "ContentArea"; ContentArea.BackgroundColor3 = Color3.fromRGB(14,20,17)
...
Footer.BackgroundColor3 = Color3.fromRGB(9,13,11); Footer.BorderSizePixel = 0
...
AvatarBg.BackgroundColor3 = Color3.fromRGB(52,211,153)
...
OnlineDot.BackgroundColor3 = Color3.fromRGB(74, 222, 128); OnlineDot.BorderSizePixel = 0
...
FName.Text = Player.DisplayName; FName.TextColor3 = Color3.fromRGB(200, 240, 220)
...
FTag.Text = "@"..Player.Name; FTag.TextColor3 = Color3.fromRGB(70, 110, 88)
...
FLangLbl.TextColor3=Color3.fromRGB(52, 211, 153); FLangLbl.TextSize=8; FLangLbl.ZIndex=7
...
for _, t in ipairs(TabConfig) do
    ...
    page.ScrollBarThickness = 4; page.ScrollBarImageColor3 = C_ACCENT
...
local function createTabIcon(parent,key)
    ...
    if key=="Info" then
        p(mkCircle(cont,10,10,9,ic)); local inner=mkCircle(cont,10,10,7,Color3.fromRGB(10,15,12)); inner.ZIndex=cont.ZIndex+1
    ...
    elseif key=="Esp" then
        p(mkRect(cont,2,6,16,8,ic,8)); local ei=mkRect(cont,3,7,14,6,Color3.fromRGB(10,15,12),7); ei.ZIndex=cont.ZIndex+1
        p(mkCircle(cont,10,10,4,ic)); local pi=mkCircle(cont,10,10,2,Color3.fromRGB(10,15,12)); pi.ZIndex=cont.ZIndex+3
    ...
    elseif key=="Bring" then
        ...
        p(mkRect(cont,2,14,5,4,Color3.fromRGB(220,80,80),2)); p(mkRect(cont,13,14,5,4,Color3.fromRGB(52,211,153),2))
    ...
    elseif key=="Configuracoes" then
        p(mkCircle(cont,10,10,5,ic)); local ci=mkCircle(cont,10,10,3,Color3.fromRGB(10,15,12)); ci.ZIndex=cont.ZIndex+2
    ...
    elseif key=="AvancadoFuncoes" then
        ...
        local furo=mkCircle(cont,15,6,3,Color3.fromRGB(10,15,12)); furo.ZIndex=cont.ZIndex+2
        p(mkRect(cont,8,9,6,3,ic,1))
    elseif key=="Teleportar" then
        -- ícone de alfinete/pin de mapa
        p(mkCircle(cont,10,7,6,ic))
        local ci=mkCircle(cont,10,7,3,Color3.fromRGB(10,15,12)); ci.ZIndex=cont.ZIndex+2
...
local function makeGroupLabel(text, trKey, groupTabs)
    ...
    if layoutOrder>1 then
        local line=Instance.new("Frame",SideBar); line.BackgroundColor3=Color3.fromRGB(20, 32, 26)
...
local function makeTab(cfg,groupTabs)
    ...
    bar.Position=UDim2.new(1,-3,0.15,0); bar.Size=UDim2.new(0,3,0.7,0); bar.Visible=false; bar.ZIndex=6
