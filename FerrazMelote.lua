...
local function nCreateCard(cfg, tipo)
    ...
    -- Borda cartoon grossa com accent
    ...
    -- Shine na barra lateral
    local sideShine = Instance.new("Frame",sideBar)
    sideShine.Size = UDim2.new(1,0,0.35,0); sideShine.BackgroundColor3 = Color3.fromRGB(255,255,255)
    sideShine.BackgroundTransparency = 0.5; sideShine.BorderSizePixel = 0; sideShine.ZIndex = 522
    Instance.new("UICorner",sideShine).CornerRadius = UDim.new(1,0)

    -- ── Ícone (círculo grande, estilo cartoon) ──────────────────
    ...
    iconStroke.Color       = Color3.fromRGB(20,10,0)
...
local function makeBringRow(bcat)
    local row=Instance.new("Frame",Pages["Bring"]); row.BackgroundColor3=Color3.fromRGB(38,22,10)
    ...
    labelDesc.Font=Enum.Font.Gotham; labelDesc.Text=bcat.desc or ""; labelDesc.TextColor3=Color3.fromRGB(160,120,60)
    ...
    local limparStroke=Instance.new("UIStroke",btnLimpar); limparStroke.Color=Color3.fromRGB(180,130,50); limparStroke.Thickness=1; limparStroke.Transparency=0.5
...
local function makePlToggle(lbl_txt, desc_txt, cor, onToggle)
    ...
    Instance.new("UICorner",row).CornerRadius=UDim.new(0,9)
    local rowS=Instance.new("UIStroke",row); rowS.Color=Color3.fromRGB(252,198,0); rowS.Thickness=2.5; rowS.Transparency=0.72
...
local function makeSliderBar(parentPage, lbl_txt, desc_txt, cor, minV, maxV, initVal, onChange)
    ...
    row.BackgroundColor3 = Color3.fromRGB(38,22,10); row.BorderSizePixel = 0
    ...
    td.Text=desc_txt; td.TextColor3=Color3.fromRGB(160,120,60); td.TextSize=9; td.TextXAlignment=Enum.TextXAlignment.Left; td.ZIndex=7
...
cfgStroke.Color = Color3.fromRGB(100,70,30); cfgStroke.Thickness = 1.2
...
bpBtnRef.BackgroundTransparency = 0.1; bpBtnRef.BorderSizePixel = 0
...
bpBtnClr.BackgroundTransparency = 0.1; bpBtnClr.BorderSizePixel = 0
...
bpBackBtn.BackgroundTransparency = 0.1; bpBackBtn.BorderSizePixel = 0
...
local function bpAddEntryToGroup(grp, name, pos, biomeLabel, biomeIcon)
    ...
    if wasVisited then
        ...
        row.BackgroundColor3 = Color3.fromRGB(40,26,12)
    end
    local rowS = Instance.new("UIStroke",row)
    rowS.Color = wasVisited and Color3.fromRGB(200,60,60) or Color3.fromRGB(80,55,25)
    rowS.Thickness = 1.5
    ...
    rowHit.MouseEnter:Connect(function()
        if not entry.visited then
            TweenService:Create(row,TweenInfo.new(0.1),{BackgroundColor3=Color3.fromRGB(45,28,15)}):Play()
        end
    end)
...
cpBtnRef.BackgroundColor3 = Color3.fromRGB(22,10,0); cpBtnRef.BackgroundTransparency = 0.1
...
cpBtnClr.BackgroundColor3 = Color3.fromRGB(200,50,50); cpBtnClr.BackgroundTransparency = 0.1
...
local function cpAddEntry(grp, name, pos, biomeLabel, biomeIcon)
    ...
    local rowS = Instance.new("UIStroke",row)
    rowS.Color = wasVisited and Color3.fromRGB(200,60,60) or Color3.fromRGB(70,45,15); rowS.Thickness = 1.5
...
local function makeToggle(page, lo_fn, lbl_txt, desc_txt, cor, onToggle)
    ...
    row.BackgroundColor3=Color3.fromRGB(40,24,12); row.BorderSizePixel=0
    row.Size=UDim2.new(1,0,0,62); row.LayoutOrder=lo_fn(); row.ZIndex=5
    Instance.new("UICorner",row).CornerRadius=UDim.new(0,10)
    local rowS=Instance.new("UIStroke",row)
    rowS.Color=Color3.fromRGB(252,198,0); rowS.Thickness=4; rowS.Transparency=0.6
    -- Barra colorida lateral esquerda
    local lbar=Instance.new("Frame",row)
    lbar.BackgroundColor3=cor; lbar.BorderSizePixel=0
    lbar.Size=UDim2.new(0,4,0.7,0); lbar.Position=UDim2.new(0,0,0.15,0); lbar.ZIndex=6
    ...
    tl.Text=lbl_txt; tl.TextColor3=Color3.fromRGB(255,235,190); tl.TextSize=12
    tl.TextXAlignment=Enum.TextXAlignment.Left; tl.ZIndex=7
    local td=Instance.new("TextLabel",row); td.BackgroundTransparency=1
    td.Position=UDim2.new(0,16,0,30); td.Size=UDim2.new(1,-80,0,26); td.Font=Enum.Font.Gotham
    td.Text=desc_txt; td.TextColor3=Color3.fromRGB(160,120,70); td.TextSize=9
    td.TextXAlignment=Enum.TextXAlignment.Left; td.TextWrapped=true; td.ZIndex=7
    -- Pill toggle (estilo cartoon)
    local pill=Instance.new("Frame",row)
    pill.BackgroundColor3=Color3.fromRGB(45,28,15); pill.BorderSizePixel=0
    pill.Position=UDim2.new(1,-58,0.5,-13); pill.Size=UDim2.new(0,50,0,26); pill.ZIndex=9
    Instance.new("UICorner",pill).CornerRadius=UDim.new(1,0)
    local pillS=Instance.new("UIStroke",pill)
    pillS.Color=Color3.fromRGB(20,10,0); pillS.Thickness=3
    local knob=Instance.new("Frame",pill)
    knob.BackgroundColor3=Color3.fromRGB(180,140,80); knob.BorderSizePixel=0
    knob.Position=UDim2.new(0,2,0.5,-11); knob.Size=UDim2.new(0,22,0,22); knob.ZIndex=10
    Instance.new("UICorner",knob).CornerRadius=UDim.new(1,0)
    local knobStroke=Instance.new("UIStroke",knob); knobStroke.Color=Color3.fromRGB(120,80,20); knobStroke.Thickness=1.5
    local state=false
    local btn=Instance.new("TextButton",row); btn.BackgroundTransparency=1; btn.Size=UDim2.new(1,0,1,0); btn.Text=""; btn.ZIndex=11
    -- hover
    btn.MouseEnter:Connect(function()
        TweenService:Create(row,TweenInfo.new(0.12),{BackgroundColor3=Color3.fromRGB(50,32,15)}):Play()
        TweenService:Create(rowS,TweenInfo.new(0.12),{Transparency=0.35}):Play()
    end)
    btn.MouseLeave:Connect(function()
        TweenService:Create(row,TweenInfo.new(0.12),{BackgroundColor3=Color3.fromRGB(40,24,12)}):Play()
        TweenService:Create(rowS,TweenInfo.new(0.12),{Transparency=state and 0.2 or 0.6}):Play()
    end)
    btn.MouseButton1Click:Connect(function()
        state=not state
        TweenService:Create(pill,TweenInfo.new(0.22,Enum.EasingStyle.Quad),{
            BackgroundColor3=state and cor or Color3.fromRGB(45,28,15)
        }):Play()
        TweenService:Create(knob,TweenInfo.new(0.22,Enum.EasingStyle.Back,Enum.EasingDirection.Out),{
            Position=state and UDim2.new(1,-24,0.5,-11) or UDim2.new(0,2,0.5,-11),
            BackgroundColor3=state and Color3.fromRGB(255,255,255) or Color3.fromRGB(180,140,80)
        }):Play()
        ...
        TweenService:Create(lbar,TweenInfo.new(0.2),{
            BackgroundColor3=state and cor or Color3.fromRGB(100,65,25)
        }):Play()
        if state then
            Notify.success(lbl_txt, "✓ Ativado")
        else
...
local function makeSlider(page, lo_fn, lbl_txt, minV, maxV, defV, cor, fmt, onChange)
    ...
    Instance.new("UICorner",row).CornerRadius=UDim.new(0,10)
    local rowS=Instance.new("UIStroke",row)
    rowS.Color=Color3.fromRGB(252,198,0); rowS.Thickness=2.5; rowS.Transparency=0.72
    local tl=Instance.new("TextLabel",row); tl.BackgroundTransparency=1
    tl.Position=UDim2.new(0,14,0,8); tl.Size=UDim2.new(1,-100,0,18); tl.Font=Enum.Font.GothamBold
    tl.Text=lbl_txt; tl.TextColor3=Color3.fromRGB(255,235,190); tl.TextSize=11
    tl.TextXAlignment=Enum.TextXAlignment.Left; tl.ZIndex=7
    local valLbl=Instance.new("TextLabel",row); valLbl.BackgroundTransparency=1
    ...
    valLbl.TextXAlignment=Enum.TextXAlignment.Right; valLbl.ZIndex=7
    -- Track
    local track=Instance.new("Frame",row); track.BackgroundColor3=Color3.fromRGB(45,28,15)
