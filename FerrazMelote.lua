...
-- Uso: T("freezeTitle") em qualquer lugar do script
...
local espGroupOrder={
    {T("espGroupEntities"), Color3.fromRGB(88,101,242), {"Players","Kids","AnimPassivo","AnimAgressivo","Monstros","Cultistas","Aliens"}},
    {T("espGroupResources"), Color3.fromRGB(255,130,40), {"EspLog","EspCombustivel","EspCarcacas","EspSucata","EspMateriais"}},
    {T("espGroupFood"), Color3.fromRGB(255,120,170), {"EspComidas","EspPeixes","EspSementes","EspPocoes"}},
    {T("espGroupEquipment"), Color3.fromRGB(255,200,55), {"EspFerr","EspArmas","EspAmmo","EspCura","EspChaves","EspBigorna","EspBlueprint"}},
}
...
local function executarBring(key)
    ...
    for _,obj in ipairs(descs) do
        ...
        pcall(function()
            ...
            -- Suporte a BasePart direto OU Model com BasePart dentro
            ...
            elseif obj:IsA("Model") and not obj:FindFirstChildWhichIsA("Humanoid") then
                ...
                if p2 then targetPart = p2; checkName = obj.Name:lower() end
            end
            ...
            -- Se for Model, move todos os BasePart
            ...
            count+=1; table.insert(trazidos,{obj=targetPart,pos=target})
        end)
    end
    if #trazidos>0 then
        task.spawn(function()
...
makePlSec(T("plSecSpeed"), Color3.fromRGB(255,200,50))
...
makePlSec(T("plSecFly"), Color3.fromRGB(100,200,255))
...
makePlSec(T("plSecUtil"), Color3.fromRGB(255,210,80))
...
kaSecLbl.Font = Enum.Font.GothamBlack; kaSecLbl.Text = "⚔️  KILL AURA"
...
kaTitleLbl.Font = Enum.Font.GothamBold; kaTitleLbl.Text = "⚔️  Kill Aura"
...
kaDescLbl.Text = "Equipe uma arma e clique normalmente — 1 clique acerta TODOS os mobs no range."
...
kaRLabel.Font = Enum.Font.GothamBold; kaRLabel.Text = "⚔️ Range"
...
makeSec(Pages["AvancadoFarm"], afNextLO, T("avFarmSecFreeze"), Color3.fromRGB(0,200,255))
