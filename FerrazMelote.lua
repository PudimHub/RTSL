...
end); if not _dbgOk_5249 then warn('[PudimHub DEBUG] Erro na secao ESP1: '..tostring(_dbgErr_5249)) end
local _dbgOk_6203, _dbgErr_6203 = pcall(function() -- [[ ESP2 ]]
...
end); if not _dbgOk_6203 then warn('[PudimHub DEBUG] Erro na secao ESP2: '..tostring(_dbgErr_6203)) end
