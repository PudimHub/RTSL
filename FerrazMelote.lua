...
end -- fecha escopo do (8689) — BAÚS ACS vars
...
end -- fecha do wrapper UI (8838)
end -- fecha escopo do (8773) — BAÚS INSTANTÂNEOS vars
...
end -- fecha escopo do (9000) — PIB vars
...
end -- fecha do externo (NIGHT vars)
...
local function bpScanBuildings(isRefresh)
    ...
    task.spawn(function()
        ...
        for _, obj in ipairs(workspace:GetDescendants()) do
            ...
            local nm = obj.Name:lower()
            -- Filtra itens que não são construções (baús, armadilhas, etc.)
