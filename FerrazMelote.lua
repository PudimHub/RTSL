...
NHistScroll.CanvasSize=UDim2.new(0,0,0,2000); NHistScroll.CanvasSize=UDim2.new(0,0,0,0)
...
SideBar.CanvasSize = UDim2.new(0,0,0,2000); SideBar.ZIndex = 3
...
FLangFrame.Size = UDim2.new(0,52,0,20)
FLangFrame.ZIndex = 6
...
FLangLbl.Size=UDim2.new(1,0,1,0)
...
for _, t in ipairs(TabConfig) do
    ...
    page.BorderSizePixel = 0; page.CanvasSize = UDim2.new(0,0,0,3000)
...
-- Garante sidebar visível após criar todos os tabs
...
histScroll.CanvasSize = UDim2.new(0,0,0,2000)
...
local function mkStatBadge(parent, x, y, text, cor, textCor)
    ...
    bg.Position = UDim2.new(0,x,0,y); bg.Size = UDim2.new(0,60,0,17); bg.ZIndex = 7
    ...
    for gi, grp in ipairs(entry.grupos) do
        ...
        for _, item in ipairs(grp.items) do
            ...
            if not isOld and item.tipo ~= "old" then
                ...
                tagBg.Position = UDim2.new(1,-6,0,iy+3); tagBg.Size = UDim2.new(0,32,0,12); tagBg.ZIndex = 8
...
local function makeMultiDropdown(parent, yPos, cfg)
    ...
    for _, catKey in ipairs(catOrder) do
        ...
        catLbl.Size                   = UDim2.new(0, 80, 1, 0)
...
bpGroupView.CanvasSize = UDim2.new(0,0,0,3000); bpGroupView.CanvasSize = UDim2.new(0,0,0,0)
...
local function bpGetOrCreateGroup(biomeLabel, biomeIcon, biomeCor)
    ...
    scroll.ScrollBarImageColor3=COR
    scroll.CanvasSize=UDim2.new(0,0,0,3000); scroll.CanvasSize=UDim2.new(0,0,0,0)
...
cpGroupView.CanvasSize = UDim2.new(0,0,0,3000); cpGroupView.CanvasSize = UDim2.new(0,0,0,0)
...
cpRarScroll.CanvasSize = UDim2.new(0,0,0,3000); cpRarScroll.CanvasSize = UDim2.new(0,0,0,0)
...
cpDetailScroll.CanvasSize = UDim2.new(0,0,0,3000); cpDetailScroll.CanvasSize = UDim2.new(0,0,0,0)
...
_amgList.CanvasSize = UDim2.new(0,0,0,0); _amgList.CanvasSize = UDim2.new(0,0,0,1000)
_amgList.ZIndex = 461
...
local function makeTeleportPanel(cfg)
    ...
    card.BorderSizePixel = 0
    card.Size = UDim2.new(1,0,0,0)  -- height updated after build
    ...
    cLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
        card.Size = UDim2.new(1,0,0,cLayout.AbsoluteContentSize.Y)
    end)
