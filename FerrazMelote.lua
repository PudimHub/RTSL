...
-- Translações dos textos principais da interface
local TRANSLATIONS = {
    ["PT-BR"] = {
        ...
        tabInfo="Info", tabStatus="Status", tabFarm="Farm", tabEsp="ESP",
        tabBring="Bring", tabAvFarm="Avançado Farm", tabPlayer="Player",
        tabConfig="Configurações", tabAvFunc="Avançado Funcoes",
        groupGeral="GERAL", groupCombate="COMBATE", groupExtra="EXTRA",
        langSystem="Sistema de idiomas", langCurrent="Idioma",
        popupTitle="Você deseja mudar de linguagem?",
        popupYes="Sim", popupNo="Não",
    ...
    ["EN-US"] = {
        ...
        tabInfo="Info", tabStatus="Status", tabFarm="Farm", tabEsp="ESP",
        tabBring="Bring", tabAvFarm="Advanced Farm", tabPlayer="Player",
        tabConfig="Settings", tabAvFunc="Advanced Functions",
        groupGeral="GENERAL", groupCombate="COMBAT", groupExtra="EXTRA",
        langSystem="Language System", langCurrent="Language",
        popupTitle="Do you want to change language?",
        popupYes="Yes", popupNo="No",
    ...
    ["ES-ES"] = {
        notifTitle="Notificaciones", notifDesc="Activa/desactiva todas las notificaciones del hub",
        notifOn="ON", notifOff="OFF",
        infoStatus="🎮  Jugando 99 Nights in the Forest",
        tabInfo="Info", tabStatus="Estado", tabFarm="Farm", tabEsp="ESP",
        tabBring="Bring", tabAvFarm="Farm Avanzado", tabPlayer="Jugador",
        tabConfig="Configuración", tabAvFunc="Funciones Avanzadas",
        groupGeral="GENERAL", groupCombate="COMBATE", groupExtra="EXTRA",
        langSystem="Sistema de idiomas", langCurrent="Idioma",
        popupTitle="¿Deseas cambiar el idioma?",
        popupYes="Sí", popupNo="No",
        notifWelcome="¡Cargado!", notifWelcomeMsg="¡Bienvenido, ",
        notifTip="Consejo", notifTipMsg="Pasa el ratón sobre la notificación para pausar el temporizador 🔔",
    ...
    ["ZH-CN"] = {
        ...
        tabInfo="信息", tabStatus="状态", tabFarm="农场", tabEsp="ESP",
    ...
    ["HI-IN"] = {
        ...
        tabInfo="जानकारी", tabStatus="स्थिति", tabFarm="फार्म", tabEsp="ESP",
        ...
        popupTitle="क्या आप भाषा बदलना चाहते हैं?",
        popupYes="हाँ", popupNo="नहीं",
    ...
    ["AR-SA"] = {
        ...
        tabInfo="معلومات", tabStatus="الحالة", tabFarm="مزرعة", tabEsp="ESP",
        ...
        popupTitle="هل تريد تغيير اللغة؟",
        popupYes="نعم", popupNo="لا",
        notifWelcome="تم التحميل!", notifWelcomeMsg="مرحباً، ",
        notifTip="نصيحة", notifTipMsg="مرر الماوس على الإشعار لإيقاف المؤقت مؤقتاً 🔔",
    ...
    ["BN-BD"] = {
        ...
        tabInfo="তথ্য", tabStatus="অবস্থা", tabFarm="ফার্ম", tabEsp="ESP",
        ...
        popupTitle="আপনি কি ভাষা পরিবর্তন করতে চান?",
        popupYes="হ্যাঁ", popupNo="না",
    ...
    ["RU-RU"] = {
        ...
        tabInfo="Инфо", tabStatus="Статус", tabFarm="Фарм", tabEsp="ESP",
        tabBring="Принести", tabAvFarm="Продвинутый Фарм", tabPlayer="Игрок",
        tabConfig="Настройки", tabAvFunc="Продвинутые Функции",
        groupGeral="ОБЩЕЕ", groupCombate="БОЕВЫЕ", groupExtra="ДОПОЛН.",
        langSystem="Система языков", langCurrent="Язык",
        popupTitle="Вы хотите изменить язык?",
        popupYes="Да", popupNo="Нет",
...
local function applyLanguage(lang)
    ...
    -- Atualizar labels rastreados
    for key, lbl in pairs(langTrackedLabels) do
        if T[key] then lbl.Text = T[key] end
    end
end
...
-- ══════════════════════════════════════════════════════
-- POPUP CONFIRMAÇÃO DE IDIOMA
-- ══════════════════════════════════════════════════════
local LangPopupOverlay = Instance.new("Frame", ScreenGui)
LangPopupOverlay.Name = "LangPopupOverlay"
LangPopupOverlay.BackgroundColor3 = Color3.fromRGB(0,0,0)
LangPopupOverlay.BackgroundTransparency = 0.5
LangPopupOverlay.BorderSizePixel = 0
LangPopupOverlay.Size = UDim2.new(1,0,1,0)
LangPopupOverlay.ZIndex = 600
LangPopupOverlay.Visible = false

local LangPopup = Instance.new("Frame", LangPopupOverlay)
LangPopup.Name = "LangPopup"
LangPopup.BackgroundColor3 = Color3.fromRGB(28,29,36)
LangPopup.BorderSizePixel = 0
LangPopup.AnchorPoint = Vector2.new(0.5,0.5)
LangPopup.Position = UDim2.new(0.5,0,0.5,0)
LangPopup.Size = UDim2.new(0,280,0,0)
LangPopup.ZIndex = 601
...
lpStroke.Color = Color3.fromRGB(88,101,242); lpStroke.Thickness = 1.8

-- Ícone topo
local lpIconBg = Instance.new("Frame",LangPopup)
lpIconBg.BackgroundColor3 = Color3.fromRGB(88,101,242)
lpIconBg.BackgroundTransparency = 0.75
lpIconBg.BorderSizePixel = 0
lpIconBg.AnchorPoint = Vector2.new(0.5,0)
lpIconBg.Position = UDim2.new(0.5,0,0,18)
lpIconBg.Size = UDim2.new(0,48,0,48)
lpIconBg.ZIndex = 602
Instance.new("UICorner",lpIconBg).CornerRadius = UDim.new(1,0)
local lpIconLbl = Instance.new("TextLabel",lpIconBg)
lpIconLbl.BackgroundTransparency=1; lpIconLbl.Size=UDim2.new(1,0,1,0)
lpIconLbl.Font=Enum.Font.GothamBold; lpIconLbl.Text="🌐"; lpIconLbl.TextSize=24; lpIconLbl.ZIndex=603

-- Título
local lpTitle = Instance.new("TextLabel",LangPopup)
lpTitle.BackgroundTransparency=1
lpTitle.Position = UDim2.new(0,14,0,76)
lpTitle.Size = UDim2.new(1,-28,0,18)
lpTitle.Font = Enum.Font.GothamBlack
lpTitle.Text = "Você deseja mudar de linguagem?"
lpTitle.TextColor3 = Color3.fromRGB(235,238,255)
lpTitle.TextSize = 12; lpTitle.TextXAlignment = Enum.TextXAlignment.Center
lpTitle.TextWrapped = true; lpTitle.ZIndex = 602

-- Label idioma selecionado
local lpLangLbl = Instance.new("TextLabel",LangPopup)
lpLangLbl.BackgroundTransparency=1
lpLangLbl.Position = UDim2.new(0,14,0,98)
lpLangLbl.Size = UDim2.new(1,-28,0,20)
lpLangLbl.Font = Enum.Font.GothamBold
lpLangLbl.Text = ""
lpLangLbl.TextColor3 = Color3.fromRGB(88,101,242)
lpLangLbl.TextSize = 13; lpLangLbl.TextXAlignment = Enum.TextXAlignment.Center; lpLangLbl.ZIndex = 602

-- Botões
local lpBtnsRow = Instance.new("Frame",LangPopup)
lpBtnsRow.BackgroundTransparency=1; lpBtnsRow.BorderSizePixel=0
lpBtnsRow.Position = UDim2.new(0,14,0,130)
lpBtnsRow.Size = UDim2.new(1,-28,0,38)
lpBtnsRow.ZIndex=602
local lpBtnsList = Instance.new("UIListLayout",lpBtnsRow)
lpBtnsList.FillDirection=Enum.FillDirection.Horizontal
lpBtnsList.Padding=UDim.new(0,10)
lpBtnsList.HorizontalAlignment=Enum.HorizontalAlignment.Center

local lpNoBtn = Instance.new("TextButton",lpBtnsRow)
lpNoBtn.BackgroundColor3=Color3.fromRGB(55,58,72); lpNoBtn.BorderSizePixel=0
lpNoBtn.Size=UDim2.new(0,110,0,36); lpNoBtn.Font=Enum.Font.GothamBold
lpNoBtn.Text="Não"; lpNoBtn.TextColor3=Color3.fromRGB(185,190,210); lpNoBtn.TextSize=12; lpNoBtn.ZIndex=603
Instance.new("UICorner",lpNoBtn).CornerRadius=UDim.new(0,9)

local lpYesBtn = Instance.new("TextButton",lpBtnsRow)
lpYesBtn.BackgroundColor3=Color3.fromRGB(88,101,242); lpYesBtn.BorderSizePixel=0
lpYesBtn.Size=UDim2.new(0,110,0,36); lpYesBtn.Font=Enum.Font.GothamBold
lpYesBtn.Text="Sim"; lpYesBtn.TextColor3=Color3.fromRGB(255,255,255); lpYesBtn.TextSize=12; lpYesBtn.ZIndex=603
Instance.new("UICorner",lpYesBtn).CornerRadius=UDim.new(0,9)

local lpPendingLang = nil
local langInfoLabel = nil    -- preenchido após infoCard ser criado
local langFooterLabel = nil  -- preenchido após Footer ser criado

local function showLangPopup(lang)
    lpPendingLang = lang
    local T = TRANSLATIONS[lang.code] or TRANSLATIONS["PT-BR"]
    lpTitle.Text = T.popupTitle
    lpNoBtn.Text  = T.popupNo
    lpYesBtn.Text = T.popupYes
    lpLangLbl.Text = lang.flag .. "  " .. lang.name
    LangPopupOverlay.Visible = true
    LangPopup.Size = UDim2.new(0,280,0,0)
    TweenService:Create(LangPopup,TweenInfo.new(0.3,Enum.EasingStyle.Back,Enum.EasingDirection.Out),{Size=UDim2.new(0,280,0,182)}):Play()
end

local function hideLangPopup()
    TweenService:Create(LangPopup,TweenInfo.new(0.2,Enum.EasingStyle.Quad),{Size=UDim2.new(0,280,0,0)}):Play()
    task.delay(0.22, function() LangPopupOverlay.Visible=false end)
end

lpNoBtn.MouseButton1Click:Connect(function() hideLangPopup() end)
lpYesBtn.MouseButton1Click:Connect(function()
    if not lpPendingLang then return end
    applyLanguage(lpPendingLang)
    -- Atualiza displays de idioma
    if langInfoLabel then
        langInfoLabel.Text = lpPendingLang.flag .. "  " .. lpPendingLang.short
    end
    if langFooterLabel then
        langFooterLabel.Text = lpPendingLang.flag .. " " .. lpPendingLang.short
    end
    hideLangPopup()
    local T = TRANSLATIONS[lpPendingLang.code] or TRANSLATIONS["PT-BR"]
    task.delay(0.3, function()
        Notify.success(T.langSystem or "Language", (T.notifLangChanged or "Language changed to ")..lpPendingLang.name, 4)
    end)
end)

-- Hover effects nos botões
lpNoBtn.MouseEnter:Connect(function() TweenService:Create(lpNoBtn,TweenInfo.new(0.1),{BackgroundColor3=Color3.fromRGB(70,74,90)}):Play() end)
lpNoBtn.MouseLeave:Connect(function() TweenService:Create(lpNoBtn,TweenInfo.new(0.1),{BackgroundColor3=Color3.fromRGB(55,58,72)}):Play() end)
lpYesBtn.MouseEnter:Connect(function() TweenService:Create(lpYesBtn,TweenInfo.new(0.1),{BackgroundColor3=Color3.fromRGB(105,120,255)}):Play() end)
lpYesBtn.MouseLeave:Connect(function() TweenService:Create(lpYesBtn,TweenInfo.new(0.1),{BackgroundColor3=Color3.fromRGB(88,101,242)}):Play() end)
...
for idx, lang in ipairs(LANGUAGES) do
    ...
    lBtn.MouseButton1Click:Connect(function()
        ...
        -- Atualiza label corrente no header
...
-- ══════════════════════════════════════════════════════
local BIOMES_99N = {
    { name="🌲 Floresta",   desc="Bioma inicial",       col=Color3.fromRGB(80,200,100),  keywords={"forestground","foresttree","greentree","treestump","forestbiome","spawnpoint","forest","spawn","tree","grass","grassland"} },
    { name="🏜️ Deserto",   desc="Areia e cactos",      col=Color3.fromRGB(230,180,60),  keywords={"desert","desertground","cactus","sanddune","desertrock","desertbiome","sandbiome","sand","dune"} },
    { name="❄️ Tundra",    desc="Gelo e neve",          col=Color3.fromRGB(160,220,255), keywords={"tundra","arctic","tundraground","icesheet","snowfield","tundrabiome","icebiome","arcticbiome","snowbiome","snow","ice","frozen"} },
    { name="🌋 Vulcão",    desc="Lava e cinzas",        col=Color3.fromRGB(255,90,40),   keywords={"volcano","lavapool","lavarock","volcanoground","lavabiome","volcanozone","volcanobiome","lavafloor","lava","magma","volcanic"} },
    { name="🌿 Pântano",   desc="Banhado e lama",       col=Color3.fromRGB(100,180,80),  keywords={"swamp","swampground","swamptree","bog","swampbiome","marshbiome","marsh","mud","swampland"} },
    { name="⛏️ Caverna",   desc="Subterrâneo",          col=Color3.fromRGB(140,110,200), keywords={"cave","underground","caveentrance","cavern","cavebiome","cavetunnel","caveground","cavewall","cave","tunnel","underground"} },
    { name="👽 Área Alien",desc="Zona extraterrestre",  col=Color3.fromRGB(130,255,160), keywords={"alien","ufo","crashsite","alienbase","ufowreck","alienbiome","alienzone","alienground","alienarea","extraterrestrial"} },
    { name="🎃 Halloween", desc="Abóboras e bruxas",    col=Color3.fromRGB(255,130,30),  keywords={"halloween","halloweenbiome","pumpkin","hauntedhouse","graveyard","cauldron","ghost","haunted","spooky"} },
    { name="🌊 Praia",     desc="Areia e mar",          col=Color3.fromRGB(60,180,255),  keywords={"beach","shore","coastalrock","beachsand","coastalbiome","shorebiome","coastal","ocean","sea","island"} },
    { name="⛰️ Montanha",  desc="Picos e penhascos",    col=Color3.fromRGB(180,160,140), keywords={"mountain","mountainpeak","mountainbiome","highground","peak","cliffbiome","cliff","highland","ridge","summit"} },
}
...
-- ══════════════════════════════════════════════════════
local CRIANCAS_99N = {
    { name="🦕 Dino Kid",   desc="Protegida por Lobos • 1ª criança",       col=Color3.fromRGB(100,220,130),
      keywords={"dinokid","dino_kid","dinoKid","DinokiD","DinokId","child_dino","childdino","kid_dino","kiddino","npc_dino","dinoboy","dinogirl","dinosaurkid","dino","child1","lost_child_1","lostchild1","missingchild1","kid1"} },
    { name="🦑 Squid Kid",  desc="Protegida por Lobos Alfa • 2ª criança",  col=Color3.fromRGB(120,180,255),
      keywords={"squidkid","squid_kid","squidKid","SquidkiD","child_squid","childsquid","kid_squid","kidsquid","npc_squid","squidboy","squidgirl","squid","child2","lost_child_2","lostchild2","missingchild2","kid2"} },
    { name="🐙 Kraken Kid", desc="Protegida por Ursos • 3ª criança",        col=Color3.fromRGB(180,130,255),
      keywords={"krakenkid","kraken_kid","krakenKid","KrakenkiD","child_kraken","childkraken","kid_kraken","kidkraken","npc_kraken","krakenboy","krakengirl","kraken","child3","lost_child_3","lostchild3","missingchild3","kid3"} },
    { name="🐨 Koala Kid",  desc="Protegida por Ursos Alfa • 4ª criança",  col=Color3.fromRGB(255,210,100),
      keywords={"koalakid","koala_kid","koalaKid","KoalakiD","child_koala","childkoala","kid_koala","kidkoala","npc_koala","koalaboy","koalagirl","koala","child4","lost_child_4","lostchild4","missingchild4","kid4"} },
}
