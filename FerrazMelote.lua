...
local NOTIF_TIPOS = {
    success     = { title="Sucesso",    accent=Color3.fromRGB(74, 222, 128),  icon="✓", bg=Color3.fromRGB(12,22,17),  sound=5928788253 },
    error       = { title="Erro",       accent=Color3.fromRGB(255,75,75),   icon="✕", bg=Color3.fromRGB(28,12,12),  sound=9119713951 },
    warn        = { title="Aviso",      accent=Color3.fromRGB(255,200,50),  icon="⚠", bg=Color3.fromRGB(24,20,10),  sound=5989740700 },
    info        = { title="Info",       accent=Color3.fromRGB(88,150,255),  icon="ℹ", bg=Color3.fromRGB(10,18,14),  sound=5989740700 },
    achievement = { title="Conquista!", accent=Color3.fromRGB(255,210,60),  icon="★", bg=Color3.fromRGB(22,18,8),  sound=6042053626 },
    custom      = { title="Aviso",      accent=Color3.fromRGB(52,211,153),  icon="◆", bg=Color3.fromRGB(14,20,17),  sound=5989740700 },
}
...
NBadge.BackgroundColor3   = Color3.fromRGB(52,211,153)
...
NBadgeStroke.Color = Color3.fromRGB(52,211,153); NBadgeStroke.Thickness=1.5
...
NHistPanel.Name="HistPanel"; NHistPanel.BackgroundColor3=Color3.fromRGB(12,18,15)
...
local NHistStroke=Instance.new("UIStroke",NHistPanel); NHistStroke.Color=Color3.fromRGB(40,72,55); NHistStroke.Thickness=1.8

local NHistHeader=Instance.new("Frame",NHistPanel)
NHistHeader.BackgroundColor3=Color3.fromRGB(9,14,11); NHistHeader.BorderSizePixel=0
...
NHistHeaderFix.BackgroundColor3=Color3.fromRGB(9,14,11); NHistHeaderFix.BorderSizePixel=0
...
NHistTitle.Text="🔔 Notifications"; NHistTitle.TextColor3=Color3.fromRGB(180, 240, 210)
...
NHistClearBtn.BackgroundColor3=Color3.fromRGB(30,45,35); NHistClearBtn.BackgroundTransparency=0.3
...
NHistScroll.ScrollBarImageColor3=Color3.fromRGB(52,211,153)
...
NEmptyLbl.TextColor3=Color3.fromRGB(60,95,75); NEmptyLbl.TextSize=11
...
local function nAddHistory(cfg, type)
    ...
    hRow.BackgroundColor3 = Color3.fromRGB(16,22,19); hRow.BackgroundTransparency = 0.08
    ...
    hTitle.TextColor3 = Color3.fromRGB(190,240,215); hTitle.TextSize = 10
    ...
    hMsg.TextColor3 = Color3.fromRGB(80,120,98); hMsg.TextSize = 9
...
local function nCreateCard(cfg, tipo)
    ...
    titleLbl.Text     = title
    titleLbl.TextColor3 = Color3.fromRGB(210, 250, 230)
    ...
    if HAS_MSG then
        ...
        msgLbl.Text       = msg
        msgLbl.TextColor3 = Color3.fromRGB(145, 200, 172)
        msgLbl.TextSize   = 12
    ...
    progressBg.BackgroundColor3 = Color3.fromRGB(11, 17, 14)
...
NBadgeBtn.MouseButton1Click:Connect(function()
    ...
    if nHistOpen then
        ...
        TweenService:Create(NBadge,TweenInfo.new(0.2),{BackgroundColor3=Color3.fromRGB(34,197,94)}):Play()
    else
        TweenService:Create(NHistPanel,TweenInfo.new(0.22,Enum.EasingStyle.Quad),{Size=UDim2.new(0,340,0,0)}):Play()
        TweenService:Create(NBadge,TweenInfo.new(0.2),{BackgroundColor3=Color3.fromRGB(52,211,153)}):Play()
...
-- ══════════════════════════════════════════════════════════════
--  TERRA  —  Interface v7   Floresta Sombria
--  Layout : TopBar (34px) | ContentArea | TabBar bottom (42px)
-- ══════════════════════════════════════════════════════════════


-- ══════════════════════════════════════════════════════════════
--  PUDIMHUB ◆ BLOOD OPERATOR  — Interface v6
--  Layout: TopBar(40) compact + Dropdown Menu + ContentArea + StatusBar(24)
--  Estilo: Dark sangue, crimson, operacional, animado
-- ══════════════════════════════════════════════════════════════
...
local TOP_H  = 40
local BOT_H  = 24
local CNT_H  = WIN_H - TOP_H - BOT_H   -- 391
local TAB_H  = 42  -- alias legado

-- ── PALETA BLOOD OPERATOR ──────────────────────────────────────
local C_BASE    = Color3.fromRGB(  6,   4,   4)
local C_SURFACE = Color3.fromRGB( 11,   7,   7)
local C_ELEV    = Color3.fromRGB( 18,  11,  11)
local C_CARD    = Color3.fromRGB( 26,  15,  15)
local C_ACCENT  = Color3.fromRGB(200,  22,  22)   -- vermelho sangue
local C_ACCENT2 = Color3.fromRGB(255,  70,  40)   -- laranja-sangue (hover/warn)
local C_AMBER   = Color3.fromRGB(220, 130,   0)   -- ouro escuro
local C_RED2    = Color3.fromRGB(255,  40,  40)   -- vermelho brilhante
local C_HI      = Color3.fromRGB(245, 230, 230)   -- branco quente
local C_MID     = Color3.fromRGB(155, 100, 100)   -- cinza avermelhado
local C_LOW     = Color3.fromRGB( 65,  38,  38)   -- discreto
local C_STROKE  = Color3.fromRGB( 48,  22,  22)   -- bordas

-- aliases legado
local C_TEXT_OFF   = C_MID
local C_TEXT_ON    = C_HI
local C_BG_HOV     = Color3.fromRGB(28, 14, 14)
local C_BG_ACT     = Color3.fromRGB(34, 12, 12)
local C_ICON_IDLE  = C_LOW
local C_ICON_ACTIVE= C_ACCENT
...
MainFrame.BackgroundColor3 = C_BASE
...
-- Pulso lento na borda
task.spawn(function()
    while true do
        TweenService:Create(MainStroke, TweenInfo.new(2.2, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut),
...
-- Glow de fundo vermelho (canto superior esquerdo)
local _cornerGlow = Instance.new("Frame", MainFrame)
_cornerGlow.BackgroundColor3 = C_ACCENT
_cornerGlow.BackgroundTransparency = 0.88
_cornerGlow.BorderSizePixel = 0
_cornerGlow.Position = UDim2.new(0, -40, 0, -40)
_cornerGlow.Size     = UDim2.new(0, 200, 0, 200)
_cornerGlow.ZIndex   = 2
Instance.new("UICorner", _cornerGlow).CornerRadius = UDim.new(1, 0)
...
local _tpFix = Instance.new("Frame", TopBar)
_tpFix.BackgroundColor3 = C_SURFACE
_tpFix.BorderSizePixel  = 0
_tpFix.Position = UDim2.new(0, 0, 1, -8)
_tpFix.Size     = UDim2.new(1, 0, 0, 8)
_tpFix.ZIndex   = 7

-- Linha separadora TopBar → Content
local TopSep = Instance.new("Frame", MainFrame)
TopSep.BackgroundColor3 = C_STROKE
TopSep.BorderSizePixel  = 0
TopSep.Position         = UDim2.new(0, 0, 0, TOP_H)
TopSep.Size             = UDim2.new(1, 0, 0, 1)
TopSep.ZIndex           = 6

-- Faixa accent vermelha embaixo da topbar
local _topRed = Instance.new("Frame", TopBar)
_topRed.BackgroundColor3 = C_ACCENT
_topRed.BorderSizePixel  = 0
_topRed.Position = UDim2.new(0, 0, 1, -2)
_topRed.Size     = UDim2.new(1, 0, 0, 2)
_topRed.ZIndex   = 9

-- ── LOGO ─────────────────────────────────────────────────────
local _logoDiamond = Instance.new("TextLabel", TopBar)
_logoDiamond.BackgroundTransparency = 1
_logoDiamond.Position = UDim2.new(0, 14, 0.5, -9)
_logoDiamond.Size     = UDim2.new(0, 16, 0, 18)
_logoDiamond.Font     = Enum.Font.GothamBlack
_logoDiamond.Text     = "◆"
_logoDiamond.TextColor3 = C_ACCENT
_logoDiamond.TextSize = 13
_logoDiamond.ZIndex   = 9

local Logo = Instance.new("TextLabel", TopBar)
Logo.BackgroundTransparency = 1
Logo.Position  = UDim2.new(0, 32, 0, 0)
Logo.Size      = UDim2.new(0, 110, 1, 0)
Logo.Font      = Enum.Font.GothamBlack
Logo.Text      = "PUDIMHUB"
Logo.TextColor3 = C_HI
Logo.TextSize   = 13
Logo.TextXAlignment = Enum.TextXAlignment.Left
Logo.ZIndex    = 9

-- Badge versão
local VerBg = Instance.new("Frame", TopBar)
VerBg.BackgroundColor3       = C_ACCENT
VerBg.BackgroundTransparency = 0.80
VerBg.BorderSizePixel        = 0
VerBg.AnchorPoint            = Vector2.new(0, 0.5)
VerBg.Position               = UDim2.new(0, 148, 0.5, 0)
VerBg.Size                   = UDim2.new(0, 0, 0, 16)
VerBg.AutomaticSize          = Enum.AutomaticSize.X
VerBg.ZIndex                 = 9
Instance.new("UICorner", VerBg).CornerRadius = UDim.new(0, 4)
local _vbP = Instance.new("UIPadding", VerBg)
_vbP.PaddingLeft = UDim.new(0, 6); _vbP.PaddingRight = UDim.new(0, 6)
local VerLbl = Instance.new("TextLabel", VerBg)
VerLbl.BackgroundTransparency = 1
VerLbl.Size          = UDim2.new(0, 0, 1, 0)
VerLbl.AutomaticSize = Enum.AutomaticSize.X
VerLbl.Font          = Enum.Font.GothamBold
VerLbl.Text          = "v6  ◆  BLOOD"
VerLbl.TextColor3    = C_ACCENT2
VerLbl.TextSize      = 8
VerLbl.ZIndex        = 10

-- ── SESSION TIMER ─────────────────────────────────────────────
local _sessionStart = tick()
local SessionLbl = Instance.new("TextLabel", TopBar)
SessionLbl.BackgroundTransparency = 1
SessionLbl.AnchorPoint = Vector2.new(0.5, 0.5)
SessionLbl.Position    = UDim2.new(0.5, 0, 0.5, 0)
SessionLbl.Size        = UDim2.new(0, 90, 0, 18)
SessionLbl.Font        = Enum.Font.GothamSemibold
SessionLbl.Text        = "00:00:00"
SessionLbl.TextColor3  = C_LOW
SessionLbl.TextSize    = 10
SessionLbl.ZIndex      = 9
task.spawn(function()
    while true do
        task.wait(1)
        ...
        pcall(function()
            SessionLbl.Text = string.format("%02d:%02d:%02d",
...
do
    local _defs = {
        {name="Theme",   ch="≡",  hov=C_AMBER},
        {name="Minimize",ch="—",  hov=C_ACCENT2},
        {name="Maximize",ch="⊡", hov=C_MID},
        {name="Close",   ch="✕", hov=C_RED2},
    }
    local _bx = WIN_W - 6
    for _i = #_defs, 1, -1 do
        local _d = _defs[_i]; _bx = _bx - 30
        local _bg = Instance.new("Frame", TopBar)
        _bg.BackgroundColor3       = C_ELEV
        _bg.BackgroundTransparency = 1
        _bg.BorderSizePixel        = 0
        _bg.Position               = UDim2.new(0, _bx, 0.5, -11)
        _bg.Size                   = UDim2.new(0, 22, 0, 22)
        _bg.ZIndex                 = 9
        Instance.new("UICorner", _bg).CornerRadius = UDim.new(0, 6)
        local _btn = Instance.new("TextButton", TopBar)
        _btn.BackgroundTransparency = 1
        _btn.BorderSizePixel        = 0
        _btn.Position               = UDim2.new(0, _bx, 0.5, -11)
        _btn.Size                   = UDim2.new(0, 22, 0, 22)
        _btn.Font                   = Enum.Font.GothamBold
        _btn.Text                   = _d.ch
        _btn.TextSize               = _d.ch == "≡" and 16 or 12
        _btn.TextColor3             = C_LOW
        _btn.ZIndex                 = 10
        _btn.MouseEnter:Connect(function()
            TweenService:Create(_bg,  TweenInfo.new(0.10), {BackgroundTransparency=0.40}):Play()
            TweenService:Create(_btn, TweenInfo.new(0.10), {TextColor3=_d.hov}):Play()
        end)
        _btn.MouseLeave:Connect(function()
            TweenService:Create(_bg,  TweenInfo.new(0.10), {BackgroundTransparency=1}):Play()
            TweenService:Create(_btn, TweenInfo.new(0.10), {TextColor3=C_LOW}):Play()
        end)
        TopBtns[_d.name] = _btn
    end
end
...
do
    ...
    TopBar.InputBegan:Connect(function(i)
        if i.UserInputType == Enum.UserInputType.MouseButton1 then
            _drag=true; _ds=i.Position; _fs=MainFrame.Position
        end
    end)
...
-- ══════════════════════════════════════════════════════════════
--  DROPDOWN MENU ◆ BLOOD OPERATOR
--  Aparece abaixo da topbar com animação, organizado por grupos,
--  com barra de busca integrada e visual de "operator terminal"
-- ══════════════════════════════════════════════════════════════
local DropPanel = Instance.new("Frame", ScreenGui)
DropPanel.Name             = "DropPanel"
DropPanel.BackgroundColor3 = Color3.fromRGB(8, 5, 5)
DropPanel.BorderSizePixel  = 0
DropPanel.ZIndex           = 500
DropPanel.Visible          = false
DropPanel.ClipsDescendants = true
Instance.new("UICorner", DropPanel).CornerRadius = UDim.new(0, 10)
local _dpStroke = Instance.new("UIStroke", DropPanel)
_dpStroke.Color = C_ACCENT; _dpStroke.Thickness = 1.4; _dpStroke.Transparency = 0.3

-- Gradient interno do dropdown
local _dpGrad = Instance.new("UIGradient", DropPanel)
_dpGrad.Color = ColorSequence.new({
    ColorSequenceKeypoint.new(0.0, Color3.fromRGB(16, 8, 8)),
    ColorSequenceKeypoint.new(1.0, Color3.fromRGB(6,  4, 4)),
})
_dpGrad.Rotation = 90

-- Cabeçalho do dropdown com barra de busca
local _dpHeader = Instance.new("Frame", DropPanel)
_dpHeader.BackgroundColor3 = Color3.fromRGB(14, 7, 7)
_dpHeader.BorderSizePixel  = 0
_dpHeader.Size             = UDim2.new(1, 0, 0, 38)
_dpHeader.ZIndex           = 501
local _dhFix = Instance.new("Frame", _dpHeader)
_dhFix.BackgroundColor3 = Color3.fromRGB(14, 7, 7); _dhFix.BorderSizePixel = 0
_dhFix.Position = UDim2.new(0,0,0,0); _dhFix.Size = UDim2.new(1,0,0,10); _dhFix.ZIndex = 500

-- Label "MENU" no header
local _dpMenuLbl = Instance.new("TextLabel", _dpHeader)
_dpMenuLbl.BackgroundTransparency = 1
_dpMenuLbl.Position = UDim2.new(0, 12, 0, 0)
_dpMenuLbl.Size     = UDim2.new(0, 60, 1, 0)
_dpMenuLbl.Font     = Enum.Font.GothamBlack
_dpMenuLbl.Text     = "◆ MENU"
_dpMenuLbl.TextColor3 = C_ACCENT
_dpMenuLbl.TextSize = 10
_dpMenuLbl.TextXAlignment = Enum.TextXAlignment.Left
_dpMenuLbl.ZIndex   = 502

-- Caixa de busca
local _dpSearchBg = Instance.new("Frame", _dpHeader)
_dpSearchBg.BackgroundColor3 = Color3.fromRGB(20, 10, 10)
_dpSearchBg.BorderSizePixel  = 0
_dpSearchBg.Position         = UDim2.new(0, 76, 0.5, -11)
_dpSearchBg.Size             = UDim2.new(1, -132, 0, 22)
_dpSearchBg.ZIndex           = 502
Instance.new("UICorner", _dpSearchBg).CornerRadius = UDim.new(0, 7)
local _dsStroke = Instance.new("UIStroke", _dpSearchBg)
_dsStroke.Color = C_STROKE; _dsStroke.Thickness = 1.2

local _dsIco = Instance.new("TextLabel", _dpSearchBg)
_dsIco.BackgroundTransparency = 1
_dsIco.Position = UDim2.new(0, 7, 0, 0)
_dsIco.Size     = UDim2.new(0, 16, 1, 0)
_dsIco.Font     = Enum.Font.GothamBold
_dsIco.Text     = "⊘"; _dsIco.TextColor3 = C_LOW; _dsIco.TextSize = 10; _dsIco.ZIndex = 503

local SearchBox = Instance.new("TextBox", _dpSearchBg)
SearchBox.BackgroundTransparency = 1; SearchBox.BorderSizePixel = 0
SearchBox.Position = UDim2.new(0, 26, 0, 0); SearchBox.Size = UDim2.new(1, -34, 1, 0)
SearchBox.Font = Enum.Font.Gotham; SearchBox.PlaceholderText = "buscar..."
SearchBox.Text = ""; SearchBox.PlaceholderColor3 = C_LOW
SearchBox.TextColor3 = C_HI; SearchBox.TextSize = 10
SearchBox.ClearTextOnFocus = true; SearchBox.ZIndex = 503
SearchBox.Focused:Connect(function()
    TweenService:Create(_dsStroke, TweenInfo.new(0.12), {Color=C_ACCENT}):Play()
end)
SearchBox.FocusLost:Connect(function()
    TweenService:Create(_dsStroke, TweenInfo.new(0.12), {Color=C_STROKE}):Play()
end)

-- Botão fechar dropdown no header
local _dpCloseBtn = Instance.new("TextButton", _dpHeader)
_dpCloseBtn.BackgroundTransparency = 1; _dpCloseBtn.BorderSizePixel = 0
_dpCloseBtn.AnchorPoint = Vector2.new(1, 0.5)
_dpCloseBtn.Position    = UDim2.new(1, -8, 0.5, 0)
_dpCloseBtn.Size        = UDim2.new(0, 26, 0, 22)
_dpCloseBtn.Font        = Enum.Font.GothamBold
_dpCloseBtn.Text        = "✕"; _dpCloseBtn.TextColor3 = C_LOW; _dpCloseBtn.TextSize = 11; _dpCloseBtn.ZIndex = 503
_dpCloseBtn.MouseEnter:Connect(function()
    TweenService:Create(_dpCloseBtn, TweenInfo.new(0.10), {TextColor3=C_RED2}):Play()
end)
_dpCloseBtn.MouseLeave:Connect(function()
    TweenService:Create(_dpCloseBtn, TweenInfo.new(0.10), {TextColor3=C_LOW}):Play()
end)

-- Linha separadora abaixo do header do dropdown
local _dpHSep = Instance.new("Frame", DropPanel)
_dpHSep.BackgroundColor3 = C_STROKE; _dpHSep.BorderSizePixel = 0
_dpHSep.Position = UDim2.new(0, 0, 0, 38); _dpHSep.Size = UDim2.new(1, 0, 0, 1)
_dpHSep.ZIndex   = 501

-- Linha accent vermelha embaixo do header
local _dpHAccent = Instance.new("Frame", DropPanel)
_dpHAccent.BackgroundColor3 = C_ACCENT
_dpHAccent.BackgroundTransparency = 0.55
_dpHAccent.BorderSizePixel = 0
_dpHAccent.Position = UDim2.new(0, 0, 0, 39); _dpHAccent.Size = UDim2.new(1, 0, 0, 1)
_dpHAccent.ZIndex   = 502

-- ScrollingFrame do dropdown
local _dpScroll = Instance.new("ScrollingFrame", DropPanel)
_dpScroll.BackgroundTransparency = 1; _dpScroll.BorderSizePixel = 0
_dpScroll.Position              = UDim2.new(0, 0, 0, 40)
_dpScroll.Size                  = UDim2.new(1, 0, 1, -40)
_dpScroll.ScrollBarThickness    = 2
_dpScroll.ScrollBarImageColor3  = C_ACCENT
_dpScroll.AutomaticCanvasSize   = Enum.AutomaticSize.Y
_dpScroll.CanvasSize            = UDim2.new(0, 0, 0, 0)
_dpScroll.ZIndex                = 501

local _dpList = Instance.new("UIListLayout", _dpScroll)
_dpList.FillDirection = Enum.FillDirection.Vertical
_dpList.HorizontalAlignment = Enum.HorizontalAlignment.Left
_dpList.Padding = UDim.new(0, 0); _dpList.SortOrder = Enum.SortOrder.LayoutOrder
local _dpPad = Instance.new("UIPadding", _dpScroll)
_dpPad.PaddingLeft = UDim.new(0, 6); _dpPad.PaddingRight = UDim.new(0, 6)
_dpPad.PaddingTop  = UDim.new(0, 6); _dpPad.PaddingBottom = UDim.new(0, 6)
...
ContentArea.Position            = UDim2.new(0, 0, 0, TOP_H + 1)
ContentArea.Size                = UDim2.new(1, 0, 0, CNT_H)
ContentArea.ZIndex              = 4
ContentArea.Visible             = false

-- STATUS BAR ─────────────────────────────────────────────────
local TabBar   = Instance.new("Frame", MainFrame)  -- alias legado
TabBar.Name    = "TabBar"
TabBar.BackgroundColor3 = Color3.fromRGB(10, 6, 6)
TabBar.BorderSizePixel  = 0
TabBar.Position         = UDim2.new(0, 0, 1, -BOT_H)
TabBar.Size             = UDim2.new(1, 0, 0, BOT_H)
TabBar.ZIndex           = 5
TabBar.Visible          = false
Instance.new("UICorner", TabBar).CornerRadius = UDim.new(0, 12)
local _tbFix2 = Instance.new("Frame", TabBar)
_tbFix2.BackgroundColor3 = Color3.fromRGB(10,6,6); _tbFix2.BorderSizePixel=0
_tbFix2.Position=UDim2.new(0,0,0,0); _tbFix2.Size=UDim2.new(1,0,0,8); _tbFix2.ZIndex=4

local TabSep = Instance.new("Frame", MainFrame)
TabSep.BackgroundColor3 = C_STROKE; TabSep.BorderSizePixel = 0
TabSep.Position         = UDim2.new(0, 0, 1, -(BOT_H+1))
TabSep.Size             = UDim2.new(1, 0, 0, 1); TabSep.ZIndex = 4

local Divider = TabSep
local SideBar = TabBar

-- Lista horizontal na status bar
local _stHList = Instance.new("UIListLayout", TabBar)
_stHList.FillDirection = Enum.FillDirection.Horizontal
_stHList.VerticalAlignment = Enum.VerticalAlignment.Center
_stHList.HorizontalAlignment = Enum.HorizontalAlignment.Left
_stHList.Padding = UDim.new(0, 0)
local _stPad = Instance.new("UIPadding", TabBar)
_stPad.PaddingLeft = UDim.new(0, 10)

local function makeStatPill(ico, val, icoCol)
    local f = Instance.new("Frame", TabBar)
    f.BackgroundTransparency = 1; f.BorderSizePixel = 0
    f.Size = UDim2.new(0,0,1,0); f.AutomaticSize = Enum.AutomaticSize.X; f.ZIndex = 6
    ...
    fp.PaddingLeft=UDim.new(0,0); fp.PaddingRight=UDim.new(0,12)
    local iL = Instance.new("TextLabel", f)
    iL.BackgroundTransparency=1; iL.Size=UDim2.new(0,10,1,0)
    iL.Font=Enum.Font.GothamBold; iL.Text=ico
    iL.TextColor3=icoCol or C_ACCENT; iL.TextSize=9; iL.ZIndex=7
    local vL = Instance.new("TextLabel", f)
    vL.BackgroundTransparency=1; vL.Size=UDim2.new(0,0,1,0); vL.AutomaticSize=Enum.AutomaticSize.X
    vL.Font=Enum.Font.GothamSemibold; vL.Text=val
    vL.TextColor3=C_MID; vL.TextSize=9; vL.ZIndex=7
    return vL, iL
end
local FpsLbl,FpsIco   = makeStatPill("⚡","FPS --",   Color3.fromRGB(200,22,22))
local PingLbl,PingIco = makeStatPill("◎","Ping --",  Color3.fromRGB(180,80,40))
local MemLbl,_        = makeStatPill("▣","Mem --",   Color3.fromRGB(130,60,0))
local PlayLbl,_       = makeStatPill("◐","-- jogadores", C_LOW)

-- Keybind info (direita da status bar)
local _kbLbl = Instance.new("TextLabel", TabBar)
_kbLbl.BackgroundTransparency=1
_kbLbl.AnchorPoint=Vector2.new(1,0.5)
_kbLbl.Position=UDim2.new(1,-8,0.5,0); _kbLbl.Size=UDim2.new(0,100,0,14)
_kbLbl.Font=Enum.Font.Gotham; _kbLbl.Text="[ RShift ] toggle"
_kbLbl.TextColor3=C_LOW; _kbLbl.TextSize=8
_kbLbl.TextXAlignment=Enum.TextXAlignment.Right; _kbLbl.ZIndex=6
...
task.spawn(function()
    ...
    while true do
        task.wait(0.7)
        pcall(function()
            local rawFps = math.floor(1 / RunService.RenderStepped:Wait())
            table.insert(_fbuf, rawFps); if #_fbuf > 4 then table.remove(_fbuf,1) end
            local avg = 0; for _,v in ipairs(_fbuf) do avg=avg+v end; avg=math.floor(avg/#_fbuf)
            FpsLbl.Text = "FPS "..avg
            local fc = avg>=55 and Color3.fromRGB(200,22,22) or (avg>=30 and C_AMBER or Color3.fromRGB(255,40,40))
            FpsLbl.TextColor3=fc; FpsIco.TextColor3=fc
            local ping = math.floor(Players.LocalPlayer:GetNetworkPing()*1000)
            PingLbl.Text = "Ping "..ping.."ms"
            local pc2 = ping<80 and Color3.fromRGB(200,22,22) or (ping<180 and C_AMBER or Color3.fromRGB(255,40,40))
            PingLbl.TextColor3=pc2; PingIco.TextColor3=pc2
            MemLbl.Text = "Mem "..math.floor(StatsService:GetTotalMemoryUsageMb()).."mb"
            PlayLbl.Text = #Players:GetPlayers().." players"
        end)
    end
end)

-- ── SCROLL ALIAS (compat legado para ScrollingFrame dentro de "TabBar") ──────
local TabScroll = Instance.new("ScrollingFrame", TabBar)
TabScroll.BackgroundTransparency=1; TabScroll.BorderSizePixel=0
TabScroll.Size=UDim2.new(0,0,0,0); TabScroll.Visible=false
TabScroll.ScrollBarThickness=0; TabScroll.ZIndex=3

-- Rodapé (compat)
local Footer = Instance.new("Frame", MainFrame)
Footer.Name="Footer"; Footer.BackgroundTransparency=1; Footer.BorderSizePixel=0
Footer.Position=UDim2.new(0,0,1,0); Footer.Size=UDim2.new(0,0,0,0)
Footer.Visible=true; Footer.ZIndex=2
local FLangFrame=Instance.new("Frame",Footer)
FLangFrame.BackgroundTransparency=1; FLangFrame.BorderSizePixel=0
FLangFrame.Size=UDim2.new(0,0,0,0); FLangFrame.ZIndex=2
local FLangLbl=Instance.new("TextLabel",FLangFrame)
FLangLbl.BackgroundTransparency=1; FLangLbl.Size=UDim2.new(0,0,0,0)
FLangLbl.Text=currentLang.flag.." "..currentLang.short
FLangLbl.TextColor3=C_ACCENT; FLangLbl.TextSize=8; FLangLbl.ZIndex=2
langFooterLabel=FLangLbl

-- ── PÁGINAS ──────────────────────────────────────────────────
local Pages = {}
local TabConfig = {
    {key="Info",           label="Info",         icon="◉",  trKey="tabInfo"},
    {key="Status",         label="Status",       icon="◎",  trKey="tabStatus"},
    {key="Farm",           label="Farm",         icon="⚡",  trKey="tabFarm"},
    {key="Teleportar",     label="Teleport",     icon="⊕",  trKey="tabTeleportar"},
    {key="Esp",            label="ESP",          icon="◈",  trKey="tabEsp"},
    {key="Bring",          label="Bring",        icon="⇅",  trKey="tabBring"},
    {key="AvancadoFarm",   label="Av.Farm",      icon="⚙",  trKey="tabAvFarm"},
    {key="Player",         label="Player",       icon="◐",  trKey="tabPlayer"},
    {key="Configuracoes",  label="Config",       icon="⊞",  trKey="tabConfig"},
    {key="AvancadoFuncoes",label="Funções",      icon="◆",  trKey="tabAvFunc"},
}
local GroupConfig = {
...
for _, t in ipairs(TabConfig) do
    ...
    pp.PaddingTop=UDim.new(0,12); pp.PaddingLeft=UDim.new(0,14)
...
-- Label do menu que mostra aba ativa na topbar
local _activeTabLbl = Instance.new("TextButton", TopBar)
_activeTabLbl.BackgroundColor3 = C_CARD
_activeTabLbl.BackgroundTransparency = 0.5
_activeTabLbl.BorderSizePixel = 0
_activeTabLbl.Position = UDim2.new(0, 272, 0.5, -13)
_activeTabLbl.Size     = UDim2.new(0, 116, 0, 26)
_activeTabLbl.Font     = Enum.Font.GothamBold
_activeTabLbl.Text     = "◉  Info  ▾"
_activeTabLbl.TextColor3 = C_HI
_activeTabLbl.TextSize = 10
_activeTabLbl.ZIndex   = 10
Instance.new("UICorner", _activeTabLbl).CornerRadius = UDim.new(0, 7)
local _atStroke = Instance.new("UIStroke", _activeTabLbl)
_atStroke.Color = C_STROKE; _atStroke.Thickness = 1.2

_activeTabLbl.MouseEnter:Connect(function()
    TweenService:Create(_activeTabLbl, TweenInfo.new(0.10), {BackgroundTransparency=0.25}):Play()
    TweenService:Create(_atStroke, TweenInfo.new(0.10), {Color=C_ACCENT}):Play()
end)
_activeTabLbl.MouseLeave:Connect(function()
    TweenService:Create(_activeTabLbl, TweenInfo.new(0.10), {BackgroundTransparency=0.5}):Play()
    TweenService:Create(_atStroke, TweenInfo.new(0.10), {Color=C_STROKE}):Play()
end)

-- Função para fechar dropdown
local function closeDrop(instant)
    if not _dropOpen and not instant then return end
    _dropOpen = false
    local dur = instant and 0 or 0.22
    TweenService:Create(DropPanel, TweenInfo.new(dur, Enum.EasingStyle.Quad, Enum.EasingDirection.In),
        {Size=UDim2.new(0,280,0,0)}):Play()
    task.delay(dur+0.02, function() DropPanel.Visible=false end)
end

local function selectTab(key)
    if currentTab == key then closeDrop(); return end
    currentTab = key
    for _, p in pairs(Pages) do p.Visible = false end
    if Pages[key] then Pages[key].Visible = true end
    for _, e in ipairs(allTabs) do
        local on = (e.key == key)
        TweenService:Create(e.pill, TweenInfo.new(0.18, Enum.EasingStyle.Quad), {
            BackgroundTransparency = on and 0.05 or 1,
            BackgroundColor3       = on and C_BG_ACT or C_CARD,
        }):Play()
        TweenService:Create(e.iconLbl, TweenInfo.new(0.15), {TextColor3=on and C_ACCENT or C_LOW}):Play()
        TweenService:Create(e.textLbl, TweenInfo.new(0.15), {TextColor3=on and C_HI or C_MID}):Play()
        if e.bar then e.bar.Visible = on end
        if on then
            _activeTabLbl.Text = e.iconLbl.Text.."  "..e.textLbl.Text.."  ▾"
        end
    end
    closeDrop()
end

-- Constrói items do dropdown
do
    local _tabLookup = {}
    for _, t in ipairs(TabConfig) do _tabLookup[t.key] = t end
    local _lo = 0

    for _, grp in ipairs(GroupConfig) do
        -- Separador de grupo
        local _grpRow = Instance.new("Frame", _dpScroll)
        _grpRow.BackgroundTransparency = 1; _grpRow.BorderSizePixel = 0
        _grpRow.Size = UDim2.new(1,0,0,22); _grpRow.LayoutOrder = _lo; _grpRow.ZIndex=502
        local _grpLbl = Instance.new("TextLabel", _grpRow)
        _grpLbl.BackgroundTransparency=1; _grpLbl.Position=UDim2.new(0,6,0,4)
        _grpLbl.Size=UDim2.new(1,-12,0,14); _grpLbl.Font=Enum.Font.GothamBlack
        _grpLbl.Text=grp.label; _grpLbl.TextColor3=C_ACCENT
        _grpLbl.TextTransparency=0.2; _grpLbl.TextSize=8
        _grpLbl.TextXAlignment=Enum.TextXAlignment.Left; _grpLbl.ZIndex=503
        if grp.trKey then trackLabel(_grpLbl, grp.trKey) end
        -- linha embaixo do label de grupo
        local _gline=Instance.new("Frame",_grpRow); _gline.BackgroundColor3=C_STROKE
        _gline.BackgroundTransparency=0.3; _gline.BorderSizePixel=0
        _gline.Position=UDim2.new(0,6,1,-1); _gline.Size=UDim2.new(1,-12,0,1); _gline.ZIndex=503
        _lo = _lo + 1

        for _, tabKey in ipairs(grp.keys) do
            local t = _tabLookup[tabKey]
            if not t then continue end
            _lo = _lo + 1

            local pill = Instance.new("Frame", _dpScroll)
            pill.BackgroundColor3       = C_BG_ACT
            pill.BackgroundTransparency = 1
            pill.BorderSizePixel        = 0
            pill.LayoutOrder            = _lo
            pill.ZIndex                 = 502
            pill.Size                   = UDim2.new(1,0,0,32)
            Instance.new("UICorner", pill).CornerRadius = UDim.new(0, 7)

            -- Barra vermelha esquerda (ativo)
            local bar = Instance.new("Frame", pill)
            bar.BackgroundColor3 = C_ACCENT; bar.BorderSizePixel=0
            bar.Position=UDim2.new(0,0,0.2,0); bar.Size=UDim2.new(0,3,0.6,0); bar.Visible=false; bar.ZIndex=503
            Instance.new("UICorner", bar).CornerRadius = UDim.new(1,0)

            local iconLbl = Instance.new("TextLabel", pill)
            iconLbl.BackgroundTransparency=1; iconLbl.Position=UDim2.new(0,10,0.5,-8)
            iconLbl.Size=UDim2.new(0,18,0,16); iconLbl.Font=Enum.Font.GothamBold
            iconLbl.Text=t.icon; iconLbl.TextColor3=C_LOW; iconLbl.TextSize=11; iconLbl.ZIndex=503

            local textLbl = Instance.new("TextLabel", pill)
            textLbl.BackgroundTransparency=1; textLbl.Position=UDim2.new(0,32,0,0)
            textLbl.Size=UDim2.new(1,-42,1,0); textLbl.Font=Enum.Font.GothamSemibold
            textLbl.Text=t.label; textLbl.TextColor3=C_MID; textLbl.TextSize=10
            textLbl.TextXAlignment=Enum.TextXAlignment.Left; textLbl.ZIndex=503
            if t.trKey then trackLabel(textLbl, t.trKey) end

            -- Seta direita (decorativa)
            local _arw = Instance.new("TextLabel", pill)
            _arw.BackgroundTransparency=1
            _arw.AnchorPoint=Vector2.new(1,0.5)
            _arw.Position=UDim2.new(1,-8,0.5,0); _arw.Size=UDim2.new(0,12,0,12)
            _arw.Font=Enum.Font.GothamBold; _arw.Text="›"; _arw.TextColor3=C_LOW; _arw.TextSize=13; _arw.ZIndex=503

            local pbtn = Instance.new("TextButton", pill)
            pbtn.BackgroundTransparency=1; pbtn.Size=UDim2.new(1,0,1,0); pbtn.Text=""; pbtn.ZIndex=504
            pbtn.MouseButton1Click:Connect(function() selectTab(t.key) end)
            pbtn.MouseEnter:Connect(function()
                if currentTab~=t.key then
                    TweenService:Create(pill,    TweenInfo.new(0.10),{BackgroundTransparency=0.82}):Play()
                    TweenService:Create(iconLbl, TweenInfo.new(0.10),{TextColor3=C_MID}):Play()
                    TweenService:Create(_arw,    TweenInfo.new(0.10),{TextColor3=C_ACCENT}):Play()
                end
            end)
            pbtn.MouseLeave:Connect(function()
                if currentTab~=t.key then
                    TweenService:Create(pill,    TweenInfo.new(0.10),{BackgroundTransparency=1}):Play()
                    TweenService:Create(iconLbl, TweenInfo.new(0.10),{TextColor3=C_LOW}):Play()
                    TweenService:Create(_arw,    TweenInfo.new(0.10),{TextColor3=C_LOW}):Play()
                end
            end)
            table.insert(allTabs, {key=t.key, pill=pill, iconLbl=iconLbl, textLbl=textLbl, bar=bar})
        end

        -- Spacer
        local _sp = Instance.new("Frame", _dpScroll)
        _sp.BackgroundTransparency=1; _sp.BorderSizePixel=0
        _sp.Size=UDim2.new(1,0,0,5); _sp.LayoutOrder=_lo+1; _sp.ZIndex=502
        _lo = _lo + 2
    end
end
...
SearchBox:GetPropertyChangedSignal("Text"):Connect(function()
    ...
    for _, e in ipairs(allTabs) do
        if q == "" then e.pill.Visible = true
        else
            local match = e.textLbl.Text:lower():find(q,1,true) or e.key:lower():find(q,1,true)
            e.pill.Visible = match ~= nil
        end
    end
end)
...
local function openDrop()
    if _dropOpen then closeDrop(); return end
    _dropOpen = true
    -- Posiciona abaixo do botão de aba ativo na topbar
    local ap = _activeTabLbl.AbsolutePosition
    local mfp = MainFrame.AbsolutePosition
    local relX = ap.X - mfp.X
    local relY = TOP_H + 1
    DropPanel.Position = UDim2.new(0, mfp.X + relX - 8, 0, mfp.Y + relY)
    DropPanel.Size     = UDim2.new(0, 280, 0, 0)
    DropPanel.Visible  = true
    TweenService:Create(DropPanel, TweenInfo.new(0.28, Enum.EasingStyle.Back, Enum.EasingDirection.Out),
        {Size=UDim2.new(0,280,0,344)}):Play()
end

_activeTabLbl.MouseButton1Click:Connect(openDrop)
_dpCloseBtn.MouseButton1Click:Connect(closeDrop)
...
UserInputService.InputBegan:Connect(function(input)
    ...
    if input.UserInputType ~= Enum.UserInputType.MouseButton1 then return end
    local mp = UserInputService:GetMouseLocation()
    local dp, ds = DropPanel.AbsolutePosition, DropPanel.AbsoluteSize
    local ab, abs2 = _activeTabLbl.AbsolutePosition, _activeTabLbl.AbsoluteSize
    local inDrop = mp.X>=dp.X and mp.X<=dp.X+ds.X and mp.Y>=dp.Y and mp.Y<=dp.Y+ds.Y
    local inBtn  = mp.X>=ab.X and mp.X<=ab.X+abs2.X and mp.Y>=ab.Y and mp.Y<=ab.Y+abs2.Y
    if not inDrop and not inBtn then closeDrop() end
end)

-- Keybind RightShift toggle hub
...
local function closeHub()
    _hubOpen = false
    closeDrop(true)
    TweenService:Create(MainFrame, TweenInfo.new(0.20, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
...
UserInputService.InputBegan:Connect(function(input, gpe)
    ...
    if input.KeyCode == Enum.KeyCode.RightShift then
        if _hubOpen then closeHub() else openHub() end
    end
end)

-- ══════════════════════════════════════════════════════════════
--  INTRO ◆ BLOOD OPERATOR
--  Tela preta → cruz de scan vermelha → logo revela → loading bar
--  → corte lateral → janela sobe
-- ══════════════════════════════════════════════════════════════
do
    local OV = Instance.new("Frame", ScreenGui)
    OV.Name = "BloodIntro"; OV.Size=UDim2.new(1,0,1,0)
    OV.BackgroundColor3=Color3.fromRGB(3,2,2); OV.BorderSizePixel=0; OV.ZIndex=900

    -- Ruído de fundo (pontos estáticos aleatórios)
    for _p=1,55 do
        local _d=Instance.new("Frame",OV); local _s=math.random(1,3)
        _d.Size=UDim2.new(0,_s,0,_s)
        _d.Position=UDim2.new(math.random()*0.97,0,math.random()*0.97,0)
        _d.BackgroundColor3=Color3.fromRGB(200,22,22)
        _d.BackgroundTransparency=0.60+math.random()*0.36
        _d.BorderSizePixel=0; _d.ZIndex=901
        Instance.new("UICorner",_d).CornerRadius=UDim.new(1,0)
    end

    -- Scanlines: 1 horizontal + 1 vertical (forma uma cruz)
    local _hLine=Instance.new("Frame",OV)
    _hLine.BackgroundColor3=Color3.fromRGB(200,22,22); _hLine.BackgroundTransparency=0.65
    _hLine.BorderSizePixel=0; _hLine.Size=UDim2.new(0,0,0,1)
    _hLine.Position=UDim2.new(0,0,0.5,0); _hLine.ZIndex=902

    local _vLine=Instance.new("Frame",OV)
    _vLine.BackgroundColor3=Color3.fromRGB(200,22,22); _vLine.BackgroundTransparency=0.72
    _vLine.BorderSizePixel=0; _vLine.Size=UDim2.new(0,1,0,0)
    _vLine.Position=UDim2.new(0.5,0,0,0); _vLine.ZIndex=902

    -- Container central
    local _C=Instance.new("Frame",OV)
    _C.BackgroundTransparency=1; _C.BorderSizePixel=0
    _C.AnchorPoint=Vector2.new(0.5,0.5)
    _C.Position=UDim2.new(0.5,0,0.5,-15); _C.Size=UDim2.new(0,500,0,190); _C.ZIndex=903

    -- Barra vertical vermelha à esquerda
    local _acBar=Instance.new("Frame",_C)
    _acBar.BackgroundColor3=Color3.fromRGB(200,22,22); _acBar.BorderSizePixel=0
    _acBar.Position=UDim2.new(0,0,0,0); _acBar.Size=UDim2.new(0,3,0,0); _acBar.ZIndex=904
    Instance.new("UICorner",_acBar).CornerRadius=UDim.new(1,0)

    -- Glow na barra
    local _acGlow=Instance.new("Frame",_acBar)
    _acGlow.BackgroundColor3=Color3.fromRGB(255,60,60); _acGlow.BackgroundTransparency=0.82
    _acGlow.BorderSizePixel=0; _acGlow.Position=UDim2.new(-2,0,0,0); _acGlow.Size=UDim2.new(3,0,1,0)
    _acGlow.ZIndex=903
    Instance.new("UICorner",_acGlow).CornerRadius=UDim.new(1,0)

    -- Título
    local _title=Instance.new("TextLabel",_C)
    _title.BackgroundTransparency=1; _title.Position=UDim2.new(0,18,0,0)
    _title.Size=UDim2.new(1,-18,0,74); _title.Font=Enum.Font.GothamBlack
    _title.Text="PUDIMHUB"; _title.TextColor3=Color3.fromRGB(245,230,230)
    _title.TextSize=58; _title.TextTransparency=1
    _title.TextXAlignment=Enum.TextXAlignment.Left; _title.ZIndex=905

    -- Shadow do título (vermelho atrás)
    local _tShadow=Instance.new("TextLabel",_C)
    _tShadow.BackgroundTransparency=1; _tShadow.Position=UDim2.new(0,20,0,2)
    _tShadow.Size=UDim2.new(1,-18,0,74); _tShadow.Font=Enum.Font.GothamBlack
    _tShadow.Text="PUDIMHUB"; _tShadow.TextColor3=Color3.fromRGB(200,22,22)
    _tShadow.TextSize=58; _tShadow.TextTransparency=1
    _tShadow.TextXAlignment=Enum.TextXAlignment.Left; _tShadow.ZIndex=904

    -- Badge Blood Operator
    local _badge=Instance.new("Frame",_C)
    _badge.BackgroundColor3=Color3.fromRGB(200,22,22); _badge.BackgroundTransparency=1
    _badge.BorderSizePixel=0; _badge.Position=UDim2.new(0,18,0,78)
    _badge.Size=UDim2.new(0,0,0,20); _badge.AutomaticSize=Enum.AutomaticSize.X; _badge.ZIndex=905
    Instance.new("UICorner",_badge).CornerRadius=UDim.new(0,5)
    local _bStroke=Instance.new("UIStroke",_badge); _bStroke.Color=Color3.fromRGB(200,22,22); _bStroke.Thickness=1.2; _bStroke.Transparency=0.5
    local _bPad=Instance.new("UIPadding",_badge); _bPad.PaddingLeft=UDim.new(0,7); _bPad.PaddingRight=UDim.new(0,7)
    local _bLbl=Instance.new("TextLabel",_badge)
    _bLbl.BackgroundTransparency=1; _bLbl.Size=UDim2.new(0,0,1,0); _bLbl.AutomaticSize=Enum.AutomaticSize.X
    _bLbl.Font=Enum.Font.GothamBold; _bLbl.Text="◆  BLOOD OPERATOR  ·  v6"
    _bLbl.TextColor3=Color3.fromRGB(255,100,80); _bLbl.TextSize=9; _bLbl.ZIndex=906

    -- Subtítulo jogo
    local _sub=Instance.new("TextLabel",_C)
    _sub.BackgroundTransparency=1; _sub.Position=UDim2.new(0,18,0,106)
    _sub.Size=UDim2.new(1,-18,0,16); _sub.Font=Enum.Font.GothamSemibold
    _sub.Text="99  NIGHTS  IN  THE  FOREST   ·   2026"
    _sub.TextColor3=Color3.fromRGB(155,100,100); _sub.TextSize=11
    _sub.TextTransparency=1; _sub.TextXAlignment=Enum.TextXAlignment.Left; _sub.ZIndex=904

    -- Divisor
    local _div=Instance.new("Frame",_C)
    _div.BackgroundColor3=Color3.fromRGB(48,22,22); _div.BackgroundTransparency=0.2
    _div.BorderSizePixel=0; _div.Position=UDim2.new(0,18,0,128); _div.Size=UDim2.new(0,0,0,1); _div.ZIndex=904

    -- Data
    local _n=os.date("*t")
    local _dateLbl=Instance.new("TextLabel",_C)
    _dateLbl.BackgroundTransparency=1; _dateLbl.Position=UDim2.new(0,18,0,136)
    _dateLbl.Size=UDim2.new(1,-18,0,14); _dateLbl.Font=Enum.Font.Gotham
    _dateLbl.Text=string.format("Atualizado  %02d/%02d/%04d  —  %02d:%02d",_n.day,_n.month,_n.year,_n.hour,_n.min)
    _dateLbl.TextColor3=Color3.fromRGB(65,38,38); _dateLbl.TextSize=9
    _dateLbl.TextTransparency=1; _dateLbl.TextXAlignment=Enum.TextXAlignment.Left; _dateLbl.ZIndex=904

    -- Loading bar
    local _lC=Instance.new("Frame",OV)
    _lC.BackgroundTransparency=1; _lC.BorderSizePixel=0
    _lC.AnchorPoint=Vector2.new(0.5,0); _lC.Position=UDim2.new(0.5,0,0.5,105)
    _lC.Size=UDim2.new(0,500,0,22); _lC.ZIndex=903

    local _lBg=Instance.new("Frame",_lC)
    _lBg.BackgroundColor3=Color3.fromRGB(20,8,8); _lBg.BorderSizePixel=0
    _lBg.Size=UDim2.new(1,0,0,3); _lBg.ZIndex=904
    Instance.new("UICorner",_lBg).CornerRadius=UDim.new(1,0)

    local _lFill=Instance.new("Frame",_lBg)
    _lFill.BackgroundColor3=Color3.fromRGB(200,22,22); _lFill.BorderSizePixel=0
    _lFill.Size=UDim2.new(0,0,1,0); _lFill.ZIndex=905
    Instance.new("UICorner",_lFill).CornerRadius=UDim.new(1,0)

    -- Brilho da barra
    local _lGlow=Instance.new("Frame",_lFill)
    _lGlow.BackgroundColor3=Color3.fromRGB(255,60,60); _lGlow.BackgroundTransparency=0.7
    _lGlow.BorderSizePixel=0; _lGlow.Size=UDim2.new(1,0,3,0); _lGlow.Position=UDim2.new(0,0,-1,0)
    _lGlow.ZIndex=904
    Instance.new("UICorner",_lGlow).CornerRadius=UDim.new(1,0)

    local _lTxt=Instance.new("TextLabel",_lC)
    _lTxt.BackgroundTransparency=1; _lTxt.Position=UDim2.new(0,0,0,8)
    _lTxt.Size=UDim2.new(0.75,0,0,12); _lTxt.Font=Enum.Font.Gotham
    _lTxt.Text="Inicializando..."; _lTxt.TextColor3=Color3.fromRGB(65,38,38)
    _lTxt.TextSize=8; _lTxt.TextXAlignment=Enum.TextXAlignment.Left; _lTxt.ZIndex=904

    local _lPct=Instance.new("TextLabel",_lC)
    _lPct.BackgroundTransparency=1; _lPct.AnchorPoint=Vector2.new(1,0)
    _lPct.Position=UDim2.new(1,0,0,8); _lPct.Size=UDim2.new(0,36,0,12)
    _lPct.Font=Enum.Font.GothamBold; _lPct.Text="0%"
    _lPct.TextColor3=Color3.fromRGB(200,22,22); _lPct.TextSize=8; _lPct.ZIndex=904

    -- ── Sequência do intro ────────────────────────────────────
    task.spawn(function()
        -- Cruz de scan cresce do centro
        TweenService:Create(_hLine, TweenInfo.new(0.38,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
            {Size=UDim2.new(1,0,0,1)}):Play()
        task.wait(0.12)
        TweenService:Create(_vLine, TweenInfo.new(0.34,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
            {Size=UDim2.new(0,1,1,0)}):Play()
        task.wait(0.36)

        -- Linhas somem suavemente
        TweenService:Create(_hLine,TweenInfo.new(0.22),{BackgroundTransparency=1}):Play()
        TweenService:Create(_vLine,TweenInfo.new(0.22),{BackgroundTransparency=1}):Play()
        task.wait(0.10)

        -- Barra de acento cresce
        TweenService:Create(_acBar,TweenInfo.new(0.24,Enum.EasingStyle.Quint),{Size=UDim2.new(0,3,0,74)}):Play()
        task.wait(0.12)

        -- Shadow do título aparece primeiro
        TweenService:Create(_tShadow,TweenInfo.new(0.08),{TextTransparency=0.88}):Play()
        -- Título emerge
        _title.Position=UDim2.new(0,24,0,0)
        TweenService:Create(_title,TweenInfo.new(0.36,Enum.EasingStyle.Quint),
            {TextTransparency=0,Position=UDim2.new(0,18,0,0)}):Play()
        task.wait(0.24)

        -- Badge
        TweenService:Create(_badge,TweenInfo.new(0.18),{BackgroundTransparency=0.78}):Play()
        task.wait(0.16)

        -- Subtítulo
        TweenService:Create(_sub,TweenInfo.new(0.22),{TextTransparency=0}):Play()
        task.wait(0.16)

        -- Divisor
        TweenService:Create(_div,TweenInfo.new(0.30,Enum.EasingStyle.Quad),{Size=UDim2.new(0,480,0,1)}):Play()
        task.wait(0.14)

        -- Data
        TweenService:Create(_dateLbl,TweenInfo.new(0.20),{TextTransparency=0}):Play()

        -- Loading bar
        local _steps={
            {p=0.20,t="Carregando módulos...",    s="20%"},
            {p=0.40,t="Inicializando ESP...",      s="40%"},
            {p=0.60,t="Configurando Bring...",     s="60%"},
            {p=0.80,t="Aplicando tema BLOOD...",   s="80%"},
            {p=1.00,t="Sistema operacional!",      s="100%"},
        }
        for _,st in ipairs(_steps) do
            task.wait(0.24)
            TweenService:Create(_lFill,TweenInfo.new(0.26,Enum.EasingStyle.Quint),
                {Size=UDim2.new(st.p,0,1,0)}):Play()
            _lTxt.Text=st.t; _lPct.Text=st.s
        end
        task.wait(0.5)

        -- Overlay sai PARA A ESQUERDA (corte lateral)
        TweenService:Create(OV,TweenInfo.new(0.40,Enum.EasingStyle.Quad,Enum.EasingDirection.In),
            {Position=UDim2.new(-1,0,0,0)}):Play()
        task.wait(0.42)
        OV.Visible=false

        -- MainFrame sobe do fundo
        MainFrame.Visible=true
        MainFrame.BackgroundTransparency=1
        MainFrame.Size=UDim2.new(0,WIN_W,0,0)
...
BoostPopup.BackgroundColor3=Color3.fromRGB(10, 5, 5); BoostPopup.Size=UDim2.new(0,190,0,0)
BoostPopup.Visible=false; BoostPopup.ZIndex=200; BoostPopup.ClipsDescendants=true
Instance.new("UICorner",BoostPopup).CornerRadius=UDim.new(0,14)
...
local function makePopupToggle(text,callback)
    local row=Instance.new("Frame",BoostPopup); row.BackgroundColor3=Color3.fromRGB(22, 10, 10)
    ...
    lbl.Text=text; lbl.TextColor3=Color3.fromRGB(235, 215, 215); lbl.TextSize=10
    lbl.TextXAlignment=Enum.TextXAlignment.Left; lbl.ZIndex=201
    local pill=Instance.new("Frame",row); pill.BackgroundColor3=Color3.fromRGB(22, 38, 30); pill.BorderSizePixel=0
    pill.Position=UDim2.new(1,-42,0.5,-10); pill.Size=UDim2.new(0,36,0,20); pill.ZIndex=201
    Instance.new("UICorner",pill).CornerRadius=UDim.new(1,0)
    local knob=Instance.new("Frame",pill); knob.BackgroundColor3=Color3.fromRGB(120, 30, 30); knob.BorderSizePixel=0
    ...
    btn.MouseButton1Click:Connect(function()
        state=not state
        TweenService:Create(pill,TweenInfo.new(0.2),{BackgroundColor3=state and Color3.fromRGB(74, 222, 128) or Color3.fromRGB(22, 38, 30)}):Play()
...
rejBtn.BackgroundColor3=Color3.fromRGB(160,20,20); rejBtn.BorderSizePixel=0
...
Instance.new("UICorner",rejBtn).CornerRadius=UDim.new(0,10)
...
FloatBtn.BackgroundColor3=Color3.fromRGB(8, 4, 4); FloatBtn.BorderSizePixel=0; FloatBtn.Visible=false; FloatBtn.ZIndex=100; FloatBtn.Active=true
...
PDText.Text="◆"; PDText.TextColor3=Color3.fromRGB(200, 30, 30); PDText.TextSize=20; PDText.TextTransparency=0.05; PDText.ZIndex=105
...
FloatClick.MouseButton1Click:Connect(function()
    ...
    task.delay(0.22,function()
        ...
        MainFrame.Visible=true; MainFrame.Size=UDim2.new(0,WIN_W,0,0)
        TweenService:Create(MainFrame,TweenInfo.new(0.3,Enum.EasingStyle.Back,Enum.EasingDirection.Out),{Size=UDim2.new(0,WIN_W,0,WIN_H)}):Play()
        task.delay(0.2,function() TabBar.Visible=true; ContentArea.Visible=true end)
    end)
end)
...
TopBtns["Minimize"].MouseButton1Click:Connect(function()
    ...
    if isMinimized then
        ...
        TweenService:Create(MainFrame,TweenInfo.new(0.25,Enum.EasingStyle.Quad),{Size=UDim2.new(0,WIN_W,0,TOP_H)}):Play()
    else
        TweenService:Create(MainFrame,TweenInfo.new(0.25,Enum.EasingStyle.Quad),{Size=UDim2.new(0,WIN_W,0,WIN_H)}):Play()
...
TopBtns["Maximize"].MouseButton1Click:Connect(function()
    ...
    if isMaximized then
        ...
        TweenService:Create(MainFrame,TweenInfo.new(0.3,Enum.EasingStyle.Quad),{Size=UDim2.new(0,860,0,570),Position=UDim2.new(0.5,-430,0.5,-285)}):Play()
    else
        TweenService:Create(MainFrame,TweenInfo.new(0.3,Enum.EasingStyle.Quad),{Size=UDim2.new(0,WIN_W,0,WIN_H),Position=normalPos}):Play()
    end
end)

TopBtns["Close"].MouseButton1Click:Connect(function()
    closeHub()
    task.delay(0.26,function() showFloatBtn() end)
end)
...
local infoCardStroke=Instance.new("UIStroke",infoCard); infoCardStroke.Color=Color3.fromRGB(40,72,55); infoCardStroke.Thickness=1.2
...
infoGreenDot.BackgroundColor3=Color3.fromRGB(74, 222, 128); infoGreenDot.BorderSizePixel=0
...
infoStatusLbl.TextColor3=Color3.fromRGB(74, 222, 128); infoStatusLbl.TextSize=10
...
infoLangKeyLbl.Text="Idioma:"; infoLangKeyLbl.TextColor3=Color3.fromRGB(100,150,125)
...
infoLangValLbl.TextColor3=Color3.fromRGB(52,211,153)
...
ntStroke.Color = Color3.fromRGB(52,211,153); ntStroke.Thickness = 1.5

-- Icon 🔔 on the left
local ntIconBg = Instance.new("Frame", notifToggleRow)
ntIconBg.BackgroundColor3   = Color3.fromRGB(52,211,153)
...
ntTitle.Text="Notifications"; ntTitle.TextColor3=Color3.fromRGB(200, 240, 220)
...
ntDesc.Text="Enables/disables all hub notifications"; ntDesc.TextColor3=Color3.fromRGB(60, 100, 80)
...
ntPill.BackgroundColor3 = Color3.fromRGB(52,211,153) -- starts ACTIVE (tealic green)
...
ntStatusLbl.Text=T("notifOn"); ntStatusLbl.TextColor3=Color3.fromRGB(52,211,153)
...
ntBtn.MouseButton1Click:Connect(function()
    ...
    local onColor   = Color3.fromRGB(52,211,153)
    local offColor  = Color3.fromRGB(22, 36, 28)
    ...
    TweenService:Create(ntKnob,TweenInfo.new(0.22,Enum.EasingStyle.Back,Enum.EasingDirection.Out),{
        ...
        BackgroundColor3 = notifEnabled and Color3.fromRGB(255,255,255) or Color3.fromRGB(80, 115, 95)
    }):Play()
    TweenService:Create(ntStroke,TweenInfo.new(0.2),{
        Color = notifEnabled and onColor or Color3.fromRGB(40,72,55)
    }):Play()
...
histPanelOuter.BackgroundColor3 = Color3.fromRGB(12, 18, 15)
...
histPanelStroke.Color = Color3.fromRGB(52,211,153); histPanelStroke.Thickness=1.5
...
histHIconBg.BackgroundColor3=Color3.fromRGB(52,211,153); histHIconBg.BackgroundTransparency=0.75
...
histHArrow.Image="rbxassetid://6034818375"; histHArrow.ImageColor3=Color3.fromRGB(52,211,153)
...
histTogglePill.BackgroundColor3=Color3.fromRGB(74, 222, 128); histTogglePill.BorderSizePixel=0
...
histScroll.ScrollBarImageColor3  = Color3.fromRGB(52,211,153)
...
local function setHistPanelOpen(open, animated)
    ...
    if animated then
        ...
        TweenService:Create(histPanelStroke,TweenInfo.new(0.2),{Color=open and Color3.fromRGB(130,145,255) or Color3.fromRGB(52,211,153)}):Play()
    else
...
histToggleBtn.MouseButton1Click:Connect(function()
    ...
    local onC  = Color3.fromRGB(74, 222, 128)
...
local dadosStroke=Instance.new("UIStroke",dadosHeader); dadosStroke.Color=Color3.fromRGB(40,72,55); dadosStroke.Thickness=1
...
makeDadosBtn(dadosBtnsRow,"🔗 Discord Link",Color3.fromRGB(52,211,153),function()
...
dadosHeader.MouseButton1Click:Connect(function()
    ...
    TweenService:Create(dadosStroke,TweenInfo.new(0.2),{Color=dataOpen and C_ACCENT or Color3.fromRGB(40,72,55)}):Play()
end)
...
langHeaderStroke.Color=Color3.fromRGB(52,211,153); langHeaderStroke.Thickness=1.5

-- Ícone globo
local lhIconBg=Instance.new("Frame",langHeader)
lhIconBg.BackgroundColor3=Color3.fromRGB(52,211,153); lhIconBg.BackgroundTransparency=0.75
...
lhCurrentLbl.TextColor3=Color3.fromRGB(52,211,153); lhCurrentLbl.TextSize=10
...
lhArrow.Image="rbxassetid://6034818375"; lhArrow.ImageColor3=Color3.fromRGB(52,211,153)
...
langDropContent.BackgroundColor3=Color3.fromRGB(12, 18, 15); langDropContent.BorderSizePixel=0
...
langDropContent.ScrollBarImageColor3=Color3.fromRGB(52,211,153)
...
for idx, lang in ipairs(LANGUAGES) do
    ...
    lBtn.BackgroundColor3=isSelected and Color3.fromRGB(52,211,153) or Color3.fromRGB(30,33,45)
    ...
    if isSelected then
        local lbStroke=Instance.new("UIStroke",lBtn); lbStroke.Color=Color3.fromRGB(52,211,153); lbStroke.Thickness=1.2
    end
    ...
    lbName.Text=lang.name; lbName.TextColor3=isSelected and Color3.fromRGB(180, 240, 210) or Color3.fromRGB(180,188,210)
    ...
    lbCode.Text=lang.short; lbCode.TextColor3=isSelected and Color3.fromRGB(52,211,153) or Color3.fromRGB(90,100,125)
    ...
    lBtn.MouseButton1Click:Connect(function()
        ...
        TweenService:Create(langHeaderStroke,TweenInfo.new(0.2),{Color=Color3.fromRGB(52,211,153)}):Play()
...
srvCard.BackgroundColor3=Color3.fromRGB(12, 18, 15); srvCard.BorderSizePixel=0
...
srvSubTitle.TextColor3=Color3.fromRGB(80,125,100); srvSubTitle.TextSize=9
...
srvBox.TextColor3=Color3.fromRGB(190, 240, 215); srvBox.TextSize=10
...
srvBtn.MouseButton1Click:Connect(function()
    ...
    task.spawn(function()
        ...
        if not ok then
            ...
            srvStatusLbl.Text=T("srvTeleporting"); srvStatusLbl.TextColor3=Color3.fromRGB(74, 222, 128)
...
mkAccentBar(statsTitleCard,Color3.fromRGB(52,211,153))
...
stLiveLbl.Font=Enum.Font.GothamBold; stLiveLbl.Text="● LIVE"; stLiveLbl.TextColor3=Color3.fromRGB(74, 222, 128)
...
-- FPS column
local fpsIconBg=Instance.new("Frame",fpsPingCard); fpsIconBg.BackgroundColor3=Color3.fromRGB(74, 222, 128)
...
local fpsValLbl=mkLabel(fpsPingCard,UDim2.new(0,48,0,24),UDim2.new(0.42,0,0,24),"--",Enum.Font.GothamBlack,24,Color3.fromRGB(74, 222, 128))
...
local fpsBarFill=Instance.new("Frame",fpsBarBg); fpsBarFill.BackgroundColor3=Color3.fromRGB(74, 222, 128)
...
local srvJobLbl=mkLabel(srvInfoCard,UDim2.new(0,46,0,19),UDim2.new(1,-56,0,14),"Job: "..game.JobId:sub(1,22).."...",Enum.Font.GothamSemibold,9,Color3.fromRGB(190, 240, 215))
...
local srvRegionLbl=mkLabel(srvInfoCard,UDim2.new(0,46,0,46),UDim2.new(1,-56,0,12),"Região: detectando...",Enum.Font.Gotham,8,Color3.fromRGB(80,125,100))
...
plrMaxLbl.TextColor3=Color3.fromRGB(60, 100, 80); plrMaxLbl.TextSize=9; plrMaxLbl.TextXAlignment=Enum.TextXAlignment.Right; plrMaxLbl.ZIndex=6
...
local function refreshPlayerList()
    ...
    for i,plr in ipairs(allPlrs) do
        if not plrRows[plr.UserId] then
            ...
            row.BackgroundColor3=Color3.fromRGB(16,22,19); row.BackgroundTransparency=0.2
            ...
            -- Online dot
            local dot=Instance.new("Frame",avRing); dot.BackgroundColor3=Color3.fromRGB(74, 222, 128)
            ...
            nameL.TextColor3=Color3.fromRGB(190,240,215); nameL.TextSize=11
            ...
            tagL.TextColor3=Color3.fromRGB(60, 100, 80); tagL.TextSize=9
            tagL.TextXAlignment=Enum.TextXAlignment.Left; tagL.ZIndex=8
            -- Você badge
            if plr==Player then
                local youBadge=Instance.new("Frame",row); youBadge.BackgroundColor3=Color3.fromRGB(52,211,153)
                ...
                youLbl.Text=T("stPlayersYou"); youLbl.TextColor3=Color3.fromRGB(52, 211, 153); youLbl.TextSize=8; youLbl.ZIndex=9
            end
    ...
    while true do
        ...
        pcall(function()
            ...
            if elapsed>0 then
                ...
                local fpsColor=pct>0.9 and Color3.fromRGB(74, 222, 128) or pct>0.5 and Color3.fromRGB(255,200,50) or Color3.fromRGB(255,80,80)
...
local function criarIconeEsp(parent, key, cor)
    ...
    local function dk(f) f.BackgroundColor3=Color3.fromRGB(10,15,12); return f end
    if key == "Players" then
...
local function makeEspSection ( titleKey , cor )
    local hdr=Instance.new("Frame",Pages["Esp"]); hdr.BackgroundColor3=Color3.fromRGB(12, 18, 15)
    hdr.BackgroundTransparency=0.3; hdr.BorderSizePixel=0; hdr.Size=UDim2.new(1,0,0,26); hdr.LayoutOrder=espLO(); hdr.ZIndex=4
...
local function makeEspRow(cat)
    ...
    local iconContainer=Instance.new("Frame",row); iconContainer.BackgroundColor3=Color3.fromRGB(12, 18, 15)
    ...
    labelNome.Font=Enum.Font.GothamBold; labelNome.Text=cat.label; labelNome.TextColor3=Color3.fromRGB(200, 240, 220)
    ...
    labelDesc.Font=Enum.Font.Gotham; labelDesc.Text=cat.desc or ""; labelDesc.TextColor3=Color3.fromRGB(60, 100, 80)
    ...
    local pill=Instance.new("Frame",row); pill.BackgroundColor3=Color3.fromRGB(22, 36, 28); pill.BorderSizePixel=0
    pill.Position=UDim2.new(1,-52,0.5,-11); pill.Size=UDim2.new(0,42,0,22); pill.ZIndex=7
    Instance.new("UICorner",pill).CornerRadius=UDim.new(1,0)
    local knob=Instance.new("Frame",pill); knob.BackgroundColor3=Color3.fromRGB(80, 115, 95); knob.BorderSizePixel=0
    ...
    btn.MouseButton1Click:Connect(function()
        ...
        TweenService:Create(pill,TweenInfo.new(0.22,Enum.EasingStyle.Quad),{BackgroundColor3=state and cat.cor or Color3.fromRGB(22, 36, 28)}):Play()
        TweenService:Create(knob,TweenInfo.new(0.22,Enum.EasingStyle.Back,Enum.EasingDirection.Out),{
            Position=state and UDim2.new(1,-20,0.5,-9) or UDim2.new(0,2,0.5,-9),
            BackgroundColor3=state and Color3.fromRGB(255,255,255) or Color3.fromRGB(80, 115, 95),
        }):Play()
...
local espGroupOrder={
    {"espGroupEntities", Color3.fromRGB(52,211,153), {"Players","Kids","Animais","Monstros","Cultistas","Aliens"}},
...
local function makeBringSection(trKey, cor)
    local hdr=Instance.new("Frame",Pages["Bring"]); hdr.BackgroundColor3=Color3.fromRGB(12, 18, 15)
    hdr.BackgroundTransparency=0.3; hdr.BorderSizePixel=0; hdr.Size=UDim2.new(1,0,0,26); hdr.LayoutOrder=bringLO(); hdr.ZIndex=4
    Instance.new("UICorner",hdr).CornerRadius=UDim.new(0,8)
    local bar=Instance.new("Frame",hdr); bar.BackgroundColor3=cor; bar.BorderSizePixel=0
    bar.Position=UDim2.new(0,0,0,0); bar.Size=UDim2.new(0,3,1,0); bar.ZIndex=5
    Instance.new("UICorner",bar).CornerRadius=UDim.new(0,3)
...
local function makeBringRow(bcat)
    ...
    labelDesc.Font=Enum.Font.Gotham; labelDesc.Text=bcat.desc or ""; labelDesc.TextColor3=Color3.fromRGB(60, 100, 80)
    ...
    -- Botão LIMPAR
    local btnLimpar=Instance.new("TextButton",row); btnLimpar.BackgroundColor3=Color3.fromRGB(30,55,42); btnLimpar.BackgroundTransparency=0.1
    ...
    btnLimpar.MouseLeave:Connect(function() TweenService:Create(btnLimpar,TweenInfo.new(0.12),{BackgroundColor3=Color3.fromRGB(30,55,42),BackgroundTransparency=0.1}):Play() end)
    ...
    btnLimpar.MouseButton1Click:Connect(function()
        ...
        if restored > 0 then
            ...
            task.delay(0.8, function() TweenService:Create(btnLimpar,TweenInfo.new(0.3),{BackgroundColor3=Color3.fromRGB(30,55,42)}):Play() end)
            task.delay(2.5,function() TweenService:Create(feedbackLbl,TweenInfo.new(0.4),{TextTransparency=1}):Play(); task.wait(0.5); feedbackLbl.Text=""; feedbackLbl.TextTransparency=0; feedbackLbl.TextColor3=bcat.cor end)
        else
...
do
    ...
    local baStroke=Instance.new("UIStroke",baCard); baStroke.Color=Color3.fromRGB(52,211,153); baStroke.Thickness=1.8

    -- Glow bg
    local baGlow=Instance.new("Frame",baCard); baGlow.BackgroundColor3=Color3.fromRGB(52,211,153)
    ...
    -- Barra lateral
    local baBar=Instance.new("Frame",baCard); baBar.BackgroundColor3=Color3.fromRGB(52,211,153)
    ...
    -- Ícone
    local baIconBg=Instance.new("Frame",baCard); baIconBg.BackgroundColor3=Color3.fromRGB(52,211,153)
    ...
    baFeedLbl.TextColor3=Color3.fromRGB(52,211,153); baFeedLbl.TextSize=8
    ...
    local baProgFill=Instance.new("Frame",baProgBg); baProgFill.BackgroundColor3=Color3.fromRGB(52,211,153)
    ...
    -- Botão
    local baBtn=Instance.new("TextButton",baCard); baBtn.BackgroundColor3=Color3.fromRGB(52,211,153)
    ...
    baBtn.MouseLeave:Connect(function() TweenService:Create(baBtn,TweenInfo.new(0.12),{BackgroundTransparency=0.1,BackgroundColor3=Color3.fromRGB(52,211,153)}):Play() end)
    ...
    baBtn.MouseButton1Click:Connect(function()
        ...
        task.spawn(function()
            ...
            -- Feedback
            task.wait(0.2)
            TweenService:Create(baProgFill,TweenInfo.new(0.3),{Size=UDim2.new(1,0,1,0),BackgroundColor3=Color3.fromRGB(74, 222, 128)}):Play()
            baBtn.Text=T("bringAllBtn"); TweenService:Create(baBtn,TweenInfo.new(0.15),{BackgroundTransparency=0.1}):Play()
            if count>0 then
                baFeedLbl.Text="✓ "..count.." itens coletados!"; baFeedLbl.TextColor3=Color3.fromRGB(74, 222, 128)
            ...
            task.delay(3.5,function()
                TweenService:Create(baProgFill,TweenInfo.new(0.5),{Size=UDim2.new(0,0,1,0),BackgroundColor3=Color3.fromRGB(52,211,153)}):Play()
    ...
    -- Botão LIMPAR ALL
    local baLimparBtn=Instance.new("TextButton",baCard); baLimparBtn.BackgroundColor3=Color3.fromRGB(30,55,42)
    ...
    baLimparBtn.MouseLeave:Connect(function() TweenService:Create(baLimparBtn,TweenInfo.new(0.12),{BackgroundColor3=Color3.fromRGB(30,55,42),BackgroundTransparency=0.1}):Play() end)
    baLimparBtn.MouseButton1Click:Connect(function()
        ...
        if restored > 0 then
            ...
            task.delay(0.8, function() TweenService:Create(baLimparBtn,TweenInfo.new(0.3),{BackgroundColor3=Color3.fromRGB(30,55,42)}):Play() end)
...
local function makePlSec(titleKey, cor)
    local hdr=Instance.new("Frame",Pages["Player"]); hdr.BackgroundColor3=Color3.fromRGB(12, 18, 15)
    hdr.BackgroundTransparency=0.3; hdr.BorderSizePixel=0; hdr.Size=UDim2.new(1,0,0,26)
    hdr.LayoutOrder=plNextLO(); hdr.ZIndex=4
    Instance.new("UICorner",hdr).CornerRadius=UDim.new(0,8)
    local bar=Instance.new("Frame",hdr); bar.BackgroundColor3=cor; bar.BorderSizePixel=0
    bar.Size=UDim2.new(0,4,1,0); bar.ZIndex=5; Instance.new("UICorner",bar).CornerRadius=UDim.new(0,4)
    local lbl=Instance.new("TextLabel",hdr); lbl.BackgroundTransparency=1; lbl.Position=UDim2.new(0,10,0,0)
    lbl.Size=UDim2.new(1,-14,1,0); lbl.Font=Enum.Font.GothamBlack
    lbl.TextColor3=cor; lbl.TextSize=10; lbl.TextXAlignment=Enum.TextXAlignment.Left; lbl.ZIndex=5
    TL(lbl, titleKey)  -- auto-tracked for language switching
...
local function makePlToggle(lbl_txt, desc_txt, cor, onToggle)
    local row=Instance.new("Frame",Pages["Player"]); row.BackgroundColor3=Color3.fromRGB(16, 23, 19)
    row.BorderSizePixel=0; row.Size=UDim2.new(1,0,0,56); row.LayoutOrder=plNextLO(); row.ZIndex=5
    Instance.new("UICorner",row).CornerRadius=UDim.new(0,12)
    local rowS=Instance.new("UIStroke",row); rowS.Color=Color3.fromRGB(28, 50, 38); rowS.Thickness=1
    ...
    tl.Text=lbl_txt; tl.TextColor3=Color3.fromRGB(200, 240, 220); tl.TextSize=12; tl.TextXAlignment=Enum.TextXAlignment.Left; tl.ZIndex=7
    ...
    td.Text=desc_txt; td.TextColor3=Color3.fromRGB(60, 100, 80); td.TextSize=9
    ...
    btn.MouseButton1Click:Connect(function()
        state=not state
        TweenService:Create(pill,TweenInfo.new(0.22,Enum.EasingStyle.Quad),{BackgroundColor3=state and cor or Color3.fromRGB(22, 36, 28)}):Play()
        TweenService:Create(knob,TweenInfo.new(0.22,Enum.EasingStyle.Back,Enum.EasingDirection.Out),{
            Position=state and UDim2.new(1,-24,0.5,-11) or UDim2.new(0,2,0.5,-11),
            BackgroundColor3=state and Color3.fromRGB(255,255,255) or Color3.fromRGB(80, 115, 95)
        }):Play()
        TweenService:Create(rowS,TweenInfo.new(0.2),{Color=state and cor or Color3.fromRGB(28, 50, 38)}):Play()
        -- Notificação automática: verde ao ativar, vermelha ao desativar
        if state then
            Notify.success(lbl_txt, "✓ Ativado")
        else
            Notify.error(lbl_txt, "✗ Desativado")
        end
        onToggle(state)
    end)
end
...
local function makeSliderBar(parentPage, lbl_txt, desc_txt, cor, minV, maxV, initVal, onChange)
    ...
    row.BackgroundColor3 = Color3.fromRGB(16, 23, 19); row.BorderSizePixel = 0
    ...
    td.Text=desc_txt; td.TextColor3=Color3.fromRGB(60, 100, 80); td.TextSize=9; td.TextXAlignment=Enum.TextXAlignment.Left; td.ZIndex=7
...
local function makePlKACard(COR, titleTxt, descTxt, minV, maxV, defV, maxStr, getDescFn, initEnabled, onToggle, onSlider)
    ...
    titLbl.TextColor3=Color3.fromRGB(200, 240, 220); titLbl.TextSize=12
    ...
    descLbl.TextColor3=Color3.fromRGB(60, 100, 80); descLbl.TextSize=9
    ...
    Instance.new("UICorner",pill).CornerRadius=UDim.new(1,0)
    pill.BackgroundColor3 = initEnabled and COR or Color3.fromRGB(22, 36, 28)
    ...
    pillKnob.BackgroundColor3 = initEnabled and Color3.fromRGB(255,255,255) or Color3.fromRGB(80, 115, 95)
    ...
    statusLbl.TextColor3 = initEnabled and COR or Color3.fromRGB(70, 110, 88)
    ...
    toggleBtn.MouseButton1Click:Connect(function()
        enabled = not enabled
        TweenService:Create(pill,TweenInfo.new(0.22),{BackgroundColor3=enabled and COR or Color3.fromRGB(22, 36, 28)}):Play()
        TweenService:Create(pillKnob,TweenInfo.new(0.22,Enum.EasingStyle.Back,Enum.EasingDirection.Out),{
            ...
            BackgroundColor3=enabled and Color3.fromRGB(255,255,255) or Color3.fromRGB(80, 115, 95)
        }):Play()
        ...
        statusLbl.TextColor3= enabled and COR or Color3.fromRGB(70, 110, 88)
...
acsDescLbl.TextColor3 = Color3.fromRGB(60, 100, 80); acsDescLbl.TextSize = 9
...
acsPill.BackgroundColor3 = Color3.fromRGB(22, 36, 28)
...
acsKnob.BackgroundColor3 = Color3.fromRGB(80, 115, 95)
...
acsStatus.Text = "INATIVO"; acsStatus.TextColor3 = Color3.fromRGB(70, 110, 88)
...
acsBtnClick.MouseButton1Click:Connect(function()
    ...
    TweenService:Create(acsPill,TweenInfo.new(0.22),{
        BackgroundColor3 = acsEnabled and ACS_COR or Color3.fromRGB(22, 36, 28)
    }):Play()
    TweenService:Create(acsKnob,TweenInfo.new(0.22,Enum.EasingStyle.Back,Enum.EasingDirection.Out),{
        ...
        BackgroundColor3 = acsEnabled and Color3.fromRGB(255,255,255) or Color3.fromRGB(80, 115, 95)
    }):Play()
    ...
    acsStatus.TextColor3 = acsEnabled and ACS_COR   or Color3.fromRGB(70, 110, 88)
...
do
    local ibcSecHdr = Instance.new("Frame",Pages["Player"]); ibcSecHdr.BackgroundColor3 = Color3.fromRGB(12, 18, 15)
...
ibcDesc.TextColor3 = Color3.fromRGB(60, 100, 80); ibcDesc.TextSize = 9
...
ibcPill.BackgroundColor3 = Color3.fromRGB(22, 36, 28); ibcPill.BorderSizePixel = 0
...
ibcKnob.BackgroundColor3 = Color3.fromRGB(80, 115, 95); ibcKnob.BorderSizePixel = 0
...
ibcBtn.MouseButton1Click:Connect(function()
    ...
    TweenService:Create(ibcPill,TweenInfo.new(0.22),{
        BackgroundColor3 = ibcEnabled and IBC_COR or Color3.fromRGB(22, 36, 28)
    }):Play()
    TweenService:Create(ibcKnob,TweenInfo.new(0.22,Enum.EasingStyle.Back,Enum.EasingDirection.Out),{
        ...
        BackgroundColor3 = ibcEnabled and Color3.fromRGB(255,255,255) or Color3.fromRGB(80, 115, 95),
    }):Play()
...
cfgSec.BackgroundColor3 = Color3.fromRGB(12, 18, 15); cfgSec.BackgroundTransparency = 0.3
...
-- ── Card principal Estilo de Bring ───────────────────────────
local cfgCard = Instance.new("Frame", Pages["Configuracoes"])
cfgCard.BackgroundColor3 = Color3.fromRGB(22,24,34); cfgCard.BorderSizePixel = 0
cfgCard.Size = UDim2.new(1,0,0,68); cfgCard.LayoutOrder = cfgNextLO(); cfgCard.ZIndex = 5
Instance.new("UICorner",cfgCard).CornerRadius = UDim.new(0,10)
local cfgStroke = Instance.new("UIStroke",cfgCard)
cfgStroke.Color = Color3.fromRGB(55,70,110); cfgStroke.Thickness = 1.2

-- Barra lateral
local cfgBar = Instance.new("Frame",cfgCard)
cfgBar.BackgroundColor3 = CFG_COR; cfgBar.BorderSizePixel = 0
cfgBar.Size = UDim2.new(0,3,0.7,0); cfgBar.Position = UDim2.new(0,0,0.15,0); cfgBar.ZIndex = 6
...
cfgTitleLbl.Position = UDim2.new(0,14,0,10); cfgTitleLbl.Size = UDim2.new(0.55,0,0,18)
cfgTitleLbl.Font = Enum.Font.GothamBold; cfgTitleLbl.Text = "Estilo de Bring"
cfgTitleLbl.TextColor3 = Color3.fromRGB(215,225,255); cfgTitleLbl.TextSize = 12
...
cfgDescLbl.Position = UDim2.new(0,14,0,30); cfgDescLbl.Size = UDim2.new(0.55,0,0,30)
cfgDescLbl.Font = Enum.Font.Gotham; cfgDescLbl.Text = "Define como os itens aparecem ao usar qualquer Bring."
cfgDescLbl.TextColor3 = Color3.fromRGB(90,100,130); cfgDescLbl.TextSize = 9
...
cfgStyleBtn.BackgroundColor3 = Color3.fromRGB(40,50,80); cfgStyleBtn.BackgroundTransparency = 0
cfgStyleBtn.BorderSizePixel = 0; cfgStyleBtn.Position = UDim2.new(1,-150,0.5,-14)
cfgStyleBtn.Size = UDim2.new(0,138,0,28); cfgStyleBtn.ZIndex = 9
cfgStyleBtn.Font = Enum.Font.GothamBold; cfgStyleBtn.Text = STYLE_LABELS[bringStyle]
cfgStyleBtn.TextColor3 = Color3.fromRGB(200,220,255); cfgStyleBtn.TextSize = 10
Instance.new("UICorner",cfgStyleBtn).CornerRadius = UDim.new(0,8)
local cfgStyleStroke = Instance.new("UIStroke",cfgStyleBtn)
cfgStyleStroke.Color = CFG_COR; cfgStyleStroke.Thickness = 1.2; cfgStyleStroke.Transparency = 0.4
...
cfgPopup.BackgroundColor3 = Color3.fromRGB(22,26,40)
...
Instance.new("UICorner",cfgPopupShadow).CornerRadius = UDim.new(0,18)
...
local function pegarItensBaus(statusLbl)
    ...
    Notify.send({type="custom", icon="✅", accent=Color3.fromRGB(74, 222, 128),
...
local function makeTpSec(titleTxt, cor)
    ...
    hdr.BackgroundColor3 = Color3.fromRGB(12, 18, 15); hdr.BackgroundTransparency = 0.3
...
local function makeTpBtn(icon, titleTxt, descTxt, cor, onClick)
    ...
    Instance.new("UICorner",card).CornerRadius = UDim.new(0,9)
    local stroke = Instance.new("UIStroke",card); stroke.Color = Color3.fromRGB(28, 50, 38); stroke.Thickness = 1
    ...
    tl.TextColor3 = Color3.fromRGB(200, 240, 220); tl.TextSize = 12
    ...
    td.TextColor3 = Color3.fromRGB(60, 100, 80); td.TextSize = 9
    td.TextXAlignment = Enum.TextXAlignment.Left; td.TextWrapped = true; td.ZIndex = 7
    ...
    btn.MouseLeave:Connect(function()
        ...
        TweenService:Create(stroke,TweenInfo.new(0.12),{Color=Color3.fromRGB(28, 50, 38)}):Play()
    end)
...
tpChildStroke = Instance.new("UIStroke",tpChildCard); tpChildStroke.Color = Color3.fromRGB(28, 50, 38); tpChildStroke.Thickness = 1
...
chTitle.TextColor3 = Color3.fromRGB(200, 240, 220); chTitle.TextSize = 12
...
chDesc.TextColor3 = Color3.fromRGB(60, 100, 80); chDesc.TextSize = 9
chDesc.TextXAlignment = Enum.TextXAlignment.Left; chDesc.TextWrapped = true; chDesc.ZIndex = 7

-- Indicador de status (ponto pulsante)
local chStatusDot = Instance.new("Frame",tpChildCard); chStatusDot.BackgroundColor3 = Color3.fromRGB(60, 100, 80)
...
tpChildBtn.MouseButton1Click:Connect(function()
    ...
    if target then
        ...
        tpChildActive = false
        TweenService:Create(tpChildStroke,TweenInfo.new(0.2),{Color=Color3.fromRGB(28, 50, 38)}):Play()
        TweenService:Create(chStatusDot,TweenInfo.new(0.2),{BackgroundColor3=Color3.fromRGB(60, 100, 80)}):Play()
        tpChildBtnL.Text = "✓"
...
bpCard.BackgroundColor3 = Color3.fromRGB(18,20,30)
...
bpCardStroke.Color = Color3.fromRGB(80,110,200); bpCardStroke.Thickness = 1.8

-- ── Header ──────────────────────────────────────────────────
local bpHdr = Instance.new("Frame",bpCard)
bpHdr.BackgroundColor3 = Color3.fromRGB(25,30,55)
...
bpHdrFix.BackgroundColor3 = Color3.fromRGB(25,30,55)
...
bpHdrTitle.TextColor3 = TP_COR_BUILD; bpHdrTitle.TextSize = 13
...
bpHdrSub.TextColor3 = Color3.fromRGB(100,120,180); bpHdrSub.TextSize = 9
bpHdrSub.TextXAlignment = Enum.TextXAlignment.Left; bpHdrSub.ZIndex = 7

-- Botão atualizar
local bpBtnRef = Instance.new("TextButton",bpHdr)
bpBtnRef.BackgroundColor3 = Color3.fromRGB(60,100,200)
bpBtnRef.BackgroundTransparency = 0.45; bpBtnRef.BorderSizePixel = 0
...
bpBtnClr.BackgroundTransparency = 0.5; bpBtnClr.BorderSizePixel = 0
...
bpEmptyLbl.TextColor3 = Color3.fromRGB(70,80,120); bpEmptyLbl.TextSize = 11
...
bpDetailHdr.BackgroundColor3 = Color3.fromRGB(20,24,42)
...
bpBackBtn.BackgroundColor3 = Color3.fromRGB(60,80,140)
bpBackBtn.BackgroundTransparency = 0.4; bpBackBtn.BorderSizePixel = 0
...
bpBackBtnL.Text = "◀ Voltar"; bpBackBtnL.TextColor3 = Color3.fromRGB(200,215,255)
...
bpDetailTitle.TextColor3 = TP_COR_BUILD; bpDetailTitle.TextSize = 12
...
bpDetailCount.TextColor3 = Color3.fromRGB(100,120,180); bpDetailCount.TextSize = 9
...
bpDetailScroll.ScrollBarImageColor3 = TP_COR_BUILD
...
local function bpGetOrCreateGroup(key, name, icon, color)
    ...
    Instance.new("UICorner",btn).CornerRadius = UDim.new(0,14)
    local btnS = Instance.new("UIStroke",btn); btnS.Color = color; btnS.Thickness = 2; btnS.Transparency = 0.5
    ...
    icoBox.BackgroundColor3 = color; icoBox.BackgroundTransparency = 0.65
    ...
    nameLbl.TextColor3 = Color3.fromRGB(230,235,255); nameLbl.TextSize = 13
    nameLbl.TextXAlignment = Enum.TextXAlignment.Left; nameLbl.ZIndex = 8

    -- Contagem
    local cntBadge = Instance.new("Frame",btn)
    cntBadge.BackgroundColor3 = color; cntBadge.BackgroundTransparency = 0.3
    ...
    hitBtn.MouseEnter:Connect(function()
        TweenService:Create(btn,TweenInfo.new(0.12),{BackgroundColor3=Color3.fromRGB(30,36,60)}):Play()
    ...
    hitBtn.MouseLeave:Connect(function()
        TweenService:Create(btn,TweenInfo.new(0.12),{BackgroundColor3=Color3.fromRGB(22,26,44)}):Play()
...
local function bpAddEntryToGroup(grp, name, pos, biomeLabel, biomeIcon)
    ...
    Instance.new("UICorner",row).CornerRadius = UDim.new(0,12)
    -- Se já visitado: fundo vermelho
    if wasVisited then
        row.BackgroundColor3 = Color3.fromRGB(80,18,18)
    else
        row.BackgroundColor3 = Color3.fromRGB(22,26,42)
    end
    local rowS = Instance.new("UIStroke",row)
    rowS.Color = wasVisited and Color3.fromRGB(200,60,60) or Color3.fromRGB(50,60,90)
    rowS.Thickness = 1.5
    ...
    nameLbl.TextColor3 = wasVisited and Color3.fromRGB(200,130,130) or Color3.fromRGB(180, 250, 220)
    ...
    infoLbl.TextColor3 = wasVisited and Color3.fromRGB(160,100,100) or Color3.fromRGB(80,100,150)
    ...
    tpb.BackgroundColor3 = grp.color; tpb.BackgroundTransparency = 0.5
    tpb.BorderSizePixel = 0; tpb.Position = UDim2.new(1,-46,0.5,-16)
    tpb.Size = UDim2.new(0,40,0,32); tpb.ZIndex = 10
    ...
    tpbL.Text = "TP"; tpbL.TextColor3 = Color3.fromRGB(255,255,255); tpbL.TextSize = 12; tpbL.ZIndex = 11
    ...
    local function doTp()
        ...
        task.delay(0.2, function()
            TweenService:Create(tpb,TweenInfo.new(0.2),{BackgroundColor3=grp.color,BackgroundTransparency=0.5}):Play()
        end)
    ...
    rowHit.MouseEnter:Connect(function()
        if not entry.visited then
            TweenService:Create(row,TweenInfo.new(0.1),{BackgroundColor3=Color3.fromRGB(28,34,58)}):Play()
        end
    end)
    rowHit.MouseLeave:Connect(function()
        if not entry.visited then
            TweenService:Create(row,TweenInfo.new(0.1),{BackgroundColor3=Color3.fromRGB(22,26,42)}):Play()
        end
    end)
...
cpCard.BackgroundColor3 = Color3.fromRGB(20,17,10)
...
cpStroke.Color = Color3.fromRGB(180,130,30); cpStroke.Thickness = 1.8

-- ── Header ──────────────────────────────────────────────────
local cpHdr = Instance.new("Frame",cpCard)
cpHdr.BackgroundColor3 = Color3.fromRGB(30,22,10)
...
cpHdrFix.BackgroundColor3 = Color3.fromRGB(30,22,10)
...
cpHdrTitle.TextColor3 = TP_COR_CHEST; cpHdrTitle.TextSize = 13
...
cpHdrSub.TextColor3 = Color3.fromRGB(140,110,40); cpHdrSub.TextSize = 9
cpHdrSub.TextXAlignment = Enum.TextXAlignment.Left; cpHdrSub.ZIndex = 7

local cpBtnRef = Instance.new("TextButton",cpHdr)
cpBtnRef.BackgroundColor3 = Color3.fromRGB(180,120,20); cpBtnRef.BackgroundTransparency = 0.45
...
cpBtnClr.BackgroundColor3 = Color3.fromRGB(200,50,50); cpBtnClr.BackgroundTransparency = 0.5
...
cpDetailHdr.BackgroundColor3 = Color3.fromRGB(25,20,10)
...
cpBackBtn.BackgroundColor3 = Color3.fromRGB(140,90,20); cpBackBtn.BackgroundTransparency = 0.4
...
cpBackBtnL.Text = "◀ Voltar"; cpBackBtnL.TextColor3 = Color3.fromRGB(255,220,150)
...
cpDetailTitle.TextColor3 = TP_COR_CHEST; cpDetailTitle.TextSize = 12
...
cpDetailCount.TextColor3 = Color3.fromRGB(140,110,40); cpDetailCount.TextSize = 9
...
cpDetailScroll.ScrollBarImageColor3 = TP_COR_CHEST
...
local function cpGetOrCreateGroup(rarity)
    ...
    btn.BackgroundColor3 = Color3.fromRGB(22,18,10); btn.BorderSizePixel = 0
    btn.Size = UDim2.new(1,0,0,68); btn.ZIndex = 7
    -- LayoutOrder = tier invertido
    btn.LayoutOrder = 100 - (rarity.tier or 0)
    Instance.new("UICorner",btn).CornerRadius = UDim.new(0,14)
    local btnS = Instance.new("UIStroke",btn); btnS.Color = COR; btnS.Thickness = 2; btnS.Transparency = 0.5
    ...
    btnBar.Position = UDim2.new(0,0,0.2,0); btnBar.Size = UDim2.new(0,4,0.6,0); btnBar.ZIndex = 9
    Instance.new("UICorner",btnBar).CornerRadius = UDim.new(0,3)
    local icoBox = Instance.new("Frame",btn); icoBox.BackgroundColor3 = COR; icoBox.BackgroundTransparency = 0.65
    ...
    nameLbl.TextColor3 = Color3.fromRGB(240,230,200); nameLbl.TextSize = 13
    nameLbl.TextXAlignment = Enum.TextXAlignment.Left; nameLbl.ZIndex = 8
    local cntBadge = Instance.new("Frame",btn); cntBadge.BackgroundColor3 = COR; cntBadge.BackgroundTransparency = 0.3
    ...
    hitBtn.Size = UDim2.new(1,0,1,0); hitBtn.Text = ""; hitBtn.ZIndex = 10
    hitBtn.MouseEnter:Connect(function()
        TweenService:Create(btn,TweenInfo.new(0.12),{BackgroundColor3=Color3.fromRGB(32,26,14)}):Play()
        TweenService:Create(btnS,TweenInfo.new(0.12),{Transparency=0}):Play()
    end)
    hitBtn.MouseLeave:Connect(function()
        TweenService:Create(btn,TweenInfo.new(0.12),{BackgroundColor3=Color3.fromRGB(22,18,10)}):Play()
        TweenService:Create(btnS,TweenInfo.new(0.12),{Transparency=0.5}):Play()
    end)
    hitBtn.MouseButton1Click:Connect(function()
...
local function cpAddEntry(grp, name, pos, biomeLabel, biomeIcon)
    ...
    Instance.new("UICorner",row).CornerRadius = UDim.new(0,12)
    row.BackgroundColor3 = wasVisited and Color3.fromRGB(80,18,18) or Color3.fromRGB(22,18,10)
    local rowS = Instance.new("UIStroke",row)
    rowS.Color = wasVisited and Color3.fromRGB(200,60,60) or Color3.fromRGB(60,50,20); rowS.Thickness = 1.5
    ...
    rarBar.Position = UDim2.new(0,0,0.1,0); rarBar.Size = UDim2.new(0,3,0.8,0); rarBar.ZIndex = 9
    ...
    nameLbl.Font = Enum.Font.GothamBold; nameLbl.Text = name
    nameLbl.TextColor3 = wasVisited and Color3.fromRGB(200,130,130) or Color3.fromRGB(240,225,190)
    ...
    infoLbl.Text = biomeIcon.." "..biomeLabel..distTxt
    infoLbl.TextColor3 = wasVisited and Color3.fromRGB(160,100,100) or COR
    infoLbl.TextXAlignment = Enum.TextXAlignment.Left; infoLbl.ZIndex = 9
    -- Etiqueta
    ...
    tpb.Position = UDim2.new(1,-46,0.5,-16); tpb.Size = UDim2.new(0,40,0,32); tpb.ZIndex = 10
    Instance.new("UICorner",tpb).CornerRadius = UDim.new(0,10)
    local tpbL = Instance.new("TextLabel",tpb); tpbL.BackgroundTransparency = 1
    tpbL.Size = UDim2.new(1,0,1,0); tpbL.Font = Enum.Font.GothamBlack
    tpbL.Text = "TP"; tpbL.TextColor3 = Color3.fromRGB(255,255,255); tpbL.TextSize = 12; tpbL.ZIndex = 11
    local function doTp()
        ...
        TweenService:Create(tpb,TweenInfo.new(0.08),{BackgroundColor3=Color3.fromRGB(255,255,255),BackgroundTransparency=0}):Play()
        task.delay(0.2,function() TweenService:Create(tpb,TweenInfo.new(0.2),{BackgroundColor3=COR,BackgroundTransparency=0.5}):Play() end)
        TweenService:Create(row,TweenInfo.new(0.25),{BackgroundColor3=Color3.fromRGB(80,18,18)}):Play()
        TweenService:Create(rowS,TweenInfo.new(0.25),{Color=Color3.fromRGB(200,60,60)}):Play()
    ...
    rowHit.Size = UDim2.new(1,-50,1,0); rowHit.Text = ""; rowHit.ZIndex = 9
    rowHit.MouseButton1Click:Connect(doTp)
    rowHit.MouseEnter:Connect(function() if not entry.visited then TweenService:Create(row,TweenInfo.new(0.1),{BackgroundColor3=Color3.fromRGB(30,24,14)}):Play() end end)
    rowHit.MouseLeave:Connect(function() if not entry.visited then TweenService:Create(row,TweenInfo.new(0.1),{BackgroundColor3=Color3.fromRGB(22,18,10)}):Play() end end)
    return entry
end
...
local function makeToggle(page, lo_fn, lbl_txt, desc_txt, cor, onToggle)
    ...
    local tl=Instance.new("TextLabel",row); tl.BackgroundTransparency=1
    tl.Position=UDim2.new(0,14,0,8); tl.Size=UDim2.new(1,-80,0,18); tl.Font=Enum.Font.GothamBold
    tl.Text=lbl_txt; tl.TextColor3=Color3.fromRGB(200, 240, 220); tl.TextSize=12
    tl.TextXAlignment=Enum.TextXAlignment.Left; tl.ZIndex=7
    local td=Instance.new("TextLabel",row); td.BackgroundTransparency=1
...
local function makeSlider(page, lo_fn, lbl_txt, minV, maxV, defV, cor, fmt, onChange)
    ...
    Instance.new("UICorner",row).CornerRadius=UDim.new(0,12)
    Instance.new("UIStroke",row).Color=Color3.fromRGB(28, 50, 38)
    local tl=Instance.new("TextLabel",row); tl.BackgroundTransparency=1
    tl.Position=UDim2.new(0,14,0,8); tl.Size=UDim2.new(1,-100,0,18); tl.Font=Enum.Font.GothamBold
    tl.Text=lbl_txt; tl.TextColor3=Color3.fromRGB(190, 240, 215); tl.TextSize=11
    tl.TextXAlignment=Enum.TextXAlignment.Left; tl.ZIndex=7
    local valLbl=Instance.new("TextLabel",row); valLbl.BackgroundTransparency=1
    ...
    valLbl.TextXAlignment=Enum.TextXAlignment.Right; valLbl.ZIndex=7
    -- Track
    local track=Instance.new("Frame",row); track.BackgroundColor3=Color3.fromRGB(20, 32, 26)
...
kaSecHdr.BackgroundColor3 = Color3.fromRGB(12, 18, 15)
...
kaDescLbl.Font = Enum.Font.Gotham; kaDescLbl.TextColor3 = Color3.fromRGB(60, 100, 80)
TL(kaDescLbl, "kaDesc")
...
local kaPill = Instance.new("Frame",kaCard); kaPill.BackgroundColor3 = Color3.fromRGB(22, 36, 28); kaPill.BorderSizePixel = 0
...
local kaKnob = Instance.new("Frame",kaPill); kaKnob.BackgroundColor3 = Color3.fromRGB(80, 115, 95); kaKnob.BorderSizePixel = 0
...
for i, txt in ipairs(descTexts) do
    ...
    d.Font=Enum.Font.Gotham; d.TextColor3=Color3.fromRGB(60, 100, 80); d.TextSize=8
...
kaBtnClick.MouseButton1Click:Connect(function()
    ...
    TweenService:Create(kaPill,TweenInfo.new(0.22),{BackgroundColor3=kaEnabled and KA_COR or Color3.fromRGB(22, 36, 28)}):Play()
    TweenService:Create(kaKnob,TweenInfo.new(0.22,Enum.EasingStyle.Back,Enum.EasingDirection.Out),{
        ...
        BackgroundColor3=kaEnabled and Color3.fromRGB(255,255,255) or Color3.fromRGB(80, 115, 95)
    }):Play()
    ...
    if kaEnabled then
        ...
        Notify.send({type="custom",icon="⚔️",accent=Color3.fromRGB(74, 222, 128),
...
-- ── Solta um item sobre o triturador de forma limpa ────────────
-- atSoltar: coloca item acima do triturador e desce por teleporte contínuo
-- O CFrame set replica do client para o servidor (ao contrário de física)
local function atSoltar(part, obj, pos, targetY)
    -- 1. Limpa constraints e scripts
    for _, v in ipairs(obj:GetDescendants()) do
        pcall(function()
            if v:IsA("BodyPosition") or v:IsA("BodyForce") or v:IsA("BodyVelocity")
            or v:IsA("BodyGyro") or v:IsA("AlignPosition") or v:IsA("AlignOrientation")
            or v:IsA("LinearVelocity") or v:IsA("AngularVelocity")
            or v:IsA("Weld") or v:IsA("WeldConstraint") or v:IsA("Motor6D") then
                v:Destroy()
            end
        end)
    end
    ...
    -- 2. Solta e posiciona no ponto de drop
    pcall(function() part.Anchored = false end)
    part.CanCollide = true
    part.CFrame     = CFrame.new(pos)

    -- Partes secundárias do Model
    if obj:IsA("Model") then
    ...
    -- 3. Desce por teleporte contínuo (40 steps de 0.4 studs = 16 studs total)
    -- CFrame.set replica para o servidor; BodyVelocity NÃO replica sem ownership
    task.spawn(function()
        local steps = 50
        local stepSize = 0.4  -- studs por step
        for i = 1, steps do
            if not part or not part.Parent then break end
            local curY = part.Position.Y
            if curY <= (targetY + 1) then break end  -- chegou no triturador
            local newY = math.max(curY - stepSize, targetY)
            pcall(function()
                part.CFrame = CFrame.new(part.Position.X, newY, part.Position.Z)
                -- Partes secundárias descem junto
                if obj:IsA("Model") then
                    for _, bp in ipairs(obj:GetDescendants()) do
                        if bp:IsA("BasePart") and bp ~= part then
                            pcall(function()
                                bp.CFrame = CFrame.new(bp.Position.X, bp.Position.Y - stepSize, bp.Position.Z)
                            end)
                        end
                    end
                end
...
-- ── MAIN: Envia em batches de 5 Logs + 4 Metais a cada 2s ─────
local function autoTriturador()
    ...
    local ALTURA   = 15   -- 15 studs acima do triturador
    local LOTE_LOG = 5    -- 5 Logs por batch
    local LOTE_MET = 4    -- 4 Metais/Sucata por batch
    local INTERVALO = 2   -- segundos entre batches

    -- Posições distribuídas em círculo separado ao redor do triturador
    -- Usa slots fixos para cada item do batch — sem sobreposição
    local function dropPos(slotIdx, totalSlots)
        local total = math.max(totalSlots, 1)
        local angle = (slotIdx / total) * math.pi * 2
        local r = 0.4 + (slotIdx % 3) * 0.5  -- 0.4 / 0.9 / 1.4 studs — dentro do triturador
        return Vector3.new(
            shredPos.X + math.cos(angle) * r,
            shredPos.Y + ALTURA,
            shredPos.Z + math.sin(angle) * r)
    end
    ...
    while atRunning do
        ...
        local totalMet  = #metals

        if totalLogs == 0 and totalMet == 0 then break end

        loteN += 1
        local loteLog = math.min(LOTE_LOG, totalLogs)
        local loteMet = math.min(LOTE_MET, totalMet)
        local loteTotal = loteLog + loteMet

        -- Atualiza status na UI
        pcall(function()
            atStatus.Text = string.format("🪵 %d Logs  •  ⚙️ %d Metais  — Lote %d",
                totalLogs, totalMet, loteN)
        end)
        ...
        for s = 1, loteLog do
            ...
            if entry and entry.part and entry.part.Parent then
                local pos = dropPos(s - 1, loteTotal)
                atSoltar(entry.part, entry.obj, pos, shredPos.Y)
                enviados += 1
            end
        end

        -- Envia Metais/Sucata do lote (continua os slots)
        for s = 1, loteMet do
            local entry = metals[s]
            if entry and entry.part and entry.part.Parent then
                local pos = dropPos(loteLog + s - 1, loteTotal)
                atSoltar(entry.part, entry.obj, pos, shredPos.Y)
                enviados += 1
            end
        end

        -- Aguarda 2 segundos antes do próximo lote
        task.wait(INTERVALO)
    end
    ...
    if enviados > 0 then
        Notify.send({type="custom", icon="✅", accent=Color3.fromRGB(74, 222, 128),
            ...
            msg=string.format("%d item(s) enviados em %d lote(s)!", enviados, loteN),
            duration=5})
    else
        Notify.warn("⚙️ Auto Triturador", "Nenhum Log ou Sucata encontrado!", 3)
    end
    atRunning = false
end
...
atSecHdr.BackgroundColor3 = Color3.fromRGB(12, 18, 15); atSecHdr.BackgroundTransparency = 0.3
...
local function stopAutoExplore(tpBack)
    ...
    pcall(function()
        if aePill   then TweenService:Create(aePill,  TweenInfo.new(0.22), {BackgroundColor3=Color3.fromRGB(22, 36, 28)}):Play() end
        if aeKnob   then TweenService:Create(aeKnob,  TweenInfo.new(0.22, Enum.EasingStyle.Back, Enum.EasingDirection.Out),
                            {Position=UDim2.new(0,2,0.5,-11), BackgroundColor3=Color3.fromRGB(80, 115, 95)}):Play() end
        if aeStroke then TweenService:Create(aeStroke, TweenInfo.new(0.2), {Color=Color3.fromRGB(28, 50, 38)}):Play() end
...
aeSecHdr.BackgroundColor3 = Color3.fromRGB(12, 18, 15); aeSecHdr.BackgroundTransparency = 0.3
...
aeCard.BackgroundColor3 = Color3.fromRGB(16,22,32); aeCard.BorderSizePixel = 0
...
aeStroke = Instance.new("UIStroke",aeCard); aeStroke.Color = Color3.fromRGB(28, 50, 38); aeStroke.Thickness = 1
...
aeTitleLbl.Text="🗺️ Auto Explorar"; aeTitleLbl.TextColor3=Color3.fromRGB(200,230,255)
aeTitleLbl.TextSize=12; aeTitleLbl.TextXAlignment=Enum.TextXAlignment.Left; aeTitleLbl.ZIndex=7
aeLabelState = Instance.new("TextLabel",aeTitleRow); aeLabelState.BackgroundColor3=Color3.fromRGB(30,35,50)
...
aeLabelState.TextColor3=Color3.fromRGB(100,120,160); aeLabelState.TextSize=8
...
Instance.new("UIStroke",aeLabelState).Color=Color3.fromRGB(45,55,75)

-- Toggle pill
aePill = Instance.new("Frame",aeCard); aePill.BackgroundColor3=Color3.fromRGB(22, 36, 28)
...
aeKnob = Instance.new("Frame",aePill); aeKnob.BackgroundColor3=Color3.fromRGB(80, 115, 95)
...
for bi, lbl in ipairs(aeLvlLabels) do
    ...
    btn.BackgroundColor3 = (aeLvlVals[bi]==aeManualLevel)
        and Color3.fromRGB(120,200,255) or Color3.fromRGB(30,36,52)
...
aeRadiusLbl.TextColor3=Color3.fromRGB(60,80,110); aeRadiusLbl.TextSize=8
aeRadiusLbl.TextXAlignment=Enum.TextXAlignment.Left; aeRadiusLbl.ZIndex=6

-- Linha 5: barra de progresso
local aeProgressBg = Instance.new("Frame",aeCard); aeProgressBg.BackgroundColor3=Color3.fromRGB(30,36,52)
...
aeDesc.TextColor3=Color3.fromRGB(55,75,100); aeDesc.TextSize=8; aeDesc.TextWrapped=true
...
aeBtn.MouseButton1Click:Connect(function()
    ...
    TweenService:Create(aePill,TweenInfo.new(0.22),{BackgroundColor3=aeEnabled and AE_COR or Color3.fromRGB(22, 36, 28)}):Play()
    TweenService:Create(aeKnob,TweenInfo.new(0.22,Enum.EasingStyle.Back,Enum.EasingDirection.Out),{
        ...
        BackgroundColor3=aeEnabled and Color3.fromRGB(255,255,255) or Color3.fromRGB(80, 115, 95),
    }):Play()
    TweenService:Create(aeStroke,TweenInfo.new(0.2),{Color=aeEnabled and AE_COR or Color3.fromRGB(28, 50, 38)}):Play()
    ...
    if aeEnabled then
        ...
        pcall(function()
            if aeLabelState then
                ...
                TweenService:Create(aeLabelState,TweenInfo.new(0.2),{BackgroundColor3=Color3.fromRGB(30,35,50)}):Play()
            end
        end)
...
local fzStroke=Instance.new("UIStroke",freezeCard); fzStroke.Color=Color3.fromRGB(28, 50, 38); fzStroke.Thickness=1
...
fzTitleLbl.Text=T("freezeTitle"); fzTitleLbl.TextColor3=Color3.fromRGB(200, 240, 220); fzTitleLbl.TextSize=12
...
fzDescLbl.Text=T("freezeDesc"); fzDescLbl.TextColor3=Color3.fromRGB(60, 100, 80)
...
local fzPill=Instance.new("Frame",freezeCard); fzPill.BackgroundColor3=Color3.fromRGB(22, 36, 28); fzPill.BorderSizePixel=0
...
local fzKnob=Instance.new("Frame",fzPill); fzKnob.BackgroundColor3=Color3.fromRGB(80, 115, 95); fzKnob.BorderSizePixel=0
...
fzBtn.MouseButton1Click:Connect(function()
    ...
    TweenService:Create(fzPill,TweenInfo.new(0.22),{BackgroundColor3=freezeEnabled and FREEZE_COR or Color3.fromRGB(22, 36, 28)}):Play()
    TweenService:Create(fzKnob,TweenInfo.new(0.22,Enum.EasingStyle.Back,Enum.EasingDirection.Out),{
        ...
        BackgroundColor3=freezeEnabled and Color3.fromRGB(255,255,255) or Color3.fromRGB(80, 115, 95)
    }):Play()
    TweenService:Create(fzStroke,TweenInfo.new(0.2),{Color=freezeEnabled and FREEZE_COR or Color3.fromRGB(28, 50, 38)}):Play()
