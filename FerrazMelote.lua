...
_uy=_uy+_nd(_uc,_uy)
_uy=_uy+_nt(_uc,_uy,"👁 Visão Melhorada (NoFov)",false,function(en) setNoFov(en) end)
_uy=_uy+_nd(_uc,_uy)
_uy=_uy+_nt(_uc,_uy,"♾️ Pulo Infinito",false,function(en) setInfJump(en) end)
...
_camy=_camy+_nt(_camc,_camy,"🔭 Câmera X — atravessa paredes",false,function(en) setCamX(en) end)
_camy=_camy+_nd(_camc,_camy)
...
_nfSec(T("kaSecTitle"), KA_COR)
do -- Kill Aura card navy
local _kac=_nfc(fNextLO); local _kay=0
-- toggle
local kaPill, kaKnob -- referências para callback
do
    local H=44
    local tl=Instance.new("TextLabel",_kac); tl.BackgroundTransparency=1
    tl.Position=UDim2.new(0,14,0,_kay); tl.Size=UDim2.new(0.65,0,0,H)
    tl.Font=Enum.Font.GothamBold; TL(tl,"kaTitle")
    tl.TextColor3=_NT_F; tl.TextSize=11
    tl.TextXAlignment=Enum.TextXAlignment.Left; tl.TextYAlignment=Enum.TextYAlignment.Center; tl.ZIndex=6
    kaPill=Instance.new("Frame",_kac); kaPill.BorderSizePixel=0
    kaPill.AnchorPoint=Vector2.new(1,0)
    kaPill.Position=UDim2.new(1,-12,0,_kay+(H-28)/2)
    kaPill.Size=UDim2.new(0,52,0,28); kaPill.ZIndex=8
    Instance.new("UICorner",kaPill).CornerRadius=UDim.new(1,0)
    kaPill.BackgroundColor3=_OF_F
    kaKnob=Instance.new("Frame",kaPill); kaKnob.BorderSizePixel=0
    kaKnob.Size=UDim2.new(0,22,0,22); kaKnob.ZIndex=9
    Instance.new("UICorner",kaKnob).CornerRadius=UDim.new(1,0)
    kaKnob.BackgroundColor3=Color3.fromRGB(255,255,255)
    kaKnob.Position=UDim2.new(0,3,0.5,-11)
    local kaCk=Instance.new("TextLabel",kaKnob); kaCk.BackgroundTransparency=1
    kaCk.Size=UDim2.new(1,0,1,0); kaCk.Font=Enum.Font.GothamBlack
    kaCk.Text="✕"; kaCk.TextColor3=_OF_F; kaCk.TextSize=11; kaCk.ZIndex=10
    local kaStroke=Instance.new("UIStroke",kaPill); kaStroke.Transparency=1
    local kaBtnClick=Instance.new("TextButton",_kac); kaBtnClick.BackgroundTransparency=1
    kaBtnClick.Position=UDim2.new(0,0,0,_kay); kaBtnClick.Size=UDim2.new(1,0,0,H); kaBtnClick.Text=""; kaBtnClick.ZIndex=11
    kaBtnClick.MouseButton1Click:Connect(function()
        kaEnabled=not kaEnabled
        TweenService:Create(kaPill,TweenInfo.new(0.18),{BackgroundColor3=kaEnabled and _ON_F or _OF_F}):Play()
        TweenService:Create(kaKnob,TweenInfo.new(0.20,Enum.EasingStyle.Back,Enum.EasingDirection.Out),{
            Position=kaEnabled and UDim2.new(1,-25,0.5,-11) or UDim2.new(0,3,0.5,-11)
        }):Play()
        kaCk.Text=kaEnabled and "✓" or "✕"; kaCk.TextColor3=kaEnabled and _ON_F or _OF_F
        if kaEnabled then
            startKillAura()
            Notify.send({type="custom",icon="⚔️",accent=KA_COR,title="Kill Aura",msg="✓ Ativado — "..kaRange.." studs",duration=5})
        else
            stopKillAura(); Notify.error("Kill Aura","✗ Desativado")
        end
    end)
    _kay=_kay+H
end
_kay=_kay+_nfd(_kac,_kay)
-- slider alcance
local kaValLbl -- ref para o drag callback
do
    local H=50
    local tl=Instance.new("TextLabel",_kac); tl.BackgroundTransparency=1
    tl.Position=UDim2.new(0,14,0,_kay); tl.Size=UDim2.new(0.44,0,0,H)
    tl.Font=Enum.Font.GothamBold; tl.Text="Alcance"
    tl.TextColor3=_NT_F; tl.TextSize=10; tl.TextXAlignment=Enum.TextXAlignment.Left
    tl.TextYAlignment=Enum.TextYAlignment.Center; tl.ZIndex=6
    kaValLbl=Instance.new("TextLabel",_kac); kaValLbl.BackgroundTransparency=1
    kaValLbl.Position=UDim2.new(0.46,0,0,_kay+(H-16)/2); kaValLbl.Size=UDim2.new(0,28,0,16)
    kaValLbl.Font=Enum.Font.GothamBold; kaValLbl.Text=tostring(kaRange)
    kaValLbl.TextColor3=_NT_F; kaValLbl.TextSize=11; kaValLbl.ZIndex=7
    local p0=math.clamp(kaRange/125,0,1)
    local kaMiniTrack=Instance.new("Frame",_kac); kaMiniTrack.BackgroundColor3=Color3.fromRGB(20,36,80)
    kaMiniTrack.BorderSizePixel=0
    kaMiniTrack.Position=UDim2.new(0.46,32,0,_kay+H/2-2)
    kaMiniTrack.Size=UDim2.new(0.51,-46,0,4); kaMiniTrack.ZIndex=7
    ...
    kaMiniF.BorderSizePixel=0; kaMiniF.Size=UDim2.new(p0,0,1,0); kaMiniF.ZIndex=8
    Instance.new("UICorner",kaMiniF).CornerRadius=UDim.new(1,0)
    local kaMiniDot=Instance.new("Frame",kaMiniTrack); kaMiniDot.BackgroundColor3=Color3.fromRGB(25,48,105)
    kaMiniDot.BorderSizePixel=0; kaMiniDot.AnchorPoint=Vector2.new(0.5,0.5)
    kaMiniDot.Position=UDim2.new(p0,0,0.5,0); kaMiniDot.Size=UDim2.new(0,16,0,16); kaMiniDot.ZIndex=9
...
_kac.Size=UDim2.new(1,0,0,_kay)
end -- Kill Aura card navy
...
aeCard.BackgroundColor3=Color3.fromRGB(10,20,52); aeCard.BackgroundTransparency=0.28
aeCard.BorderSizePixel=0; aeCard.Size=UDim2.new(1,0,0,185); aeCard.LayoutOrder=fNextLO(); aeCard.ZIndex=5
Instance.new("UICorner",aeCard).CornerRadius=UDim.new(0,12)
aeStroke=Instance.new("UIStroke",aeCard); aeStroke.Color=Color3.fromRGB(45,75,155); aeStroke.Thickness=1; aeStroke.Transparency=0.5
aeStroke.ApplyStrokeMode=Enum.ApplyStrokeMode.Border

-- Toggle row
local aeTitleLbl=Instance.new("TextLabel",aeCard); aeTitleLbl.BackgroundTransparency=1
aeTitleLbl.Position=UDim2.new(0,14,0,0); aeTitleLbl.Size=UDim2.new(0.55,0,0,44)
aeTitleLbl.Font=Enum.Font.GothamBold; aeTitleLbl.Text="🗺️ Auto Explorar"
aeTitleLbl.TextColor3=_NT_F; aeTitleLbl.TextSize=11; aeTitleLbl.TextXAlignment=Enum.TextXAlignment.Left
aeTitleLbl.TextYAlignment=Enum.TextYAlignment.Center; aeTitleLbl.ZIndex=7
aeLabelState=Instance.new("TextLabel",aeCard); aeLabelState.BackgroundColor3=Color3.fromRGB(15,25,55)
aeLabelState.Size=UDim2.new(0,80,0,18); aeLabelState.Position=UDim2.new(0.38,0,0,13)
aeLabelState.Font=Enum.Font.GothamBold; aeLabelState.Text="AGUARDANDO"
aeLabelState.TextColor3=Color3.fromRGB(140,170,220); aeLabelState.TextSize=8
aeLabelState.TextXAlignment=Enum.TextXAlignment.Center; aeLabelState.ZIndex=7
Instance.new("UICorner",aeLabelState).CornerRadius=UDim.new(0,5)
local aeS2=Instance.new("UIStroke",aeLabelState); aeS2.Color=Color3.fromRGB(45,75,155); aeS2.Thickness=1; aeS2.Transparency=0.5

aePill=Instance.new("Frame",aeCard); aePill.BorderSizePixel=0
aePill.AnchorPoint=Vector2.new(1,0); aePill.Position=UDim2.new(1,-12,0,8)
aePill.Size=UDim2.new(0,52,0,28); aePill.ZIndex=9
Instance.new("UICorner",aePill).CornerRadius=UDim.new(1,0)
aePill.BackgroundColor3=_OF_F
aeKnob=Instance.new("Frame",aePill); aeKnob.BorderSizePixel=0
aeKnob.Size=UDim2.new(0,22,0,22); aeKnob.ZIndex=10
Instance.new("UICorner",aeKnob).CornerRadius=UDim.new(1,0)
aeKnob.BackgroundColor3=Color3.fromRGB(255,255,255); aeKnob.Position=UDim2.new(0,3,0.5,-11)
local aeCk2=Instance.new("TextLabel",aeKnob); aeCk2.BackgroundTransparency=1
aeCk2.Size=UDim2.new(1,0,1,0); aeCk2.Font=Enum.Font.GothamBlack
aeCk2.Text="✕"; aeCk2.TextColor3=_OF_F; aeCk2.TextSize=11; aeCk2.ZIndex=11

-- Div 1
local _aeD1=Instance.new("Frame",aeCard); _aeD1.BackgroundColor3=_ND_F
_aeD1.BackgroundTransparency=0.58; _aeD1.BorderSizePixel=0
_aeD1.Position=UDim2.new(0,12,0,44); _aeD1.Size=UDim2.new(1,-24,0,1); _aeD1.ZIndex=6

-- Seletor de nível
local aeLvlRow=Instance.new("Frame",aeCard); aeLvlRow.BackgroundTransparency=1
aeLvlRow.Position=UDim2.new(0,14,0,46); aeLvlRow.Size=UDim2.new(1,-28,0,22); aeLvlRow.ZIndex=6
...
aeLvlLbl.Text="Nível:"; aeLvlLbl.TextColor3=Color3.fromRGB(160,200,255); aeLvlLbl.TextSize=9
...
for bi, lbl in ipairs(aeLvlLabels) do
    ...
    btn.BackgroundColor3 = (aeLvlVals[bi]==aeManualLevel)
        and Color3.fromRGB(50,100,220) or Color3.fromRGB(14,28,64)
...
aeLevelLbl.Position=UDim2.new(0,14,0,72); aeLevelLbl.Size=UDim2.new(1,-28,0,14)
aeLevelLbl.Font=Enum.Font.GothamBold; aeLevelLbl.Text="🔥 Detectando nível da fogueira..."
aeLevelLbl.TextColor3=Color3.fromRGB(140,200,255); aeLevelLbl.TextSize=9
...
aeRadiusLbl.Position=UDim2.new(0,14,0,88); aeRadiusLbl.Size=UDim2.new(1,-28,0,12)
...
aeRadiusLbl.TextColor3=Color3.fromRGB(100,140,200); aeRadiusLbl.TextSize=8
aeRadiusLbl.TextXAlignment=Enum.TextXAlignment.Left; aeRadiusLbl.ZIndex=6

-- Linha 5: barra de progresso
local aeProgressBg = Instance.new("Frame",aeCard); aeProgressBg.BackgroundColor3=Color3.fromRGB(12,24,55)
aeProgressBg.BorderSizePixel=0; aeProgressBg.Position=UDim2.new(0,14,0,106)
...
aeTimerLabel.Position=UDim2.new(0,14,0,120); aeTimerLabel.Size=UDim2.new(1,-28,0,16)
aeTimerLabel.Font=Enum.Font.GothamBold; aeTimerLabel.Text="0:00  0%"
aeTimerLabel.TextColor3=Color3.fromRGB(140,210,255); aeTimerLabel.TextSize=9
...
aeDesc.Position=UDim2.new(0,14,0,140); aeDesc.Size=UDim2.new(1,-28,0,36)
...
aeDesc.TextColor3=Color3.fromRGB(100,140,200); aeDesc.TextSize=8; aeDesc.TextWrapped=true
aeDesc.TextXAlignment=Enum.TextXAlignment.Left; aeDesc.ZIndex=6

-- Botão invisível
local aeBtn = Instance.new("TextButton",aeCard)
aeBtn.BackgroundTransparency=1; aeBtn.Size=UDim2.new(1,0,0,44); aeBtn.Text=""; aeBtn.ZIndex=11

aeBtn.MouseButton1Click:Connect(function()
    aeEnabled = not aeEnabled
    TweenService:Create(aePill,TweenInfo.new(0.18),{BackgroundColor3=aeEnabled and _ON_F or _OF_F}):Play()
    TweenService:Create(aeKnob,TweenInfo.new(0.22,Enum.EasingStyle.Back,Enum.EasingDirection.Out),{
        Position=aeEnabled and UDim2.new(1,-25,0.5,-11) or UDim2.new(0,3,0.5,-11),
    }):Play()
    aeCk2.Text=aeEnabled and '✓' or '✕'; aeCk2.TextColor3=aeEnabled and _ON_F or _OF_F
...
-- Seção
-- Seção navy
local eatSec=Instance.new("Frame",Pages["Player"])
eatSec.BackgroundColor3=Color3.fromRGB(18,30,60); eatSec.BackgroundTransparency=0.65; eatSec.BorderSizePixel=0
...
local eatSecPill=Instance.new("Frame",eatSec); eatSecPill.BackgroundColor3=Color3.fromRGB(50,120,255); eatSecPill.BorderSizePixel=0
eatSecPill.Size=UDim2.new(0,4,0.7,0); eatSecPill.Position=UDim2.new(0,8,0.15,0); eatSecPill.ZIndex=5; Instance.new("UICorner",eatSecPill).CornerRadius=UDim.new(1,0)
local eatSecLbl=Instance.new("TextLabel",eatSec); eatSecLbl.BackgroundTransparency=1; eatSecLbl.Position=UDim2.new(0,18,0,0); eatSecLbl.Size=UDim2.new(1,-22,1,0)
eatSecLbl.Font=Enum.Font.GothamBlack; eatSecLbl.Text="🍖  AUTO COMER (FOME %)"; eatSecLbl.TextColor3=Color3.fromRGB(180,210,255); eatSecLbl.TextSize=10; eatSecLbl.TextXAlignment=Enum.TextXAlignment.Left; eatSecLbl.ZIndex=5

-- Card navy
local eatCard=Instance.new("Frame",Pages["Player"])
eatCard.BackgroundColor3=Color3.fromRGB(10,20,52); eatCard.BackgroundTransparency=0.28; eatCard.BorderSizePixel=0
eatCard.Size=UDim2.new(1,0,0,100); eatCard.LayoutOrder=plNextLO(); eatCard.ZIndex=5; Instance.new("UICorner",eatCard).CornerRadius=UDim.new(0,12)
local eatCardS=Instance.new("UIStroke",eatCard); eatCardS.Color=Color3.fromRGB(45,75,155); eatCardS.Thickness=1; eatCardS.Transparency=0.5
eatCardS.ApplyStrokeMode=Enum.ApplyStrokeMode.Border

local eatTitL=Instance.new("TextLabel",eatCard); eatTitL.BackgroundTransparency=1; eatTitL.Position=UDim2.new(0,14,0,8); eatTitL.Size=UDim2.new(0.55,0,0,18)
eatTitL.Font=Enum.Font.GothamBold; eatTitL.Text="🍖 Auto Comer"; eatTitL.TextColor3=Color3.fromRGB(200,215,245); eatTitL.TextSize=11; eatTitL.TextXAlignment=Enum.TextXAlignment.Left; eatTitL.ZIndex=7

local eatDescL=Instance.new("TextLabel",eatCard); eatDescL.BackgroundTransparency=1; eatDescL.Position=UDim2.new(0,14,0,26); eatDescL.Size=UDim2.new(0.75,0,0,16)
eatDescL.Font=Enum.Font.Gotham; eatDescL.Text="Come quando fome cair abaixo do % escolhido."; eatDescL.TextColor3=Color3.fromRGB(140,160,210); eatDescL.TextSize=9; eatDescL.TextXAlignment=Enum.TextXAlignment.Left; eatDescL.ZIndex=7
...
slRow.Position=UDim2.new(0,14,0,46); slRow.Size=UDim2.new(1,-170,0,40); slRow.ZIndex=7
...
slLbl.Font=Enum.Font.GothamBold; slLbl.Text="Limite: 25% da fome"; slLbl.TextColor3=Color3.fromRGB(180,210,255); slLbl.TextSize=10; slLbl.TextXAlignment=Enum.TextXAlignment.Left; slLbl.ZIndex=8

local slTrack=Instance.new("Frame",slRow); slTrack.BackgroundColor3=Color3.fromRGB(20,36,80); slTrack.BorderSizePixel=0
...
local slThumb=Instance.new("TextButton",slTrack); slThumb.BackgroundColor3=Color3.fromRGB(25,48,105); slThumb.BorderSizePixel=0
...
-- Status
local eatStatus=Instance.new("TextLabel",eatCard); eatStatus.BackgroundTransparency=1; eatStatus.Position=UDim2.new(0,14,0,82); eatStatus.Size=UDim2.new(1,-170,0,18)
...
-- Botão ATIVAR
local eatBtn=Instance.new("TextButton",eatCard)
eatBtn.BackgroundColor3=Color3.fromRGB(50,120,255); eatBtn.BackgroundTransparency=0.15; eatBtn.BorderSizePixel=0
eatBtn.AnchorPoint=Vector2.new(1,0); eatBtn.Position=UDim2.new(1,-10,0,8); eatBtn.Size=UDim2.new(0,110,0,34)
eatBtn.Font=Enum.Font.GothamBlack; eatBtn.Text="🍖  ATIVAR"; eatBtn.TextColor3=Color3.fromRGB(220,235,255); eatBtn.TextSize=10; eatBtn.ZIndex=8; eatBtn.AutoButtonColor=false
Instance.new("UICorner",eatBtn).CornerRadius=UDim.new(0,10)
local eatBtnS=Instance.new("UIStroke",eatBtn); eatBtnS.Color=Color3.fromRGB(80,140,255); eatBtnS.Thickness=1.2; eatBtnS.Transparency=0.4
local eatBtnG=eatBtnS -- alias para não quebrar referências

eatBtn.MouseButton1Click:Connect(function()
    if eatRunning then
        stopAutoEat(); eatBtn.Text="🍖  ATIVAR"; TweenService:Create(eatBtn,TweenInfo.new(0.15),{BackgroundColor3=Color3.fromRGB(50,120,255),BackgroundTransparency=0.15}):Play()
        eatStatus.Text="⏹ Parado"; TweenService:Create(eatCardS,TweenInfo.new(0.2),{Color=Color3.fromRGB(45,75,155)}):Play()
        Notify.error("🍖 Auto Comer","⏹ Desativado")
        task.delay(1.5,function() pcall(function() eatStatus.Text="" end) end)
    else
        eatBtn.Text="⏹  PARAR"; TweenService:Create(eatBtn,TweenInfo.new(0.15),{BackgroundColor3=Color3.fromRGB(200,50,60),BackgroundTransparency=0.1}):Play()
        TweenService:Create(eatCardS,TweenInfo.new(0.2),{Color=Color3.fromRGB(50,120,255)}):Play()
...
local function autoFeedAlways()
    ...
    afcRunning = false
    pcall(function()
        if afcRef.btn then afcRef.btn.Text="🔥  ATIVAR"; TweenService:Create(afcRef.btn,TweenInfo.new(0.15),{BackgroundColor3=Color3.fromRGB(50,120,255),BackgroundTransparency=0.15}):Play() end
...
afcCard.BackgroundColor3=Color3.fromRGB(10,20,52); afcCard.BackgroundTransparency=0.28
afcCard.BorderSizePixel=0; afcCard.Size=UDim2.new(1,0,0,94); afcCard.LayoutOrder=fNextLO(); afcCard.ZIndex=5
Instance.new("UICorner",afcCard).CornerRadius=UDim.new(0,12)
local afcCardS=Instance.new("UIStroke",afcCard)
afcCardS.Color=Color3.fromRGB(45,75,155); afcCardS.Thickness=1; afcCardS.Transparency=0.5
...
afcTit.Position=UDim2.new(0,14,0,0); afcTit.Size=UDim2.new(0.60,0,0,44)
afcTit.Font=Enum.Font.GothamBold; afcTit.Text="🔥 Auto Feed Campfire (Sempre)"
afcTit.TextColor3=_NT_F; afcTit.TextSize=11; afcTit.TextXAlignment=Enum.TextXAlignment.Left
afcTit.TextYAlignment=Enum.TextYAlignment.Center; afcTit.ZIndex=7

local afcStatus=Instance.new("TextLabel",afcCard); afcStatus.BackgroundTransparency=1
afcStatus.Position=UDim2.new(0,14,0,76); afcStatus.Size=UDim2.new(0.55,0,0,14)
afcStatus.Font=Enum.Font.GothamBold; afcStatus.Text=""
afcStatus.TextColor3=Color3.fromRGB(140,200,255); afcStatus.TextSize=9
afcStatus.TextXAlignment=Enum.TextXAlignment.Left; afcStatus.ZIndex=7
afcRef.status=afcStatus

-- Div
local _afD=Instance.new("Frame",afcCard); _afD.BackgroundColor3=_ND_F
_afD.BackgroundTransparency=0.58; _afD.BorderSizePixel=0
_afD.Position=UDim2.new(0,12,0,44); _afD.Size=UDim2.new(1,-24,0,1); _afD.ZIndex=6

-- Row 2: dropdown combustível + botão ativar
local afcSelBtn=Instance.new("TextButton",afcCard)
afcSelBtn.BackgroundColor3=Color3.fromRGB(14,28,64); afcSelBtn.BorderSizePixel=0
afcSelBtn.Position=UDim2.new(0,14,0,50); afcSelBtn.Size=UDim2.new(0,165,0,28)
afcSelBtn.Font=Enum.Font.GothamBlack; afcSelBtn.Text="Selecionar Combustível ▾"
afcSelBtn.TextColor3=Color3.fromRGB(160,210,255); afcSelBtn.TextSize=10; afcSelBtn.ZIndex=8; afcSelBtn.AutoButtonColor=false
Instance.new("UICorner",afcSelBtn).CornerRadius=UDim.new(0,8)
local afcSelBtnS=Instance.new("UIStroke",afcSelBtn)
afcSelBtnS.Color=Color3.fromRGB(60,120,220); afcSelBtnS.Thickness=1.2; afcSelBtnS.Transparency=0.4
...
afcBtn.BackgroundColor3=Color3.fromRGB(50,120,255); afcBtn.BackgroundTransparency=0.15; afcBtn.BorderSizePixel=0
afcBtn.AnchorPoint=Vector2.new(1,0); afcBtn.Position=UDim2.new(1,-10,0,50); afcBtn.Size=UDim2.new(0,110,0,28)
afcBtn.Font=Enum.Font.GothamBlack; afcBtn.Text="🔥  ATIVAR"
afcBtn.TextColor3=Color3.fromRGB(220,235,255); afcBtn.TextSize=10; afcBtn.ZIndex=8; afcBtn.AutoButtonColor=false
Instance.new("UICorner",afcBtn).CornerRadius=UDim.new(0,8)
local afcBtnS=Instance.new("UIStroke",afcBtn); afcBtnS.Color=Color3.fromRGB(80,140,255); afcBtnS.Thickness=1.2; afcBtnS.Transparency=0.4
local afcBtnG=afcBtnS -- alias para não quebrar referências
...
afcBtn.MouseButton1Click:Connect(function()
    ...
    if afcRunning then
        afcRunning = false
        TweenService:Create(afcCardS,TweenInfo.new(0.2),{Color=Color3.fromRGB(45,75,155)}):Play()
        afcStatus.Text="⏹ Parado"; Notify.error("Auto Feed Campfire","⏹ Desativado")
        afcBtn.Text="🔥  ATIVAR"; TweenService:Create(afcBtn,TweenInfo.new(0.15),{BackgroundColor3=Color3.fromRGB(50,120,255),BackgroundTransparency=0.15}):Play()
        ...
        TweenService:Create(afcCardS,TweenInfo.new(0.2),{Color=Color3.fromRGB(50,120,255),Transparency=0}):Play()
...
do
    local card=_nfc(fNextLO); card.Size=UDim2.new(1,0,0,160)
    local cardS=Instance.new("UIStroke",card); cardS.Color=Color3.fromRGB(45,75,155); cardS.Thickness=1; cardS.Transparency=0.5; cardS.ApplyStrokeMode=Enum.ApplyStrokeMode.Border
    local tit=Instance.new("TextLabel",card); tit.BackgroundTransparency=1
    tit.Position=UDim2.new(0,14,0,0); tit.Size=UDim2.new(0.55,0,0,44)
    tit.Font=Enum.Font.GothamBold; tit.Text="🔥 Auto Feed HP Based"
    tit.TextColor3=_NT_F; tit.TextSize=11; tit.TextXAlignment=Enum.TextXAlignment.Left
    tit.TextYAlignment=Enum.TextYAlignment.Center; tit.ZIndex=6
    local status=Instance.new("TextLabel",card); status.BackgroundTransparency=1
    status.Position=UDim2.new(0,14,0,132); status.Size=UDim2.new(0.65,0,0,14)
    status.Font=Enum.Font.GothamBold; status.Text=""
    status.TextColor3=Color3.fromRGB(140,200,255); status.TextSize=9
    status.TextXAlignment=Enum.TextXAlignment.Left; status.ZIndex=7
    local btn=Instance.new("TextButton",card)
    btn.BackgroundColor3=Color3.fromRGB(50,120,255); btn.BackgroundTransparency=0.15; btn.BorderSizePixel=0
    btn.AnchorPoint=Vector2.new(1,0); btn.Position=UDim2.new(1,-10,0,8); btn.Size=UDim2.new(0,110,0,30)
    btn.Font=Enum.Font.GothamBlack; btn.Text="🔥  ATIVAR"
    btn.TextColor3=Color3.fromRGB(220,235,255); btn.TextSize=10; btn.ZIndex=8; btn.AutoButtonColor=false
    Instance.new("UICorner",btn).CornerRadius=UDim.new(0,8)
    local btnS2=Instance.new("UIStroke",btn); btnS2.Color=Color3.fromRGB(80,140,255); btnS2.Thickness=1.2; btnS2.Transparency=0.4
    local btnG=btnS2
    afhpRef.status=status; afhpRef.btn=btn; afhpRef.btnG=btnG; afhpRef.stroke=cardS
    local function _updateState(on)
        btn.Text=on and "⏹  PARAR" or "🔥  ATIVAR"
        TweenService:Create(btn,TweenInfo.new(0.15),{BackgroundColor3=on and Color3.fromRGB(200,50,50) or Color3.fromRGB(50,120,255)}):Play()
    end
    -- Div
    local _d1=Instance.new("Frame",card); _d1.BackgroundColor3=_ND_F; _d1.BackgroundTransparency=0.58; _d1.BorderSizePixel=0
    _d1.Position=UDim2.new(0,12,0,44); _d1.Size=UDim2.new(1,-24,0,1); _d1.ZIndex=6
    -- Limite HP: texto + badge
    local afhpBadge=Instance.new("Frame",card); afhpBadge.BorderSizePixel=0
    afhpBadge.BackgroundColor3=Color3.fromRGB(14,28,64); afhpBadge.AnchorPoint=Vector2.new(0,0)
    afhpBadge.Position=UDim2.new(0,14,0,50); afhpBadge.Size=UDim2.new(0,52,0,22); afhpBadge.ZIndex=6
    Instance.new("UICorner",afhpBadge).CornerRadius=UDim.new(0,5)
    local afhpBadgeS=Instance.new("UIStroke",afhpBadge); afhpBadgeS.Color=Color3.fromRGB(60,120,220); afhpBadgeS.Thickness=1.2; afhpBadgeS.Transparency=0.4; afhpBadgeS.ApplyStrokeMode=Enum.ApplyStrokeMode.Border
    ...
    afhpBadgeLbl.Text=tostring(afhpThreshold).."%"; afhpBadgeLbl.TextColor3=Color3.fromRGB(160,210,255)
    ...
    tbRow.Position=UDim2.new(0,80,0,46); tbRow.Size=UDim2.new(0,200,0,28); tbRow.ZIndex=8
    ...
    tbLbl.Text="Limite:"; tbLbl.TextColor3=Color3.fromRGB(160,200,255)
    ...
    tbBox.BackgroundColor3=Color3.fromRGB(14,28,64)
    ...
    local tbBoxS=Instance.new("UIStroke",tbBox); tbBoxS.Color=Color3.fromRGB(60,120,220); tbBoxS.Thickness=1.8; tbBoxS.Transparency=0.4; tbBoxS.ApplyStrokeMode=Enum.ApplyStrokeMode.Border
    ...
    tbPct.TextColor3=Color3.fromRGB(160,210,255); tbPct.TextSize=14; tbPct.ZIndex=9
    ...
    tbConfirm.Position=UDim2.new(0,14,0,112); tbConfirm.Size=UDim2.new(0.55,0,0,16)
    tbConfirm.Font=Enum.Font.GothamBold
    tbConfirm.Text="✅ "..tostring(afhpThreshold).."%"
    ...
    afhpSelBtn.BackgroundColor3=Color3.fromRGB(14,28,64); afhpSelBtn.BorderSizePixel=0
    afhpSelBtn.Position=UDim2.new(0,14,0,78); afhpSelBtn.Size=UDim2.new(0,165,0,28)
    afhpSelBtn.Font=Enum.Font.GothamBlack; afhpSelBtn.Text=afcSelLabel()
    afhpSelBtn.TextColor3=Color3.fromRGB(160,210,255); afhpSelBtn.TextSize=10; afhpSelBtn.ZIndex=8; afhpSelBtn.AutoButtonColor=false
    Instance.new("UICorner",afhpSelBtn).CornerRadius=UDim.new(0,8)
    local afhpSelBtnS=Instance.new("UIStroke",afhpSelBtn); afhpSelBtnS.Color=Color3.fromRGB(60,120,220); afhpSelBtnS.Thickness=1.2; afhpSelBtnS.Transparency=0.4; afhpSelBtnS.ApplyStrokeMode=Enum.ApplyStrokeMode.Border
    ...
    btn.MouseButton1Click:Connect(function()
        if afhpRunning then
            afhpRunning=false; _updateState(false)
            ...
            task.spawn(function()
                autoFeedHP()
                if not afhpRunning then _updateState(false) end
            end)
        end
    end)
end
...
local function autoCookFood()
    ...
    ackRunning=false
    pcall(function()
        if ackRef.btn then ackRef.btn.Text="🍖  ATIVAR"; TweenService:Create(ackRef.btn,TweenInfo.new(0.15),{BackgroundColor3=Color3.fromRGB(50,120,255),BackgroundTransparency=0.15}):Play() end
...
do
    local card=_nfc(fNextLO); card.Size=UDim2.new(1,0,0,56)
    local cardS=Instance.new("UIStroke",card); cardS.Color=Color3.fromRGB(45,75,155); cardS.Thickness=1; cardS.Transparency=0.5; cardS.ApplyStrokeMode=Enum.ApplyStrokeMode.Border
    local tit=Instance.new("TextLabel",card); tit.BackgroundTransparency=1
    tit.Position=UDim2.new(0,14,0,0); tit.Size=UDim2.new(0.55,0,0,44)
    tit.Font=Enum.Font.GothamBold; tit.Text="🍖 Auto Cook Food"
    tit.TextColor3=_NT_F; tit.TextSize=11; tit.TextXAlignment=Enum.TextXAlignment.Left
    tit.TextYAlignment=Enum.TextYAlignment.Center; tit.ZIndex=6
    local status=Instance.new("TextLabel",card); status.BackgroundTransparency=1
    status.Position=UDim2.new(0,14,0,44); status.Size=UDim2.new(0.65,0,0,10)
    status.Font=Enum.Font.GothamBold; status.Text=""
    status.TextColor3=Color3.fromRGB(140,200,255); status.TextSize=8; status.TextXAlignment=Enum.TextXAlignment.Left; status.ZIndex=7
    local btn=Instance.new("TextButton",card)
    btn.BackgroundColor3=Color3.fromRGB(50,120,255); btn.BackgroundTransparency=0.15; btn.BorderSizePixel=0
    btn.AnchorPoint=Vector2.new(1,0); btn.Position=UDim2.new(1,-10,0,8); btn.Size=UDim2.new(0,110,0,30)
    btn.Font=Enum.Font.GothamBlack; btn.Text="🍖  ATIVAR"
    ...
    btn.MouseButton1Click:Connect(function()
        if ackRunning then
            ackRunning=false; _updateState(false)
            ...
            task.spawn(function()
                autoCookFood()
                if not ackRunning then _updateState(false) end
            end)
        end
    end)
end
...
local function autoMachineGrind()
    ...
    amgRunning=false
    pcall(function()
        if amgRef.btn then amgRef.btn.Text="⚙️  ATIVAR"; TweenService:Create(amgRef.btn,TweenInfo.new(0.15),{BackgroundColor3=Color3.fromRGB(50,120,255),BackgroundTransparency=0.15}):Play() end
...
local amgCard=_nfc(fNextLO); amgCard.Size=UDim2.new(1,0,0,94)
local amgCardS=Instance.new("UIStroke",amgCard); amgCardS.Color=Color3.fromRGB(45,75,155); amgCardS.Thickness=1; amgCardS.Transparency=0.5; amgCardS.ApplyStrokeMode=Enum.ApplyStrokeMode.Border
amgRef.stroke=amgCardS
local amgTit=Instance.new("TextLabel",amgCard); amgTit.BackgroundTransparency=1
amgTit.Position=UDim2.new(0,14,0,0); amgTit.Size=UDim2.new(0.55,0,0,44)
amgTit.Font=Enum.Font.GothamBold; amgTit.Text="⚙️ Auto Machine Grind"
amgTit.TextColor3=_NT_F; amgTit.TextSize=11; amgTit.TextXAlignment=Enum.TextXAlignment.Left
amgTit.TextYAlignment=Enum.TextYAlignment.Center; amgTit.ZIndex=6
local amgStatus=Instance.new("TextLabel",amgCard); amgStatus.BackgroundTransparency=1
amgStatus.Position=UDim2.new(0,14,0,78); amgStatus.Size=UDim2.new(0.65,0,0,12)
amgStatus.Font=Enum.Font.GothamBold; amgStatus.Text=""
amgStatus.TextColor3=Color3.fromRGB(140,200,255); amgStatus.TextSize=8; amgStatus.TextXAlignment=Enum.TextXAlignment.Left; amgStatus.ZIndex=7
amgRef.status=amgStatus
-- div
local _amgD=Instance.new("Frame",amgCard); _amgD.BackgroundColor3=_ND_F; _amgD.BackgroundTransparency=0.58; _amgD.BorderSizePixel=0
_amgD.Position=UDim2.new(0,12,0,44); _amgD.Size=UDim2.new(1,-24,0,1); _amgD.ZIndex=6
-- Selecionar Itens + Ativar
local amgSelBtn=Instance.new("TextButton",amgCard)
amgSelBtn.BackgroundColor3=Color3.fromRGB(14,28,64); amgSelBtn.BorderSizePixel=0
amgSelBtn.Position=UDim2.new(0,14,0,50); amgSelBtn.Size=UDim2.new(0,148,0,28)
amgSelBtn.Font=Enum.Font.GothamBlack; amgSelBtn.Text="Selecionar Itens ▾"
amgSelBtn.TextColor3=Color3.fromRGB(160,210,255); amgSelBtn.TextSize=10; amgSelBtn.ZIndex=8; amgSelBtn.AutoButtonColor=false
Instance.new("UICorner",amgSelBtn).CornerRadius=UDim.new(0,8)
local amgSelBtnS=Instance.new("UIStroke",amgSelBtn); amgSelBtnS.Color=Color3.fromRGB(60,120,220); amgSelBtnS.Thickness=1.2; amgSelBtnS.Transparency=0.4; amgSelBtnS.ApplyStrokeMode=Enum.ApplyStrokeMode.Border
amgRef.selBtn=amgSelBtn; amgRef.selBtnS=amgSelBtnS
local amgBtn=Instance.new("TextButton",amgCard)
amgBtn.BackgroundColor3=Color3.fromRGB(50,120,255); amgBtn.BackgroundTransparency=0.15; amgBtn.BorderSizePixel=0
amgBtn.AnchorPoint=Vector2.new(1,0); amgBtn.Position=UDim2.new(1,-10,0,50); amgBtn.Size=UDim2.new(0,110,0,28)
amgBtn.Font=Enum.Font.GothamBlack; amgBtn.Text="⚙️  ATIVAR"
amgBtn.TextColor3=Color3.fromRGB(220,235,255); amgBtn.TextSize=10; amgBtn.ZIndex=8; amgBtn.AutoButtonColor=false
Instance.new("UICorner",amgBtn).CornerRadius=UDim.new(0,8)
local amgBtnS=Instance.new("UIStroke",amgBtn); amgBtnS.Color=Color3.fromRGB(80,140,255); amgBtnS.Thickness=1.2; amgBtnS.Transparency=0.4
local amgBtnG=amgBtnS
...
amgBtn.MouseButton1Click:Connect(function()
    ...
    if amgRunning then
        ...
        TweenService:Create(amgCardS,TweenInfo.new(0.2),{Color=Color3.fromRGB(50,120,255),Transparency=0}):Play()
...
local function autoBiofuel()
    ...
    pcall(function()
        if abfRef.btn then abfRef.btn.Text="🧪  ATIVAR"; TweenService:Create(abfRef.btn,TweenInfo.new(0.15),{BackgroundColor3=Color3.fromRGB(50,120,255),BackgroundTransparency=0.15}):Play() end
...
do
    ...
    local tit=Instance.new("TextLabel",card); tit.BackgroundTransparency=1
    tit.Position=UDim2.new(0,14,0,0); tit.Size=UDim2.new(0.55,0,0,44)
    tit.Font=Enum.Font.GothamBold; tit.Text="🧪 Auto Biofuel Processor"
    tit.TextColor3=_NT_F; tit.TextSize=11; tit.TextXAlignment=Enum.TextXAlignment.Left
    tit.TextYAlignment=Enum.TextYAlignment.Center; tit.ZIndex=6
    local status=Instance.new("TextLabel",card); status.BackgroundTransparency=1
    status.Position=UDim2.new(0,14,0,44); status.Size=UDim2.new(0.65,0,0,10)
    ...
    btn.MouseButton1Click:Connect(function()
        if abfRunning then
            abfRunning=false; _updateState(false)
            ...
            task.spawn(function()
                autoBiofuel()
                if not abfRunning then _updateState(false) end
            end)
        end
    end)
end
...
local fbcCard=_nfc(fNextLO); fbcCard.Size=UDim2.new(1,0,0,94)
local fbcStroke=Instance.new("UIStroke",fbcCard); fbcStroke.Color=Color3.fromRGB(45,75,155); fbcStroke.Thickness=1; fbcStroke.Transparency=0.5; fbcStroke.ApplyStrokeMode=Enum.ApplyStrokeMode.Border
local fbcTitLbl=Instance.new("TextLabel",fbcCard); fbcTitLbl.BackgroundTransparency=1
fbcTitLbl.Position=UDim2.new(0,14,0,0); fbcTitLbl.Size=UDim2.new(0.55,0,0,44)
fbcTitLbl.Font=Enum.Font.GothamBold; fbcTitLbl.Text="🎁 Farm Baús"
fbcTitLbl.TextColor3=_NT_F; fbcTitLbl.TextSize=11; fbcTitLbl.TextXAlignment=Enum.TextXAlignment.Left
fbcTitLbl.TextYAlignment=Enum.TextYAlignment.Center; fbcTitLbl.ZIndex=7
local fbcStatus=Instance.new("TextLabel",fbcCard); fbcStatus.BackgroundTransparency=1
fbcStatus.Position=UDim2.new(0,14,0,78); fbcStatus.Size=UDim2.new(0.65,0,0,12)
fbcStatus.Font=Enum.Font.GothamBold; fbcStatus.Text="Aguardando..."
fbcStatus.TextColor3=Color3.fromRGB(140,200,255); fbcStatus.TextSize=8; fbcStatus.TextXAlignment=Enum.TextXAlignment.Left; fbcStatus.ZIndex=7
-- div
local _fbcD=Instance.new("Frame",fbcCard); _fbcD.BackgroundColor3=_ND_F; _fbcD.BackgroundTransparency=0.58; _fbcD.BorderSizePixel=0
_fbcD.Position=UDim2.new(0,12,0,44); _fbcD.Size=UDim2.new(1,-24,0,1); _fbcD.ZIndex=6
...
local fbcModeBtn=Instance.new("TextButton",fbcCard)
fbcModeBtn.BackgroundColor3=Color3.fromRGB(14,28,64); fbcModeBtn.BackgroundTransparency=0; fbcModeBtn.BorderSizePixel=0
fbcModeBtn.Position=UDim2.new(0,14,0,50); fbcModeBtn.Size=UDim2.new(0,105,0,28)
fbcModeBtn.Font=Enum.Font.GothamBold; fbcModeBtn.Text="🧍 Jogador"
fbcModeBtn.TextColor3=Color3.fromRGB(160,210,255); fbcModeBtn.TextSize=9; fbcModeBtn.ZIndex=8; fbcModeBtn.AutoButtonColor=false
Instance.new("UICorner",fbcModeBtn).CornerRadius=UDim.new(0,8)
local fbcModeBtnS=Instance.new("UIStroke",fbcModeBtn); fbcModeBtnS.Color=Color3.fromRGB(60,120,220); fbcModeBtnS.Thickness=1.2; fbcModeBtnS.Transparency=0.4
...
local fbcStartBtn=Instance.new("TextButton",fbcCard)
fbcStartBtn.BackgroundColor3=Color3.fromRGB(50,120,255); fbcStartBtn.BackgroundTransparency=0.15
...
local function fbcRun()
    ...
    fbcStroke.Color=Color3.fromRGB(50,120,255); fbcStroke.Transparency=0.3
    ...
    if total == 0 then
        ...
        TweenService:Create(fbcStartBtn,TweenInfo.new(0.3),{BackgroundColor3=Color3.fromRGB(50,120,255),BackgroundTransparency=0.15}):Play()
