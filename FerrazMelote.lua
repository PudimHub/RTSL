...
local function _PudimSplashGate()
    ...
    SPLASH.Size              = UDim2.new(0,0,0,0) -- criado por tween
    ...
    SUB.TextColor3       = Color3.fromRGB(210,225,255)
    ...
    SPLASH.Position = UDim2.new(0.5,0,-0.8,0)
    ...
    task.delay(5.0, function()
        ...
        task.delay(0.55, function()
            ...
            CARDG.Color = ColorSequence.new({
                ...
                ColorSequenceKeypoint.new(0.5,Color3.fromRGB(20,12,38)),
            ...
            SIDEB.BackgroundColor3 = Color3.fromRGB(180,80,255)
            ...
            BADGE.BackgroundColor3 = Color3.fromRGB(88,101,242)
            ...
            CGAME.TextColor3       = Color3.fromRGB(160,210,255)
            ...
            CVER.TextColor3        = Color3.fromRGB(120,100,170)
            ...
            CUPD.TextColor3        = Color3.fromRGB(130,130,165)
            ...
            local function _doLaunch()
                ...
                CBTN.BackgroundColor3 = Color3.fromRGB(88,101,242)
...
local NOTIF_TIPOS = {
    success     = { title="Sucesso",    accent=Color3.fromRGB(87,242,135),  icon="✓", bg=Color3.fromRGB(8,22,16),  sound=5928788253 },
    error       = { title="Erro",       accent=Color3.fromRGB(255,75,75),   icon="✕", bg=Color3.fromRGB(22,8,8),  sound=9119713951 },
    warn        = { title="Aviso",      accent=Color3.fromRGB(255,200,50),  icon="⚠", bg=Color3.fromRGB(20,16,6),  sound=5989740700 },
    info        = { title="Info",       accent=Color3.fromRGB(88,150,255),  icon="ℹ", bg=Color3.fromRGB(8,10,24),  sound=5989740700 },
    achievement = { title="Conquista!", accent=Color3.fromRGB(255,210,60),  icon="★", bg=Color3.fromRGB(18,14,4),  sound=6042053626 },
    custom      = { title="Aviso",      accent=Color3.fromRGB(88,101,242),  icon="◆", bg=Color3.fromRGB(10,8,22),  sound=5989740700 },
}
...
NHistHeader.BackgroundColor3=Color3.fromRGB(18,10,36); NHistHeader.BorderSizePixel=0
...
NEmptyLbl.TextColor3=Color3.fromRGB(100,70,140); NEmptyLbl.TextSize=11
...
MainFrame.BackgroundColor3 = Color3.fromRGB(14, 9, 28)
...
MainStroke.Color = Color3.fromRGB(252, 198, 0); MainStroke.Thickness = 3.5

-- Gradiente sutil no fundo do MainFrame
local MainGrad = Instance.new("UIGradient", MainFrame)
MainGrad.Color = ColorSequence.new({
    ColorSequenceKeypoint.new(0,  Color3.fromRGB(40, 22, 72)),
    ColorSequenceKeypoint.new(0.5,Color3.fromRGB(18, 10, 36)),
    ColorSequenceKeypoint.new(1,  Color3.fromRGB(10,  6, 20)),
})
...
TopBarStroke.Thickness = 0  -- só visual interno, sem borda extra aqui
...
SideBar.Name = "SideBar"; SideBar.BackgroundColor3 = Color3.fromRGB(20, 11, 38)
SideBar.Position = UDim2.new(0,0,0,44); SideBar.Size = UDim2.new(0,175,1,-82)
...
Divider.Position = UDim2.new(0,175,0,44); Divider.Size = UDim2.new(0,2,1,-44); Divider.ZIndex = 3

-- ══════════════════════════════════════════════════════
--  CONTENT AREA — PudimHub Dark
-- ══════════════════════════════════════════════════════
local ContentArea = Instance.new("Frame", MainFrame)
ContentArea.Name = "ContentArea"; ContentArea.BackgroundColor3 = Color3.fromRGB(22, 14, 42)
ContentArea.Position = UDim2.new(0,177,0,44); ContentArea.Size = UDim2.new(1,-177,1,-44)
...
Footer.BackgroundColor3 = Color3.fromRGB(12, 7, 22); Footer.BorderSizePixel = 0
...
FTag.Text = "@"..Player.Name; FTag.TextColor3 = Color3.fromRGB(100,80,140)
...
local C_TEXT_OFF = Color3.fromRGB(140, 110, 180)      -- muted purple
local C_TEXT_ON  = Color3.fromRGB(255, 220, 50)       -- bright gold
local C_BG_HOV   = Color3.fromRGB(40, 24, 72)         -- hover: dark purple
local C_BG_ACT   = Color3.fromRGB(60, 36, 100)        -- active: purple
local C_ICON_IDLE   = Color3.fromRGB(110, 80, 155)    -- idle icon
...
local function createTabIcon(parent,key)
    ...
    local ibg = Color3.fromRGB(20,11,38)  -- dark purple bg for icon cutouts
...
local function makeGroupLabel(text, trKey, groupTabs)
    ...
    if layoutOrder>1 then
        ...
        line.BackgroundColor3=Color3.fromRGB(252,198,0)
        line.BackgroundTransparency=0.82
        line.BorderSizePixel=0; line.Size=UDim2.new(0.85,0,0,1)
        line.LayoutOrder=layoutOrder*100
        -- center the line
        local lpad=Instance.new("UIPadding",line)
        lpad.PaddingLeft=UDim.new(0.075,0)
    end
    layoutOrder+=1
    local header=Instance.new("TextButton",SideBar); header.BackgroundTransparency=1
    header.Size=UDim2.new(1,0,0,26); header.Text=""; header.LayoutOrder=layoutOrder*100; header.ZIndex=4
    -- background pill dourado
    local hbg=Instance.new("Frame",header)
    hbg.BackgroundColor3=Color3.fromRGB(252,198,0)
    hbg.BackgroundTransparency=0.88
    hbg.BorderSizePixel=0; hbg.Position=UDim2.new(0,0,0,3)
    hbg.Size=UDim2.new(1,0,0,20); hbg.ZIndex=3
    Instance.new("UICorner",hbg).CornerRadius=UDim.new(0,5)
    local hl=Instance.new("TextLabel",header); hl.BackgroundTransparency=1
    hl.Position=UDim2.new(0,8,0,3); hl.Size=UDim2.new(1,-28,1,-6); hl.Font=Enum.Font.GothamBlack
    hl.Text=text; hl.TextColor3=Color3.fromRGB(252,198,0); hl.TextSize=9
    ...
    af.Position=UDim2.new(1,-20,0.5,-7); af.Size=UDim2.new(0,14,0,14); af.ZIndex=5
    ...
    arrow.ImageColor3=Color3.fromRGB(252,198,0); arrow.ScaleType=Enum.ScaleType.Fit; arrow.Rotation=0; arrow.ZIndex=6
    local isOpen=true
...
BoostPopup.BackgroundColor3=Color3.fromRGB(18,10,36); BoostPopup.Size=UDim2.new(0,190,0,0)
...
local bpStroke=Instance.new("UIStroke",BoostPopup); bpStroke.Color=C_ACCENT; bpStroke.Thickness=2
...
local function makePopupToggle(text,callback)
    local row=Instance.new("Frame",BoostPopup); row.BackgroundColor3=Color3.fromRGB(22,12,42)
    ...
    lbl.Text=text; lbl.TextColor3=Color3.fromRGB(220,190,255); lbl.TextSize=10
    ...
    local knob=Instance.new("Frame",pill); knob.BackgroundColor3=Color3.fromRGB(110,70,155); knob.BorderSizePixel=0
...
infoCard.BackgroundColor3=Color3.fromRGB(14,8,28); infoCard.BorderSizePixel=0
...
infoGreenRing.BackgroundColor3=Color3.fromRGB(14,8,28); infoGreenRing.BorderSizePixel=0
...
infoTag.Text="@"..Player.Name; infoTag.TextColor3=Color3.fromRGB(110,80,150)
...
infoStatus.BackgroundColor3=Color3.fromRGB(30,16,55); infoStatus.BorderSizePixel=0
...
infoStatusSub.TextColor3=Color3.fromRGB(110,80,150); infoStatusSub.TextSize=9
...
infoLangRow.BackgroundColor3 = Color3.fromRGB(28,14,52)
...
infoLangKeyLbl.Text="Idioma:"; infoLangKeyLbl.TextColor3=Color3.fromRGB(140,110,180)
...
notifToggleRow.BackgroundColor3   = Color3.fromRGB(20,12,38)
...
ntTitle.Text="Notifications"; ntTitle.TextColor3=Color3.fromRGB(240,220,255)
...
ntDesc.Text="Enables/disables all hub notifications"; ntDesc.TextColor3=Color3.fromRGB(110,80,155)
...
ntBtn.MouseButton1Click:Connect(function()
    ...
    local offColor  = Color3.fromRGB(35,20,60)
    ...
    TweenService:Create(ntStroke,TweenInfo.new(0.2),{
        Color = notifEnabled and onColor or Color3.fromRGB(80,50,120),
        Transparency = notifEnabled and 0.45 or 0.72
    }):Play()
    TweenService:Create(ntStatusLbl,TweenInfo.new(0.15),{
        TextColor3 = notifEnabled and onColor or Color3.fromRGB(100,80,130)
    }):Play()
...
histHeaderFix.BackgroundColor3=Color3.fromRGB(18,10,36); histHeaderFix.BorderSizePixel=0
...
dadosHeader.BackgroundColor3=Color3.fromRGB(14,8,26); dadosHeader.BorderSizePixel=0
...
dadosTitleLbl.Text="Dice"; dadosTitleLbl.TextColor3=Color3.fromRGB(200,160,255)
...
dadosText.TextColor3=Color3.fromRGB(150,120,190); dadosText.TextSize=9
...
lhTitleLbl.TextColor3=Color3.fromRGB(240,220,255); lhTitleLbl.TextSize=12
...
for idx, lang in ipairs(LANGUAGES) do
    ...
    lBtn.BackgroundColor3=isSelected and Color3.fromRGB(252,198,0) or Color3.fromRGB(18,10,35)
    ...
    lbName.Text=lang.name; lbName.TextColor3=isSelected and Color3.fromRGB(20,10,0) or Color3.fromRGB(190,160,230)
    ...
    lBtn.MouseLeave:Connect(function()
        if lang.code~=currentLang.code then
            TweenService:Create(lBtn,TweenInfo.new(0.1),{BackgroundColor3=Color3.fromRGB(18,10,35),BackgroundTransparency=0.15}):Play()
        end
    end)
...
srvCard.BackgroundColor3=Color3.fromRGB(14,8,26); srvCard.BorderSizePixel=0
...
-- TextBox de ID
local srvBoxBg=Instance.new("Frame",srvCard); srvBoxBg.BackgroundColor3=Color3.fromRGB(25,12,48)
...
local function mkStatCard(parent, h, lo)
    local c=Instance.new("Frame",parent); c.BackgroundColor3=Color3.fromRGB(14,8,28)
...
mkLabel(fpsPingCard,UDim2.new(0,48,0,10),UDim2.new(0.42,0,0,14),"FPS",Enum.Font.GothamBold,9,Color3.fromRGB(140,110,180))
...
local fpsBarBg=Instance.new("Frame",fpsPingCard); fpsBarBg.BackgroundColor3=Color3.fromRGB(30,15,55)
...
local fpsDescLbl=mkLabel(fpsPingCard,UDim2.new(0,48,0,62),UDim2.new(0.42,-58,0,12),"Frames por segundo",Enum.Font.Gotham,8,Color3.fromRGB(110,80,150))
...
local pingBarBg=Instance.new("Frame",fpsPingCard); pingBarBg.BackgroundColor3=Color3.fromRGB(30,15,55)
...
local timeTzLbl=mkLabel(timeCard,UDim2.new(0,46,0,40),UDim2.new(0.44,0,0,12),"detectando fuso...",Enum.Font.Gotham,8,Color3.fromRGB(110,80,150))
...
local function refreshPlayerList()
    ...
    for i,plr in ipairs(allPlrs) do
        if not plrRows[plr.UserId] then
            ...
            row.BackgroundColor3=Color3.fromRGB(22,12,42); row.BackgroundTransparency=0.2
...
local memBarBg=Instance.new("Frame",extrasCard); memBarBg.BackgroundColor3=Color3.fromRGB(25,12,48)
...
local function makeEspRow(cat)
    local row=Instance.new("Frame",Pages["Esp"]); row.BackgroundColor3=Color3.fromRGB(16,9,30)
    row.BorderSizePixel=0; row.Size=UDim2.new(1,0,0,54); row.LayoutOrder=espLO(); row.ZIndex=5
    Instance.new("UICorner",row).CornerRadius=UDim.new(0,8)
    local rowStroke=Instance.new("UIStroke",row); rowStroke.Color=Color3.fromRGB(252,198,0); rowStroke.Thickness=1; rowStroke.Transparency=0.82
    local iconContainer=Instance.new("Frame",row); iconContainer.BackgroundColor3=Color3.fromRGB(28,14,52)
    ...
    labelNome.Font=Enum.Font.GothamBold; labelNome.Text=cat.label; labelNome.TextColor3=Color3.fromRGB(230,210,255)
    ...
    labelDesc.Font=Enum.Font.Gotham; labelDesc.Text=cat.desc or ""; labelDesc.TextColor3=Color3.fromRGB(110,80,150)
    ...
    local pill=Instance.new("Frame",row); pill.BackgroundColor3=Color3.fromRGB(30,16,55); pill.BorderSizePixel=0
    pill.Position=UDim2.new(1,-52,0.5,-11); pill.Size=UDim2.new(0,42,0,22); pill.ZIndex=7
    Instance.new("UICorner",pill).CornerRadius=UDim.new(1,0)
    local knob=Instance.new("Frame",pill); knob.BackgroundColor3=Color3.fromRGB(100,60,150); knob.BorderSizePixel=0
    ...
    btn.MouseEnter:Connect(function() if currentTab~=cat.key then TweenService:Create(row,TweenInfo.new(0.12),{BackgroundColor3=Color3.fromRGB(26,14,48)}):Play() end end)
    btn.MouseLeave:Connect(function() TweenService:Create(row,TweenInfo.new(0.12),{BackgroundColor3=Color3.fromRGB(16,9,30)}):Play() end)
    btn.MouseButton1Click:Connect(function()
        state=not state; espAtivo[cat.key]=state; lastCache=0
        TweenService:Create(pill,TweenInfo.new(0.22,Enum.EasingStyle.Quad),{BackgroundColor3=state and cat.cor or Color3.fromRGB(30,16,55)}):Play()
        TweenService:Create(knob,TweenInfo.new(0.22,Enum.EasingStyle.Back,Enum.EasingDirection.Out),{
            Position=state and UDim2.new(1,-20,0.5,-9) or UDim2.new(0,2,0.5,-9),
            BackgroundColor3=state and Color3.fromRGB(255,255,255) or Color3.fromRGB(100,60,150),
        }):Play()
...
local function makeBringRow(bcat)
    local row=Instance.new("Frame",Pages["Bring"]); row.BackgroundColor3=Color3.fromRGB(14,8,26)
    ...
    labelNome.Font=Enum.Font.GothamBold; labelNome.Text=bcat.label; labelNome.TextColor3=Color3.fromRGB(235,215,255)
    ...
    labelDesc.Font=Enum.Font.Gotham; labelDesc.Text=bcat.desc or ""; labelDesc.TextColor3=Color3.fromRGB(110,80,150)
    ...
    -- Botão LIMPAR
    local btnLimpar=Instance.new("TextButton",row); btnLimpar.BackgroundColor3=Color3.fromRGB(35,18,60); btnLimpar.BackgroundTransparency=0.1
    btnLimpar.BorderSizePixel=0; btnLimpar.Position=UDim2.new(1,-90,0,42); btnLimpar.Size=UDim2.new(0,82,0,24)
    btnLimpar.Font=Enum.Font.GothamBold; btnLimpar.Text="🗑 Limpar"; btnLimpar.TextColor3=Color3.fromRGB(180,150,220)
    btnLimpar.TextSize=9; btnLimpar.ZIndex=9
    Instance.new("UICorner",btnLimpar).CornerRadius=UDim.new(0,7)
    local limparStroke=Instance.new("UIStroke",btnLimpar); limparStroke.Color=Color3.fromRGB(150,100,200); limparStroke.Thickness=1; limparStroke.Transparency=0.5
    btnLimpar.MouseEnter:Connect(function() TweenService:Create(btnLimpar,TweenInfo.new(0.12),{BackgroundColor3=Color3.fromRGB(180,50,50),BackgroundTransparency=0}):Play() end)
    btnLimpar.MouseLeave:Connect(function() TweenService:Create(btnLimpar,TweenInfo.new(0.12),{BackgroundColor3=Color3.fromRGB(35,18,60),BackgroundTransparency=0.1}):Play() end)
...
do
    ...
    baCard.BackgroundColor3=Color3.fromRGB(14,8,28); baCard.BorderSizePixel=0
    ...
    baDescLbl.TextColor3=Color3.fromRGB(110,80,150); baDescLbl.TextSize=9
    ...
    -- Barra de progresso
    local baProgBg=Instance.new("Frame",baCard); baProgBg.BackgroundColor3=Color3.fromRGB(30,16,55)
...
local function makePlToggle(lbl_txt, desc_txt, cor, onToggle)
    local row=Instance.new("Frame",Pages["Player"]); row.BackgroundColor3=Color3.fromRGB(14,8,26)
    row.BorderSizePixel=0; row.Size=UDim2.new(1,0,0,56); row.LayoutOrder=plNextLO(); row.ZIndex=5
    Instance.new("UICorner",row).CornerRadius=UDim.new(0,9)
    local rowS=Instance.new("UIStroke",row); rowS.Color=Color3.fromRGB(252,198,0); rowS.Thickness=1; rowS.Transparency=0.82
    ...
    tl.Text=lbl_txt; tl.TextColor3=Color3.fromRGB(240,220,255); tl.TextSize=12; tl.TextXAlignment=Enum.TextXAlignment.Left; tl.ZIndex=7
    ...
    td.Text=desc_txt; td.TextColor3=Color3.fromRGB(110,80,150); td.TextSize=9
    ...
    btn.MouseButton1Click:Connect(function()
        state=not state
        TweenService:Create(pill,TweenInfo.new(0.22,Enum.EasingStyle.Quad),{BackgroundColor3=state and cor or Color3.fromRGB(30,16,55)}):Play()
        TweenService:Create(knob,TweenInfo.new(0.22,Enum.EasingStyle.Back,Enum.EasingDirection.Out),{
...
local function makeSliderBar(parentPage, lbl_txt, desc_txt, cor, minV, maxV, initVal, onChange)
    ...
    row.BackgroundColor3 = Color3.fromRGB(14,8,26); row.BorderSizePixel = 0
    ...
    td.Text=desc_txt; td.TextColor3=Color3.fromRGB(110,80,150); td.TextSize=9; td.TextXAlignment=Enum.TextXAlignment.Left; td.ZIndex=7
    local trackBg = Instance.new("Frame", row); trackBg.BackgroundColor3=Color3.fromRGB(30,14,55)
...
ibcPill.BackgroundColor3 = Color3.fromRGB(45,50,62); ibcPill.BorderSizePixel = 0
...
ibcBtn.MouseButton1Click:Connect(function()
    ...
    TweenService:Create(ibcPill,TweenInfo.new(0.22),{
        BackgroundColor3 = ibcEnabled and IBC_COR or Color3.fromRGB(45,50,62)
    }):Play()
...
local function bpGetOrCreateGroup(key, name, icon, color)
    ...
    hitBtn.MouseEnter:Connect(function()
        TweenService:Create(btn,TweenInfo.new(0.12),{BackgroundColor3=Color3.fromRGB(55,35,90)}):Play()
    ...
    hitBtn.MouseLeave:Connect(function()
        TweenService:Create(btn,TweenInfo.new(0.12),{BackgroundColor3=Color3.fromRGB(18,10,35)}):Play()
...
local function bpAddEntryToGroup(grp, name, pos, biomeLabel, biomeIcon)
    ...
    nameLbl.TextColor3 = wasVisited and Color3.fromRGB(200,130,130) or Color3.fromRGB(220,225,255)
    ...
    rowHit.MouseEnter:Connect(function()
        if not entry.visited then
            TweenService:Create(row,TweenInfo.new(0.1),{BackgroundColor3=Color3.fromRGB(28,14,52)}):Play()
        end
    end)
    rowHit.MouseLeave:Connect(function()
        if not entry.visited then
            TweenService:Create(row,TweenInfo.new(0.1),{BackgroundColor3=Color3.fromRGB(14,8,30)}):Play()
        end
    end)
...
local function cpGetOrCreateGroup(rarity)
    ...
    hitBtn.Size = UDim2.new(1,0,1,0); hitBtn.Text = ""; hitBtn.ZIndex = 10
    hitBtn.MouseEnter:Connect(function()
        TweenService:Create(btn,TweenInfo.new(0.12),{BackgroundColor3=Color3.fromRGB(50,36,10)}):Play()
        TweenService:Create(btnS,TweenInfo.new(0.12),{Transparency=0}):Play()
    end)
    hitBtn.MouseLeave:Connect(function()
...
local function cpAddEntry(grp, name, pos, biomeLabel, biomeIcon)
    ...
    rowHit.Size = UDim2.new(1,-50,1,0); rowHit.Text = ""; rowHit.ZIndex = 9
    rowHit.MouseButton1Click:Connect(doTp)
    rowHit.MouseEnter:Connect(function() if not entry.visited then TweenService:Create(row,TweenInfo.new(0.1),{BackgroundColor3=Color3.fromRGB(36,22,8)}):Play() end end)
    rowHit.MouseLeave:Connect(function() if not entry.visited then TweenService:Create(row,TweenInfo.new(0.1),{BackgroundColor3=Color3.fromRGB(22,12,6)}):Play() end end)
    return entry
end
...
makeSec = function(page, lo_fn, titleKey, cor)
    ...
    hdr.BackgroundColor3=Color3.fromRGB(252,198,0)
    hdr.BackgroundTransparency=0.88
    hdr.BorderSizePixel=0; hdr.Size=UDim2.new(1,0,0,24); hdr.LayoutOrder=lo_fn(); hdr.ZIndex=4
    Instance.new("UICorner",hdr).CornerRadius=UDim.new(0,7)
    -- Barra colorida lateral
    local bar=Instance.new("Frame",hdr); bar.BackgroundColor3=cor; bar.BorderSizePixel=0
    bar.Size=UDim2.new(0,4,1,-8); bar.Position=UDim2.new(0,0,0,4); bar.ZIndex=5
    Instance.new("UICorner",bar).CornerRadius=UDim.new(0,3)
...
local function makeToggle(page, lo_fn, lbl_txt, desc_txt, cor, onToggle)
    ...
    row.BackgroundColor3=Color3.fromRGB(20,12,38); row.BorderSizePixel=0
    row.Size=UDim2.new(1,0,0,62); row.LayoutOrder=lo_fn(); row.ZIndex=5
    Instance.new("UICorner",row).CornerRadius=UDim.new(0,10)
    local rowS=Instance.new("UIStroke",row)
    rowS.Color=Color3.fromRGB(252,198,0); rowS.Thickness=1; rowS.Transparency=0.82
    -- Barra colorida lateral esquerda
    local lbar=Instance.new("Frame",row)
    lbar.BackgroundColor3=cor; lbar.BorderSizePixel=0
    lbar.Size=UDim2.new(0,3,0.7,0); lbar.Position=UDim2.new(0,0,0.15,0); lbar.ZIndex=6
    Instance.new("UICorner",lbar).CornerRadius=UDim.new(0,3)
    local tl=Instance.new("TextLabel",row); tl.BackgroundTransparency=1
    tl.Position=UDim2.new(0,16,0,10); tl.Size=UDim2.new(1,-80,0,18); tl.Font=Enum.Font.GothamBold
    tl.Text=lbl_txt; tl.TextColor3=Color3.fromRGB(240,220,255); tl.TextSize=12
    tl.TextXAlignment=Enum.TextXAlignment.Left; tl.ZIndex=7
    local td=Instance.new("TextLabel",row); td.BackgroundTransparency=1
    td.Position=UDim2.new(0,16,0,30); td.Size=UDim2.new(1,-80,0,26); td.Font=Enum.Font.Gotham
    td.Text=desc_txt; td.TextColor3=Color3.fromRGB(110,80,155); td.TextSize=9
    td.TextXAlignment=Enum.TextXAlignment.Left; td.TextWrapped=true; td.ZIndex=7
    -- Pill toggle
    local pill=Instance.new("Frame",row)
    pill.BackgroundColor3=Color3.fromRGB(35,20,60); pill.BorderSizePixel=0
    pill.Position=UDim2.new(1,-56,0.5,-13); pill.Size=UDim2.new(0,48,0,26); pill.ZIndex=9
    Instance.new("UICorner",pill).CornerRadius=UDim.new(1,0)
    local pillS=Instance.new("UIStroke",pill)
    pillS.Color=Color3.fromRGB(100,60,150); pillS.Thickness=1.2
    local knob=Instance.new("Frame",pill)
    knob.BackgroundColor3=Color3.fromRGB(120,80,170); knob.BorderSizePixel=0
    knob.Position=UDim2.new(0,2,0.5,-11); knob.Size=UDim2.new(0,22,0,22); knob.ZIndex=10
    Instance.new("UICorner",knob).CornerRadius=UDim.new(1,0)
    local state=false
    local btn=Instance.new("TextButton",row); btn.BackgroundTransparency=1; btn.Size=UDim2.new(1,0,1,0); btn.Text=""; btn.ZIndex=11
    -- hover
    btn.MouseEnter:Connect(function()
        TweenService:Create(row,TweenInfo.new(0.12),{BackgroundColor3=Color3.fromRGB(28,16,52)}):Play()
        TweenService:Create(rowS,TweenInfo.new(0.12),{Transparency=0.55}):Play()
    end)
    btn.MouseLeave:Connect(function()
        TweenService:Create(row,TweenInfo.new(0.12),{BackgroundColor3=Color3.fromRGB(20,12,38)}):Play()
        TweenService:Create(rowS,TweenInfo.new(0.12),{Transparency=state and 0.35 or 0.82}):Play()
    end)
    btn.MouseButton1Click:Connect(function()
        state=not state
        TweenService:Create(pill,TweenInfo.new(0.22,Enum.EasingStyle.Quad),{
            BackgroundColor3=state and cor or Color3.fromRGB(35,20,60)
        }):Play()
        TweenService:Create(knob,TweenInfo.new(0.22,Enum.EasingStyle.Back,Enum.EasingDirection.Out),{
            Position=state and UDim2.new(1,-24,0.5,-11) or UDim2.new(0,2,0.5,-11),
            BackgroundColor3=state and Color3.fromRGB(255,255,255) or Color3.fromRGB(120,80,170)
        }):Play()
        TweenService:Create(rowS,TweenInfo.new(0.2),{
            Color=state and cor or Color3.fromRGB(252,198,0),
            Transparency=state and 0.35 or 0.82
        }):Play()
        TweenService:Create(lbar,TweenInfo.new(0.2),{
            BackgroundColor3=state and cor or Color3.fromRGB(80,50,120)
        }):Play()
        if state then
            Notify.success(lbl_txt, "✓ Ativado")
        else
...
local function makeSlider(page, lo_fn, lbl_txt, minV, maxV, defV, cor, fmt, onChange)
    ...
    tl.Text=lbl_txt; tl.TextColor3=Color3.fromRGB(240,220,255); tl.TextSize=11
    tl.TextXAlignment=Enum.TextXAlignment.Left; tl.ZIndex=7
    local valLbl=Instance.new("TextLabel",row); valLbl.BackgroundTransparency=1
    ...
    valLbl.TextXAlignment=Enum.TextXAlignment.Right; valLbl.ZIndex=7
    -- Track
    local track=Instance.new("Frame",row); track.BackgroundColor3=Color3.fromRGB(35,20,60)
    track.BorderSizePixel=0; track.Position=UDim2.new(0,14,0,40); track.Size=UDim2.new(1,-28,0,6)
    ...
    local thumb=Instance.new("Frame",track); thumb.BackgroundColor3=Color3.fromRGB(255,220,50)
    ...
    local thumbS=Instance.new("UIStroke",thumb); thumbS.Color=Color3.fromRGB(180,130,0); thumbS.Thickness=2
    local curVal = defV
...
local function stopAutoExplore(tpBack)
    ...
    pcall(function()
        if aePill   then TweenService:Create(aePill,  TweenInfo.new(0.22), {BackgroundColor3=Color3.fromRGB(30,16,55)}):Play() end
        ...
        if aeStroke then TweenService:Create(aeStroke, TweenInfo.new(0.2), {Color=Color3.fromRGB(42,46,58)}):Play() end
...
aeTitleLbl.Text="🗺️ Auto Explorar"; aeTitleLbl.TextColor3=Color3.fromRGB(240,220,255)
...
aeLabelState.TextColor3=Color3.fromRGB(140,110,180); aeLabelState.TextSize=8
...
-- Toggle pill
aePill = Instance.new("Frame",aeCard); aePill.BackgroundColor3=Color3.fromRGB(30,16,55)
...
aeKnob = Instance.new("Frame",aePill); aeKnob.BackgroundColor3=Color3.fromRGB(100,60,150)
...
for bi, lbl in ipairs(aeLvlLabels) do
    ...
    btn.BackgroundColor3 = (aeLvlVals[bi]==aeManualLevel)
        and Color3.fromRGB(252,198,0) or Color3.fromRGB(22,12,42)
...
aeRadiusLbl.TextColor3=Color3.fromRGB(80,60,110); aeRadiusLbl.TextSize=8
...
aeBtn.MouseButton1Click:Connect(function()
    ...
    TweenService:Create(aePill,TweenInfo.new(0.22),{BackgroundColor3=aeEnabled and AE_COR or Color3.fromRGB(45,50,62)}):Play()
    ...
    TweenService:Create(aeStroke,TweenInfo.new(0.2),{Color=aeEnabled and AE_COR or Color3.fromRGB(42,46,58)}):Play()
...
local fzPill=Instance.new("Frame",freezeCard); fzPill.BackgroundColor3=Color3.fromRGB(30,16,55); fzPill.BorderSizePixel=0
...
local fzKnob=Instance.new("Frame",fzPill); fzKnob.BackgroundColor3=Color3.fromRGB(100,60,150); fzKnob.BorderSizePixel=0
...
fzBtn.MouseButton1Click:Connect(function()
    ...
    TweenService:Create(fzPill,TweenInfo.new(0.22),{BackgroundColor3=freezeEnabled and FREEZE_COR or Color3.fromRGB(30,16,55)}):Play()
    TweenService:Create(fzKnob,TweenInfo.new(0.22,Enum.EasingStyle.Back,Enum.EasingDirection.Out),{
        ...
        BackgroundColor3=freezeEnabled and Color3.fromRGB(255,255,255) or Color3.fromRGB(100,60,150)
    }):Play()
...
fzRadiusCard.BackgroundColor3 = Color3.fromRGB(14,8,28)
...
-- Botão MINUS
local fzMinus=Instance.new("TextButton",fzRadiusCard); fzMinus.BackgroundColor3=Color3.fromRGB(25,12,50)
