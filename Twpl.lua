...
local Combat, Visuals, Movement, Player, Teleport, World, Automation, Skins, Emotes, Badges, GamePass, Chat, Friends, Stats, Logs, Server, Settings, Credits
...
Library:CreateKeySystem("PudimHub", function()
    ...
    Combat = Main:CreateTab("Combat", "⚔️")
    Visuals = Main:CreateTab("Visuals", "👁️")
    Movement = Main:CreateTab("Movement", "🏃")
    Player = Main:CreateTab("Player", "👤")
    Teleport = Main:CreateTab("Teleport", "🌀")
    World = Main:CreateTab("World", "🌍")
    Automation = Main:CreateTab("Automation", "🤖")
    Skins = Main:CreateTab("Skins", "👕")
    Emotes = Main:CreateTab("Emotes", "💃")
    Badges = Main:CreateTab("Badges", "🏅")
    GamePass = Main:CreateTab("GamePass", "💎")
    Chat = Main:CreateTab("Chat", "💬")
    Friends = Main:CreateTab("Friends", "👥")
    Stats = Main:CreateTab("Stats", "📊")
